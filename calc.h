...
void GetMinMaxText2a(double X,double Y,double FontSize,int32 FontNr,double Rotation,
                     int32 Alignment,int32 Mirror,LPSTR Str);
...
int32 ArcToLineSegments(double x1,double y1,double Width,double Height,
                        ...
                        double *LineSegments,int32 mode);
...
int32 RectTestArc2(double x1,double y1,double x2,double y2,double x3,double y3,double x4,double y4,double Thickness);
