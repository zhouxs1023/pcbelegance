...
typedef struct {
          double x11,y11,x12,y12,
                x21,x22,y21,y22,
                x11a,y11a,x21a,y21a,
                lengte1,lengte1a,lengte2,lengte2a;
...

{
  ...
  double x11,y11,x12,y12,x21,x22,y21,y22,x11a,y11a,x21a,y21a,
         px,py,lengte1,lengte1a,lengte2,lengte2a;
  ...
  if ((Object1a->Layer!=-1)
     ...
     (Object2a->Layer!=-1)
     &&
     (Object2a->Layer!=Object1a->Layer)) return 0;
  ...
  if ((Object1.Layer>0)
     &&
     (Object1.Layer<Design.NrBoardLayers-1)) {
    Object1OnInnerLayer=1;
  }
  if ((Object2.Layer>0)
     &&
     (Object2.Layer<Design.NrBoardLayers-1)) {
...
*/
  ...
  if ((ObjectType2==AREAFILL)
     &&
     (ObjectType1==PIN_SMD_ROUND)) {
    if ((InRange9(Object1.x1,40.6e5))
       &&
       (InRange9(Object1.y1,31.3e5))) {
      ok=1;
    }
  ...
  if ((InRange9(Object1.x1,41.5e5))
     &&
     (InRange9(Object1.y1,67.8e5))) {
    ok=1;
    if (ObjectType2==AREAFILL) {
      ok=1;
    }
  }
  if ((InRange9(Object2.x1,41.5e5))
     &&
     (InRange9(Object2.y1,67.8e5))) {
    ok=1;
...
/***************************************************************************************/
  ...
  if ((AreaFillObject1)
    ...
    if ((ObjectType1==CONNECTION)
       ||
       (ObjectType2==CONNECTION)) {
      if (ObjectType2==CONNECTION) {
        if (GetFirstPointPolygonObject(&Object1,&px,&py,0)) {
          if ((InRange(px,x21))
             &&
             (InRange(py,y21))) return 1;
          if ((InRange(px,x22))
             &&
             (InRange(py,y22))) return 1;
        } else {
          if ((InRange(x11,x21))
             &&
             (InRange(y11,y21))) return 1;
          if ((InRange(x11,x22))
             &&
             (InRange(y11,y22))) return 1;
        }
        return 0;
      } else {
        if (GetFirstPointPolygonObject(&Object2,&px,&py,0)) {
          if ((InRange(x11,px))
             &&
             (InRange(y11,py))) return 1;
          if ((InRange(x12,px))
             &&
             (InRange(y12,py))) return 1;
        } else {
          if ((InRange(x11,x21))
             &&
             (InRange(y11,y21))) return 1;
...
/***************************************************************************************/
  ...
  if ((ObjectType1==TRACE_ALL_ANGLE)
     ||
     (ObjectType2==TRACE_ALL_ANGLE)
     ||
     (ObjectType1==TRACE_ARC)
    ...
    if ((PolygonObject1->maxx>PolygonObject2->minx)
       &&
       (PolygonObject1->minx<PolygonObject2->maxx)
       &&
       (PolygonObject1->maxy>PolygonObject2->miny)
       &&
       (PolygonObject1->miny<PolygonObject2->maxy)) {
      if (CheckPolygonCompleetlyOutsidePolygon(PolygonObject1,PolygonObject2)!=1) return 1;
    }
    return 0;
  }
...

{
  ...
  if ((ObjectType1==PIN_ARC)
     ||
     (ObjectType1==TRACE_ARC)) {
    GetArcEndPoints(Object1,&x11,&y11,&x12,&y12,0);
  }
  if ((ObjectType2==PIN_ARC)
     ||
     (ObjectType2==TRACE_ARC)) {
    GetArcEndPoints(Object2,&x21,&y21,&x22,&y22,0);
  }
...
/***************************************************************************************/
    ...
    case DRILL_UNPLATED:
    case PIN_SMD_ROUND:
      if ((InRange3(CalcP->x11,CalcP->x21))
         &&
         (InRange3(CalcP->y11,CalcP->y21))) return 1;
      return CircleTestCircleObjects(CalcP->x11,CalcP->y11,CalcP->x12,
                                     CalcP->x21,CalcP->y21,CalcP->x22);
      break;
/***************************************************************************************/
/***************************************************************************************/
    case PIN_SMD_RECT:
      if ((InRange3(CalcP->x11,CalcP->x21))
         &&
         (InRange3(CalcP->y11,CalcP->y21))) return 1;
      return RectTestCircleObjects(CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22,
                                   CalcP->x11,CalcP->y11,CalcP->x12);
      break;
/***************************************************************************************/
/***************************************************************************************/
    case PIN_PUT_THROUGH_SQUARE:
      if ((InRange3(CalcP->x11,CalcP->x21))
         &&
         (InRange3(CalcP->y11,CalcP->y21))) return 1;
      return RectTestCircleObjects(CalcP->x21,CalcP->y21,CalcP->x22,CalcP->x22,
                                   CalcP->x11,CalcP->y11,CalcP->x12);
      break;
/***************************************************************************************/
/***************************************************************************************/
    case CONNECTION:
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      if ((InRange(CalcP->x11,CalcP->x22))
         &&
         (InRange(CalcP->y11,CalcP->y22))) return 1;
      return 0;
      break;
/***************************************************************************************/
/***************************************************************************************/
...
// hor line left circle
      if ((InRange3(CalcP->x11,CalcP->x21))
         &&
         (InRange3(CalcP->y11,CalcP->y21))) return 1;
      if (CircleTestCircleObjects(CalcP->x11,CalcP->y11,CalcP->x12,
                                  CalcP->x21,CalcP->y21,CalcP->y22)) return 1;

// hor line right circle
      if ((InRange3(CalcP->x11,CalcP->x21+CalcP->lengte2))
         &&
         (InRange3(CalcP->y11,CalcP->y21))) return 1;
      if (CircleTestCircleObjects(CalcP->x11,CalcP->y11,CalcP->x12,
                                  CalcP->x21+CalcP->lengte2,CalcP->y21,CalcP->y22)) return 1;

// hor line
      if (RectTestCircleObjects(CalcP->x21+CalcP->lengte2*0.5,CalcP->y21,CalcP->x22,CalcP->y22,
                                CalcP->x11,CalcP->y11,CalcP->x12)) return 1;
...
// ver line top circle
      if ((InRange3(CalcP->x11,CalcP->x21))
         &&
         (InRange3(CalcP->y11,CalcP->y21+CalcP->lengte2))) return 1;
      if (CircleTestCircleObjects(CalcP->x11,CalcP->y11,CalcP->x12,
                                  CalcP->x21,CalcP->y21+CalcP->lengte2,CalcP->y22)) return 1;

// ver line
      if (RectTestCircleObjects(  CalcP->x21,CalcP->y21+CalcP->lengte2*0.5,CalcP->y22,CalcP->lengte2,
                                  CalcP->x11,CalcP->y11,CalcP->x12)) return 1;
...
// diag1 line right bottom circle
      if ((InRange3(CalcP->x11,CalcP->x21+CalcP->lengte2))
         ...
         (InRange3(CalcP->y11,CalcP->y21-CalcP->lengte2))) return 1;
      if (CircleTestCircleObjects(CalcP->x11,CalcP->y11,CalcP->x12,
                                  CalcP->x21+CalcP->lengte2,CalcP->y21-CalcP->lengte2,CalcP->y22)) return 1;

// diag1 line
      if (CircleTestDiag1Objects( CalcP->x11,CalcP->y11,CalcP->x12,
                                  CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22)) return 1;
...
// diag2 line
      if (CircleTestDiag2Objects( CalcP->x11,CalcP->y11,CalcP->x12,
                                  CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22)) return 1;
...
/***************************************************************************************/
    ...
    case DRILL_UNPLATED:
    case PIN_SMD_ROUND:
      if (RectTestCircleObjects(CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12,
                                CalcP->x21,CalcP->y21,CalcP->x22)) return 1;
      return 0;
      break;
/***************************************************************************************/
/***************************************************************************************/
    case PIN_PUT_THROUGH_SQUARE:
      ...
      if ((CalcP->x11-CalcP->x12*0.5>CalcP->x21+CalcP->x22*0.5)
         ...
         ||
         (CalcP->y11+CalcP->y12*0.5<CalcP->y21-CalcP->x22*0.5)) return 0;
      return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
    case PIN_SMD_RECT:
      ...
      if ((CalcP->x11-CalcP->x12*0.5>CalcP->x21+CalcP->x22*0.5)
         ...
         ||
         (CalcP->y11+CalcP->y12*0.5<CalcP->y21-CalcP->y22*0.5)) return 0;
      return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
...
// ver line
      if ((CalcP->x11-CalcP->x12*0.5>CalcP->x21+CalcP->y22*0.5)
         ...
         ||
         (CalcP->y11+CalcP->y12*0.5<CalcP->y21)) return 0;
      return 1;
      break;
...
// diag1 line
      if (RectTestDiag1Objects( CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12,
                                CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22)) return 1;
...
// diag2 line
      if (RectTestDiag2Objects( CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12,
                                CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22)) return 1;
...
/***************************************************************************************/
    ...
    case PIN_SMD_ROUND:
      if ((InRange3(CalcP->x11,CalcP->x21))
         &&
         (InRange3(CalcP->y11,CalcP->y21))) return 1;
      if (RectTestCircleObjects(CalcP->x11,CalcP->y11,CalcP->x12,CalcP->x12,
                                CalcP->x21,CalcP->y21,CalcP->x22)) return 1;
      return 0;
      break;
/***************************************************************************************/
/***************************************************************************************/
    case PIN_PUT_THROUGH_SQUARE:
      ...
      if ((CalcP->x11-CalcP->x12*0.5>CalcP->x21+CalcP->x22*0.5)
         ...
         ||
         (CalcP->y11+CalcP->x12*0.5<CalcP->y21-CalcP->x22*0.5)) return 0;
      return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
    case PIN_SMD_RECT:
      ...
      if ((CalcP->x11-CalcP->x12*0.5>CalcP->x21+CalcP->x22*0.5)
         ...
         ||
         (CalcP->y11+CalcP->x12*0.5<CalcP->y21-CalcP->y22*0.5)) return 0;
      return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
...
// ver line top circle
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11,CalcP->y21+CalcP->lengte2))) return 1;
      if (RectTestCircleObjects(CalcP->x11,CalcP->y11,CalcP->x12,CalcP->x12,
                                CalcP->x21,CalcP->y21+CalcP->lengte2,CalcP->y22)) return 1;
...
// ver line
      if ((CalcP->x11-CalcP->x12*0.5>CalcP->x21+CalcP->y22*0.5)
         ...
         ||
         (CalcP->y11+CalcP->x12*0.5<CalcP->y21)) return 0;
      return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
...
// diag1 line
      if (RectTestDiag1Objects( CalcP->x11,CalcP->y11,CalcP->x12,CalcP->x12,
                                CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22)) return 1;
...
// diag2 line
      if (RectTestDiag2Objects( CalcP->x11,CalcP->y11,CalcP->x12,CalcP->x12,
                                CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22)) return 1;
...
// hor line left circle
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      if (CircleTestCircleObjects(CalcP->x11,CalcP->y11,CalcP->y12,
                                  CalcP->x21,CalcP->y21,CalcP->x22)) return 1;
...
// hor line right circle
      if ((InRange(CalcP->x11+CalcP->lengte1,CalcP->x21))
         &&
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      if (CircleTestCircleObjects(CalcP->x11+CalcP->lengte1,CalcP->y11,CalcP->y12,
                                  CalcP->x21,CalcP->y21,CalcP->x22)) return 1;

// hor line
      if (RectTestCircleObjects(CalcP->x11+CalcP->lengte1*0.5,CalcP->y11,CalcP->x12,CalcP->y12,
                                CalcP->x21,CalcP->y21,CalcP->x22)) return 1;
...
// hor line left circle
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      if (RectTestCircleObjects(CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22,
                                CalcP->x11,CalcP->y11,CalcP->y12)) return 1;
...
// hor line right circle
      if ((InRange(CalcP->x11+CalcP->lengte1,CalcP->x21))
         ...
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      if (RectTestCircleObjects(CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22,
                                CalcP->x11+CalcP->lengte1,CalcP->y11,CalcP->y12)) return 1;
...
// hor line left circle
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      if (RectTestCircleObjects(CalcP->x21,CalcP->y21,CalcP->x22,CalcP->x22,
                                CalcP->x11,CalcP->y11,CalcP->y12)) return 1;
...
/***************************************************************************************/
    case CONNECTION:
      ...
      if ((InRange(CalcP->x11+CalcP->lengte1a,CalcP->x21))
         &&
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      ...
      if ((InRange(CalcP->x11+CalcP->lengte1,CalcP->x22))
         &&
         (InRange(CalcP->y11,CalcP->y22))) return 1;

      if ((InRange(CalcP->x11+CalcP->lengte1a,CalcP->x22))
         &&
         (InRange(CalcP->y11,CalcP->y22))) return 1;
...
// hor line
      if ((CalcP->x11>CalcP->x21+CalcP->lengte2)
         ||
         (CalcP->x11+CalcP->lengte1<CalcP->x21)
         ||
         (CalcP->y11-CalcP->y12*0.5>CalcP->y21+CalcP->y22*0.5)
         ||
         (CalcP->y11+CalcP->y12*0.5<CalcP->y21-CalcP->y22*0.5)) return 0;
...
// ver line top circle
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11+CalcP->lengte1,CalcP->y21))) return 1;
      if (CircleTestCircleObjects(CalcP->x11,CalcP->y11+CalcP->lengte1,CalcP->y12,
                                  CalcP->x21,CalcP->y21,CalcP->x22)) return 1;

// ver line
      if (RectTestCircleObjects(  CalcP->x11,CalcP->y11+CalcP->lengte1*0.5,CalcP->y12,CalcP->lengte1,
                                  CalcP->x21,CalcP->y21,CalcP->x22)) return 1;
...
// ver line top circle
      if ((InRange(CalcP->x11,CalcP->x21))
         ...
         (InRange(CalcP->y11+CalcP->lengte1,CalcP->y21))) return 1;
      if (RectTestCircleObjects(  CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22,
                                  CalcP->x11,CalcP->y11+CalcP->lengte1,CalcP->y12)) return 1;
...
// ver line
      if ((CalcP->x11-CalcP->y12*0.5>CalcP->x21+CalcP->x22*0.5)
         ...
         ||
         (CalcP->y11+CalcP->lengte1<CalcP->y21-CalcP->y22*0.5)) return 0;
      return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
...
// ver line
      if ((CalcP->x11-CalcP->y12*0.5>CalcP->x21+CalcP->x22*0.5)
         ...
         ||
         (CalcP->y11+CalcP->lengte1<CalcP->y21-CalcP->x22*0.5)) return 0;
      return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
    case CONNECTION:
      ...
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11+CalcP->lengte1a,CalcP->y21))) return 1;
      ...
      if ((InRange(CalcP->x11,CalcP->x22))
         &&
         (InRange(CalcP->y11+CalcP->lengte1,CalcP->y22))) return 1;

      if ((InRange(CalcP->x11,CalcP->x22))
         &&
         (InRange(CalcP->y11+CalcP->lengte1a,CalcP->y22))) return 1;
/*
...
// ver line
      ...
      if ((CalcP->x11-CalcP->y12*0.5>CalcP->x21+CalcP->lengte2)
         ||
         (CalcP->x11+CalcP->y12*0.5<CalcP->x21)
         ||
         (CalcP->y11>CalcP->y21+CalcP->y22*0.5)
         ||
         (CalcP->y11+CalcP->lengte1<CalcP->y21-CalcP->y22*0.5)) return 0;
...
// ver line top circle
      ...
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11+CalcP->lengte1,CalcP->y21+CalcP->lengte2))) return 1;
      if (CircleTestCircleObjects(CalcP->x11,CalcP->y11+CalcP->lengte1,CalcP->y12,        // ver line top circle
                                  CalcP->x21,CalcP->y21+CalcP->lengte2,CalcP->y22)) return 1;
...
// ver line
      if ((CalcP->x11-CalcP->y12*0.5>CalcP->x21+CalcP->y22*0.5)
         ...
         ||
         (CalcP->y11>CalcP->y21+CalcP->lengte2)
         ||
         (CalcP->y11+CalcP->lengte1<CalcP->y21)) return 0;
      return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
...
// diag1 line right bottom circle
      if ((InRange(CalcP->x11+CalcP->lengte1,CalcP->x21))
         &&
         (InRange(CalcP->y11-CalcP->lengte1,CalcP->y21))) return 1;
      if (CircleTestCircleObjects(CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->y12,
                                  CalcP->x21,CalcP->y21,CalcP->x22)) return 1;

// diag1 line
      if (CircleTestDiag1Objects( CalcP->x21,CalcP->y21,CalcP->x22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;
      return 0;
      break;
/***************************************************************************************/
/***************************************************************************************/
...
// diag1 line right bottom circle
      if ((InRange(CalcP->x11+CalcP->lengte1,CalcP->x21))
         ...
         (InRange(CalcP->y11-CalcP->lengte1,CalcP->y21))) return 1;
      if (RectTestCircleObjects(  CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22,
                                  CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->y12)) return 1;

// diag1 line
      if (RectTestDiag1Objects(   CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;
      return 0;
      break;
/***************************************************************************************/
...
// diag1 line
      if (RectTestDiag1Objects(   CalcP->x21,CalcP->y21,CalcP->x22,CalcP->x22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;
      return 0;
      break;
/***************************************************************************************/
...
// hor line left circle
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      if (CircleTestCircleObjects(CalcP->x21,CalcP->y21,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->y12)) return 1;                  // diag1 line left top circle

      if ((InRange(CalcP->x11+CalcP->lengte1,CalcP->x21))
         &&
         (InRange(CalcP->y11-CalcP->lengte1,CalcP->y21))) return 1;
      if (CircleTestCircleObjects(CalcP->x21,CalcP->y21,CalcP->y22,
                                  CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->y12)) return 1;  // diag1 line right bottom circle

      if (CircleTestDiag1Objects( CalcP->x21,CalcP->y21,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;              // diag1 line

// hor line right circle
      if ((InRange(CalcP->x11,CalcP->x21+CalcP->lengte2))
         &&
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      if (CircleTestCircleObjects(CalcP->x21+CalcP->lengte2,CalcP->y21,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->y12)) return 1;                  // diag1 line left top circle
      ...
      if (CircleTestDiag1Objects( CalcP->x21+CalcP->lengte2,CalcP->y21,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;              // diag1 line
...
// hor line
      ...
      if (RectTestDiag1Objects(   CalcP->x21+CalcP->lengte2*0.5,CalcP->y21,CalcP->x22,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;              // diag1 line
...
// ver line top circle
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11,CalcP->y21+CalcP->lengte2))) return 1;
      if (CircleTestCircleObjects(CalcP->x21,CalcP->y21+CalcP->lengte2,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->y12)) return 1;                  // diag1 line left top circle
      ...
      if (CircleTestDiag1Objects( CalcP->x21,CalcP->y21+CalcP->lengte2,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;              // diag1 line

// ver line

      if (RectTestCircleObjects(  CalcP->x21,CalcP->y21+CalcP->lengte2*0.5,CalcP->y22,CalcP->x22,
                                  CalcP->x11,CalcP->y11,CalcP->y12)) return 1;                  // diag1 line left top circle

      if (RectTestCircleObjects(  CalcP->x21,CalcP->y21+CalcP->lengte2*0.5,CalcP->y22,CalcP->x22,
                                  CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->y12)) return 1;  // diag1 line right bottom circle

      if (RectTestDiag1Objects(   CalcP->x21,CalcP->y21+CalcP->lengte2*0.5,CalcP->y22,CalcP->x22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;              // diag1 line
      return 0;
      break;
/***************************************************************************************/
...
// diag1 line right bottom circle
      ...
      if (CircleTestDiag1Objects( CalcP->x21+CalcP->lengte2,CalcP->y21-CalcP->lengte2,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;// diag1 line
...
// diag2 line
      if (CircleTestDiag2Objects( CalcP->x21,CalcP->y21,CalcP->x22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;
...
// diag2 line
      if (RectTestDiag2Objects(   CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;
...
// diag2 line
      if (RectTestDiag2Objects(   CalcP->x21,CalcP->y21,CalcP->x22,CalcP->x22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;
...
// hor line left circle
      if ((InRange(CalcP->x11,CalcP->x21))
         ...
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      if (CircleTestCircleObjects(CalcP->x21,CalcP->y21,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->y12)) return 1;                  // diag2 line left bottom circle

      if ((InRange(CalcP->x11+CalcP->lengte1,CalcP->x21))
         &&
         (InRange(CalcP->y11+CalcP->lengte1,CalcP->y21))) return 1;
      if (CircleTestCircleObjects(CalcP->x21,CalcP->y21,CalcP->y22,
                                  CalcP->x11+CalcP->lengte1,CalcP->y11+CalcP->lengte1,CalcP->y12)) return 1;  // diag2 line right top circle

      if (CircleTestDiag2Objects( CalcP->x21,CalcP->y21,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;              // diag2 line
...
// hor line right circle
      ...
      if (CircleTestDiag2Objects( CalcP->x21+CalcP->lengte2,CalcP->y21,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;              // diag2 line
...
// hor line
      ...
      if (RectTestDiag2Objects(   CalcP->x21+CalcP->lengte2*0.5,CalcP->y21,CalcP->x22,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;              // diag2 line
...
// ver line top circle
      ...
      if (CircleTestDiag2Objects( CalcP->x21,CalcP->y21+CalcP->lengte2,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;              // diag2 line
...
// ver line
      ...
      if (RectTestDiag2Objects(   CalcP->x21,CalcP->y21+CalcP->lengte2*0.5,CalcP->y22,CalcP->x22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;              // diag2 line
...
// diag1 line right bottom circle
      ...
      if (CircleTestDiag2Objects( CalcP->x21+CalcP->lengte2,CalcP->y21-CalcP->lengte2,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;// diag2 line
...
// diag1 line
      ...
      if (Diag1TestDiag2Objects(  CalcP->x21,CalcP->y21,CalcP->x22,CalcP->y22,
                                  CalcP->x11,CalcP->y11,CalcP->x12,CalcP->y12)) return 1;// diag2 line
...
/***************************************************************************************/
    ...
    case PIN_SMD_ROUND:
    case PIN_PUT_THROUGH_SQUARE:
      if ((InRange(CalcP->x11,CalcP->x21a))
         &&
         (InRange(CalcP->y11,CalcP->y21a))) return 1;
      if ((InRange(CalcP->x12,CalcP->x21a))
         &&
         (InRange(CalcP->y12,CalcP->y21a))) return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
    case CONNECTION:
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      if ((InRange(CalcP->x12,CalcP->x21))
         &&
         (InRange(CalcP->y12,CalcP->y21))) return 1;
      if ((InRange(CalcP->x11,CalcP->x22))
         &&
         (InRange(CalcP->y11,CalcP->y22))) return 1;
      if ((InRange(CalcP->x12,CalcP->x22))
         &&
         (InRange(CalcP->y12,CalcP->y22))) return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
    case TRACE_HOR:
      ...
      if ((InRange(CalcP->x12,CalcP->x21))
         &&
         (InRange(CalcP->y12,CalcP->y21))) return 1;
      if ((InRange(CalcP->x12,CalcP->x21+CalcP->lengte2))
         &&
         (InRange(CalcP->y12,CalcP->y21))) return 1;
      break;
...
/***************************************************************************************/
    case PIN_LINE_HOR:
      ...
      if ((InRange(CalcP->x11,CalcP->x21+CalcP->lengte2))
         &&
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      if ((InRange(CalcP->x11,CalcP->x21+CalcP->lengte2a))
         &&
         (InRange(CalcP->y11,CalcP->y21))) return 1;
      ...
      if ((InRange(CalcP->x12,CalcP->x21+CalcP->lengte2))
         &&
         (InRange(CalcP->y12,CalcP->y21))) return 1;
      if ((InRange(CalcP->x12,CalcP->x21+CalcP->lengte2a))
         &&
         (InRange(CalcP->y12,CalcP->y21))) return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
    case TRACE_VER:
      ...
      if ((InRange(CalcP->x12,CalcP->x21))
         &&
         (InRange(CalcP->y12,CalcP->y21+CalcP->lengte2))) return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
    case PIN_LINE_VER:
      ...
      if ((InRange(CalcP->x11,CalcP->x21))
         &&
         (InRange(CalcP->y11,CalcP->y21+CalcP->lengte2a))) return 1;
      if ((InRange(CalcP->x12,CalcP->x21))
         &&
         (InRange(CalcP->y12,CalcP->y21))) return 1;
      if ((InRange(CalcP->x12,CalcP->x21))
      ...
      if ((InRange(CalcP->x12,CalcP->x21))
         &&
         (InRange(CalcP->y12,CalcP->y21+CalcP->lengte2a))) return 1;
      break;
/***************************************************************************************/
/***************************************************************************************/
    case TRACE_DIAG1:
...
// hor line1 right circle,diag1 line right bottom circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11,CalcP->x21+CalcP->lengte2,CalcP->y21-CalcP->lengte2);
...
// hor line1 right circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11,CalcP->x21+CalcP->lengte2a,CalcP->y21-CalcP->lengte2a);
      ConnectionX1=CalcP->x11+CalcP->lengte1;
      ConnectionY1=CalcP->y11;
      ConnectionX2=CalcP->x21+CalcP->lengte2a;
      ConnectionY2=CalcP->y21-CalcP->lengte2a;
...
// ver line1 top circle,diag1 line right bottom circle
      Length21=CalcLengthLine(CalcP->x11,CalcP->y11,CalcP->x21+CalcP->lengte2,CalcP->y21-CalcP->lengte2);
// ver line1 top circle,diag1 line right bottom circle
      Length22=CalcLengthLine(CalcP->x11,CalcP->y11+CalcP->lengte1,CalcP->x21+CalcP->lengte2,CalcP->y21-CalcP->lengte2);
...
// ver line1 top circle
      Length21=CalcLengthLine(CalcP->x11,CalcP->y11,CalcP->x21+CalcP->lengte2,CalcP->y21-CalcP->lengte2);
// ver line1 top circle
      Length22=CalcLengthLine(CalcP->x11,CalcP->y11+CalcP->lengte1,CalcP->x21+CalcP->lengte2a,CalcP->y21-CalcP->lengte2a);
      ConnectionX1=CalcP->x11;
      ConnectionY1=CalcP->y11+CalcP->lengte1;
      ConnectionX2=CalcP->x21+CalcP->lengte2a;
      ConnectionY2=CalcP->y21+CalcP->lengte2a;
...
// diag1 line1 right bottom circle,hor line2 right circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->x21+CalcP->lengte2,CalcP->y21);
...
// diag1 line1 right bottom circle
      Length21=CalcLengthLine(CalcP->x11,CalcP->y11,CalcP->x21+CalcP->lengte2a,CalcP->y21);
// diag1 line1 right bottom circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->x21+CalcP->lengte2a,CalcP->y21);
...
// diag1 line1 right bottom circle,ver line2 top circle
      Length21=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->x21,CalcP->y21);
// diag1 line1 right bottom circle,ver line2 top circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->x21,CalcP->y21+CalcP->lengte2);
...
// diag1 line1 right bottom circle
      Length21=CalcLengthLine(CalcP->x11,CalcP->y11,CalcP->x21,CalcP->y21+CalcP->lengte2a);
// diag1 line1 right bottom circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->x21,CalcP->y21+CalcP->lengte2a);
...
// diag1 line1 right bottom circle,diag1 line2 right bottom circle
      Length21=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->x21,CalcP->y21);
// diag1 line1 right bottom circle,diag1 line2 right bottom circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->x21+CalcP->lengte2,CalcP->y21-CalcP->lengte2);
...
// diag1 line1 right bottom circle
      Length21=CalcLengthLine(CalcP->x11,CalcP->y11,CalcP->x21+CalcP->lengte2a,CalcP->y21-CalcP->lengte2a);
// diag1 line1 right bottom circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11-CalcP->lengte1,CalcP->x21+CalcP->lengte2a,CalcP->y21-CalcP->lengte2a);
...
/***************************************************************************************/
    case PIN_LINE_HOR:
// diag2 line1 right bottom circle
      Length21=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11+CalcP->lengte1,CalcP->x21+CalcP->lengte2a,CalcP->y21);
// diag2 line1 right bottom circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11+CalcP->lengte1,CalcP->x21+CalcP->lengte2a,CalcP->y21);
...
/***************************************************************************************/
    case PIN_LINE_VER:
// diag2 line1 right bottom circle
      Length21=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11+CalcP->lengte1,CalcP->x21,CalcP->y21+CalcP->lengte2a);
// diag2 line1 right bottom circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1,CalcP->y11+CalcP->lengte1,CalcP->x21,CalcP->y21+CalcP->lengte2a);
...
// diag1 line2 right bottom circle
      Length21=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11,CalcP->x21,CalcP->y21);
// diag1 line2 right bottom circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11,CalcP->x21+CalcP->lengte2,CalcP->y21-CalcP->lengte2);
      ConnectionX1=CalcP->x11+CalcP->lengte1a;
      ConnectionY1=CalcP->y11;
      if (Length21<=Length22) {
        ConnectionX2=CalcP->x21;
...
/***************************************************************************************/
    case PIN_LINE_DIAG1:
      ConnectionX1=CalcP->x11+CalcP->lengte1a;
      ConnectionY1=CalcP->y11;
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11,CalcP->x21+CalcP->lengte2a,CalcP->y21-CalcP->lengte2a);
      ConnectionX2=CalcP->x21+CalcP->lengte2a;
      ConnectionY2=CalcP->y21-CalcP->lengte2a;
      return Length22;
...
// diag1 line2 right bottom circle
      Length21=CalcLengthLine(CalcP->x11,CalcP->y11+CalcP->lengte1a,CalcP->x21,CalcP->y21);
// diag1 line2 right bottom circle
      Length22=CalcLengthLine(CalcP->x11,CalcP->y11+CalcP->lengte1a,CalcP->x21+CalcP->lengte2,CalcP->y21-CalcP->lengte2);
      ConnectionX1=CalcP->x11;
      ConnectionY1=CalcP->y11+CalcP->lengte1a;
      if (Length21<=Length22) {
        ConnectionX2=CalcP->x21;
...
/***************************************************************************************/
    case PIN_LINE_DIAG1:
      ConnectionX1=CalcP->x11;
      ConnectionY1=CalcP->y11+CalcP->lengte1a;
      Length22=CalcLengthLine(CalcP->x11,CalcP->y11+CalcP->lengte1a,CalcP->x21+CalcP->lengte2a,CalcP->y21-CalcP->lengte2a);
      ConnectionX2=CalcP->x21+CalcP->lengte2a;
      ConnectionY2=CalcP->y21-CalcP->lengte2a;
      return Length22;
...
// hor line2 left circle
      Length21=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11-CalcP->lengte1a,CalcP->x21,CalcP->y21);
// hor line2 right circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11-CalcP->lengte1a,CalcP->x21+CalcP->lengte2,CalcP->y21);
      ConnectionX1=CalcP->x11+CalcP->lengte1a;
      ConnectionY1=CalcP->y11-CalcP->lengte1a;
      if (Length21<=Length22) {
        ConnectionX2=CalcP->x21;
...
/***************************************************************************************/
    case PIN_LINE_HOR:
      ConnectionX1=CalcP->x11+CalcP->lengte1a;
      ConnectionY1=CalcP->y11-CalcP->lengte1a;
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11-CalcP->lengte1a,CalcP->x21+CalcP->lengte2a,CalcP->y21);
      ConnectionX2=CalcP->x21+CalcP->lengte2a;
      ConnectionY2=CalcP->y21;
      return Length22;
/***************************************************************************************/
...
// ver line2 top circle
      Length21=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11-CalcP->lengte1a,CalcP->x21,CalcP->y21);
// ver line2 top circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11-CalcP->lengte1a,CalcP->x21,CalcP->y21+CalcP->lengte2);
      ConnectionX1=CalcP->x11+CalcP->lengte1a;
      ConnectionY1=CalcP->y11-CalcP->lengte1a;
      if (Length21<=Length22) {
        ConnectionX2=CalcP->x21;
...
/***************************************************************************************/
    case PIN_LINE_VER:
      ConnectionX1=CalcP->x11+CalcP->lengte1a;
      ConnectionY1=CalcP->y11-CalcP->lengte1a;
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11-CalcP->lengte1a,CalcP->x21,CalcP->y21+CalcP->lengte2a);
      ConnectionX2=CalcP->x21;
      ConnectionY2=CalcP->y21+CalcP->lengte2a;
      return Length22;
/***************************************************************************************/
...
// diag1 line2 right bottom circle
      Length21=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11-CalcP->lengte1a,CalcP->x21,CalcP->y21);
// diag1 line2 right bottom circle
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11-CalcP->lengte1a,CalcP->x21+CalcP->lengte2,CalcP->y21-CalcP->lengte2);
      ConnectionX1=CalcP->x11+CalcP->lengte1a;
      ConnectionY1=CalcP->y11-CalcP->lengte1a;
      if (Length21<=Length22) {
        ConnectionX2=CalcP->x21;
...
/***************************************************************************************/
    case PIN_LINE_DIAG1:
      ConnectionX1=CalcP->x11+CalcP->lengte1a;
      ConnectionY1=CalcP->y11-CalcP->lengte1a;
      Length22=CalcLengthLine(CalcP->x11+CalcP->lengte1a,CalcP->y11-CalcP->lengte1a,CalcP->x21+CalcP->lengte2a,CalcP->y21-CalcP->lengte2a);
      ConnectionX2=CalcP->x21+CalcP->lengte2a;
      ConnectionY2=CalcP->y21-CalcP->lengte2a;
      return Length22;
