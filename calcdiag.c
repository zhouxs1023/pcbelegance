...
*/
  ...
  double xx1,yy1,xx2,yy2,xx3,yy3,xx4,yy4,
         CircleR,CircleMinXD,CircleMinYD,CircleMaxXD,CircleMaxYD,
  ...
  if ( CircleMaxXD+CircleMaxYD< xx4+yy4) return 0;
  if ( CircleMinXD+CircleMinYD> xx2+yy2) return 0;
  if (-CircleMaxXD+CircleMinYD>-xx4+yy4) return 0;
  if (-CircleMinXD+CircleMaxYD<-xx2+yy2) return 0;

  if ((-CircleMinXD+CircleMaxYD<=-xx4+yy4)
     &&
     ( -CircleMaxXD+CircleMinYD>=-xx2+yy2)
     &&
     (  CircleMinXD+CircleMinYD<= xx2+yy2)
     &&
     (  CircleMaxXD+CircleMaxYD>= xx4+yy4)) return 1;
  ...
  if ((CircleX+CircleY> xx2+yy2)
     &&
     (-CircleX+CircleY>-xx4+yy4)) {
    hulpx=CircleX-xx1;
    hulpy=CircleY-yy1;
    hulp=sqrt(hulpx*hulpx+hulpy*hulpy);
    if (hulp>CircleThickness) return 0;
  }
...

{
  ...
  if ( RectXmax+RectYmax< SearchX1+SearchY1) return 0;
  if ( RectXmin+RectYmin> SearchX2+SearchY2) return 0;
  if (-RectXmax+RectYmin>-SearchX1+SearchY1) return 0;
  if (-RectXmin+RectYmax<-SearchX2+SearchY2) return 0;
...
*/
  ...
  if ( SearchX2+SearchY2< xx4+yy4) return 0;
  if ( SearchX1+SearchY1> xx2+yy2) return 0;
  if (-SearchX2+SearchY2>-xx4+yy4) return 0;
  if (-SearchX1+SearchY1<-xx2+yy2) return 0;
