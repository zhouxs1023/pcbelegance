...
//  DialogWindowText=DialogText;
	...
	{
		res =
		    DialogBox(GEOMClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT), GEOMWindow,
	...
	else
	{
		...
		{
			res =
			    DialogBox(GEOMClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT2), GEOMWindow,
			              (DLGPROC) TextInputDialogBody);
		}
		else
		{
			res =
			    DialogBox(GEOMClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT4), GEOMWindow,
			              (DLGPROC) TextInputDialogBody);
		}
	}
...
int32 TextInputDialog2(LPSTR Text, LPSTR DialogText, int32 Mode)
{
	...
	MultiLineText = Text;
	res =
	    DialogBox(GEOMClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT3), GEOMWindow,
...
int32 AddTextObjectsDialog(int32 Mode)
{
	...
	DialogMode = Mode;
	res =
	    DialogBox(GEOMClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_ADD_TEXT_OBJECTS), GEOMWindow,
...
//  WorkingObject=ObjectText;
	if ((DialogMode == 0) || (OldPinStr[0] == 0))
	{
		...
		res =
		    DialogBox(GEOMClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_PINASSIGN), GEOMWindow,
...
int32 SelectNewGeomtrieDialog(int32 Mode)
{
	...
	DialogMode = Mode;
	res =
	    DialogBox(GEOMClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_NEW), GEOMWindow, (DLGPROC) SelectNewGeomtrieDialog2);
	return res;
}
...
int32 EditPadRules()
{
	...
	res =
	    DialogBox(GEOMClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_PAD_RULES), GEOMWindow,
