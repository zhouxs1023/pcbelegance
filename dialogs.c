...
int32             NrAddPins,hulp,DialogMode,NumberStart,NumberStep,
                  NumberCount,CurrentSelection;
...
extern  int32     SelectedColorNr,InstCnt,GeomScreenWidth,GeomScreenHeight,
                  GeomStartX,GeomStartY;
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDC_CHECK1     ,SC(22,"Not visible"));
      switch (DialogMode) {
        case 0:
          SetWindowTextUTF8(Dialog,SC(23,"Add text"));
          SetDialogItemText(Dialog,IDC_STATIC1    ,SC(35,"Text height"));
          ...
          break;
        case 1:
          SetWindowTextUTF8(Dialog,SC(24,"Change text"));
          strcpy(OldObjectText.Text,WorkingObjectText->Text);
          break;
        case 2:
          SetWindowTextUTF8(Dialog,SC(25,"Change reference"));
          if ((WorkingObjectText->Info & TEXT_NOT_VISIBLE) == TEXT_NOT_VISIBLE)
            SendDlgItemMessage(Dialog,IDC_CHECK1,BM_SETCHECK,1,0);
          break;
        case 3:
          if (!EditingSymbol) SetWindowTextUTF8(Dialog,SC(26,"Change value"));
          else SetWindowTextUTF8(Dialog,SC(27,"Change symbol name"));
          if ((WorkingObjectText->Info & TEXT_NOT_VISIBLE) == TEXT_NOT_VISIBLE)
            SendDlgItemMessage(Dialog,IDC_CHECK1,BM_SETCHECK,1,0);
          break;
        case 4:
          SetWindowTextUTF8(Dialog,SC(28,"Add external connection"));
          break;
        case 5:
          SetWindowTextUTF8(Dialog,SC(29,"Change external connection"));
          break;
        case 6:
          SetWindowTextUTF8(Dialog,SC(30,"Search for any text"));
          break;
        case 7:
//          SetWindowTextUTF8(Dialog,"Can not find exe path, type the exe path");
          break;
        case 8:
          SetWindowTextUTF8(Dialog,SC(31,"Add symbol on shortcut"));
          break;
        case 9:
          SetWindowTextUTF8(Dialog,SC(32,"Line width (0.1 = standard)"));
          break;
        case 10:
          SetWindowTextUTF8(Dialog,SC(33,"Rotation (Degrees counter clock wise)"));
          break;
        case 11:
          SetWindowTextUTF8(Dialog,SC(34,"Scale factor"));
          break;
        case 12:
          SetWindowTextUTF8(Dialog,SC(35,"Text height"));
          break;
        case 13:
          SetDialogItemText(Dialog,IDC_STATIC1    ,SC(35,"Text height"));
          SetWindowTextUTF8(Dialog,SC(24,"Change text"));
          ...
          break;
        case 14:
          SetWindowTextUTF8(Dialog,SC(468,"Goto (x,y)"));
          break;
      }
    ...
    case WM_COMMAND:
      switch (LOWORD(WParam)) {
        case IDOK:
          ...
          res=SendDlgItemMessageUTF8(Dialog,IDC_EDIT1,WM_GETTEXT,sizeof(WorkingObjectText->Text)-1,
          ...
          switch (DialogMode) {
            ...
            case 14:
              ...
              if ((res>0)
                 &&
                 (sscanf(str,"%f,%f",&x,&y)==2)) {
                WorkingObjectText->X=x;
                WorkingObjectText->Y=y;
              } else {
                MessageBoxUTF8(SCHWindow,SC(469,"Wrong coordinates for goto x,y"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
                return about;
              }
              break;
          }
...
//  DialogWindowText=DialogText;
  ...
  switch (DialogMode) {
    case 0:
      res=DialogBox(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT4), SCHWindow, (DLGPROC)TextInputDialog2);
      break;
    case 1:
      res=DialogBox(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT3), SCHWindow, (DLGPROC)TextInputDialog2);
      break;
    case 2:
    case 3:
      res=DialogBox(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT), SCHWindow, (DLGPROC)TextInputDialog2);
      break;
    case 13:
      res=DialogBox(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT4), SCHWindow, (DLGPROC)TextInputDialog2);
      break;
    case 14:
      res=DialogBox(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT2), SCHWindow, (DLGPROC)TextInputDialog2);
      break;
    default:
      res=DialogBox(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT2), SCHWindow, (DLGPROC)TextInputDialog2);
      break;
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL         ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP           ,SC(3,"Help"));
      SetWindowTextUTF8(Dialog,SC(36,"Nr parts"));
...

{
  ...
  if (SendDlgItemMessage(Dialog,IDC_RADIO1,BM_GETCHECK,0,0)==1) LastPinConnectionType=CONNECTION_INPUT;
  if (SendDlgItemMessage(Dialog,IDC_RADIO2,BM_GETCHECK,0,0)==1) LastPinConnectionType=CONNECTION_OUTPUT;
  if (SendDlgItemMessage(Dialog,IDC_RADIO3,BM_GETCHECK,0,0)==1) LastPinConnectionType=CONNECTION_IO;
  if (SendDlgItemMessage(Dialog,IDC_RADIO4,BM_GETCHECK,0,0)==1) LastPinConnectionType=CONNECTION_TRISTATE;
  if (SendDlgItemMessage(Dialog,IDC_RADIO5,BM_GETCHECK,0,0)==1) LastPinConnectionType=CONNECTION_OC;
  if (SendDlgItemMessage(Dialog,IDC_RADIO6,BM_GETCHECK,0,0)==1) LastPinConnectionType=CONNECTION_PASSIVE;
  if (SendDlgItemMessage(Dialog,IDC_RADIO7,BM_GETCHECK,0,0)==1) LastPinConnectionType=CONNECTION_POWER;
  if (mode==0) {
    if (SendDlgItemMessage(Dialog,IDC_RADIO8,BM_GETCHECK,0,0)==1) LastPinType=CONNECTION_UNDEFINED;
    if (SendDlgItemMessage(Dialog,IDC_RADIO9,BM_GETCHECK,0,0)==1) LastPinType=CONNECTION_TTL;
    if (SendDlgItemMessage(Dialog,IDC_RADIO10,BM_GETCHECK,0,0)==1) LastPinType=CONNECTION_LVTTL;
    if (SendDlgItemMessage(Dialog,IDC_RADIO11,BM_GETCHECK,0,0)==1) LastPinType=CONNECTION_CMOS;
    if (SendDlgItemMessage(Dialog,IDC_RADIO12,BM_GETCHECK,0,0)==1) LastPinType=CONNECTION_ANALOG;
  }
...

{
  ...
  char    sel[MAX_LENGTH_STRING],LabelName[MAX_LENGTH_STRING],NewLabelName[MAX_LENGTH_STRING],
          PinTextName[MAX_LENGTH_STRING],NewPinTextName[MAX_LENGTH_STRING],
          PinName[MAX_LENGTH_STRING],NewPinName[MAX_LENGTH_STRING],
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL        ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP          ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1     ,SC(39,"Pin Name"));
      SetDialogItemText(Dialog,IDC_STATIC2     ,SC(40,"Pin Text"));
      SetDialogItemText(Dialog,IDC_STATIC3     ,SC(41,"Label"));
      SetDialogItemText(Dialog,IDC_STATIC4     ,SC(42,"Offset +X"));
      SetDialogItemText(Dialog,IDC_STATIC5     ,SC(43,"Offset +Y"));
      SetDialogItemText(Dialog,IDC_STATIC6     ,SC(44,"Connection"));
      SetDialogItemText(Dialog,IDC_STATIC7     ,SC(45,"Type"));
      SetDialogItemText(Dialog,IDC_STATIC9     ,SC(440,"Auto numbering"));
      SetDialogItemText(Dialog,IDC_STATIC10    ,SC(441,"Start"));
      SetDialogItemText(Dialog,IDC_STATIC11    ,SC(442,"Increment"));
      SetDialogItemText(Dialog,IDC_STATIC12    ,SC(79,"Nr pins"));
      SetDialogItemText(Dialog,IDC_STATIC15    ,SC(439,"Postion increment"));
      SetDialogItemText(Dialog,IDC_RADIO1      ,SC(46,"Input"));
      SetDialogItemText(Dialog,IDC_RADIO2      ,SC(47,"Output"));
      SetDialogItemText(Dialog,IDC_RADIO3      ,SC(48,"IO"));
      SetDialogItemText(Dialog,IDC_RADIO4      ,SC(49,"Tristate"));
      SetDialogItemText(Dialog,IDC_RADIO5      ,SC(50,"Open collector"));
      SetDialogItemText(Dialog,IDC_RADIO6      ,SC(51,"Passive"));
      SetDialogItemText(Dialog,IDC_RADIO7      ,SC(52,"Power"));
      SetDialogItemText(Dialog,IDC_RADIO8      ,SC(53,"Undefined"));
      SetDialogItemText(Dialog,IDC_RADIO9      ,"TTL");
      SetDialogItemText(Dialog,IDC_RADIO10     ,"LVTTL");
      SetDialogItemText(Dialog,IDC_RADIO11     ,"CMOS");
      ...
      switch (DialogMode) {
        case 0:
          SetWindowTextUTF8(Dialog,SC(57,"Add pin(s)"));
          break;
        case 1:
          SetWindowTextUTF8(Dialog,SC(58,"Change pin"));
          break;
        case 2:
          SetWindowTextUTF8(Dialog,SC(59,"Add pin label(s)"));
          break;
        case 3:
          SetWindowTextUTF8(Dialog,SC(60,"Change pin label"));
          break;
      }
      ...
      PowerPin=0;
      if (WorkingPin->ConnectionType==POWER_CONNECTION) PowerPin=1;
      switch (DialogMode) {
        case 0:
        case 2:
    ...
    case WM_COMMAND:
      switch (LOWORD(WParam)) {
        ...
        case IDOK:
          ...
          PowerPin=0;
          if (LastPinConnectionType==POWER_CONNECTION) PowerPin=1;
// ********************************************************************************************
// ********************************************************************************************
          ...
          switch (DialogMode) {
            case 0:
              if (GetDialogFloatValue(Dialog,IDC_EDIT4,&AddPinDialogDivX)==0) {
                MessageBoxUTF8(SCHWindow,SC(61,"Wrong value in offset +X"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
                return about;
              }
              if (GetDialogFloatValue(Dialog,IDC_EDIT5,&AddPinDialogDivY)==0) {
                MessageBoxUTF8(SCHWindow,SC(62,"Wrong value in offset +Y"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
                return about;
              }
              if ((AddPinDialogDivX==0.0)
                 &&
                 (AddPinDialogDivY==0.0)) {
              ...
              AutoNumbering=0;
              if ((SendDlgItemMessage(Dialog,IDC_EDIT6,WM_GETTEXT,MAX_LENGTH_STRING-50,(LPARAM)&NumberString)>0)
                 &&
                 (sscanf(NumberString,"%i",&StartNumber)==1)
                 &&
                 (StartNumber>=0)
                 &&
                 (SendDlgItemMessage(Dialog,IDC_EDIT7,WM_GETTEXT,MAX_LENGTH_STRING-50,(LPARAM)&NumberString)>0)
                 &&
                 (sscanf(NumberString,"%i",&IncNumber)==1)
                 &&
                 (IncNumber!=0)
                 &&
                 (SendDlgItemMessage(Dialog,IDC_EDIT8,WM_GETTEXT,MAX_LENGTH_STRING-50,(LPARAM)&NumberString)>0)
                 &&
                 (sscanf(NumberString,"%i",&NrOfPins)==1)
                 &&
                 (NrOfPins>0)) {
                AutoNumbering=1;
              }
              ...
              if (AutoNumbering) {
                ...
                if ((res=SendDlgItemMessageUTF8(Dialog,IDC_EDIT1,WM_GETTEXT,MAX_LENGTH_STRING-50,
                                                (LPARAM)DialogTextLine))>0) {
                  DialogTextLine[res]=0;
                  while ((res>0)
                        &&
                        ((DialogTextLine[res-1]==' '))) {
...
// ******************************************************************************************
                ...
                for (cnt=0;cnt<NrOfPins;cnt++) {
                  ...
                  memmove(&AddedPins[NrAddPins].Name,&NewPinName,
                          sizeof(AddedPins[NrAddPins].Name)-1);
                    ...
                    if (!PowerPin) {
                      if (PinTextName[0]==0) {
                        ...
                        if (CheckLabelName(NewPinTextName)==-1) {
                          sprintf(sel,SC(64,"Pin text ( %s ) is not valid for use as a label name"),NewPinTextName);
                          MessageBoxUTF8(SCHWindow,sel,SC(38,"Error"),MB_APPLMODAL|MB_OK);
                          return about;
                        }
    ...
    // ******************************************************************************************
                    ...
                    AddedPins[NrAddPins].ConnectionType=(int16)LastPinConnectionType;
                    memset(&AddedPinText[NrAddPins],0,sizeof(ObjectTextRecord));
                    memmove(&AddedPins[NrAddPins].Name,&DialogTextLine,
                            sizeof(AddedPins[NrAddPins].Name)-1);
                      ...
                      if (!PowerPin) {
                        if (PinTextName[0]==0) {
                          ...
                          if (CheckLabelName(PinTextName)==-1) {
                            sprintf(sel,SC(64,"Pin text ( %s ) is not valid for use as a label name"),PinTextName);
                            MessageBoxUTF8(SCHWindow,sel,SC(38,"Error"),MB_APPLMODAL|MB_OK);
                            return about;
                          }
                          strcpy(AddedPinText[NrAddPins].Text,PinTextName);
...
// ********************************************************************************************
  ...
  // ******************************************************************************************
              ...
              if ((res=SendDlgItemMessageUTF8(Dialog,IDC_EDIT4,WM_GETTEXT,(WPARAM)17,
                                          (LPARAM)DialogTextLine))>0) {
...
#endif
              if (PinChanged) EndDialog(Dialog, 1);
              else EndDialog(Dialog, 2);
              break;
// ********************************************************************************************
// ********************************************************************************************
  ...
  // ******************************************************************************************
                  ...
                  memmove(&AddedPins[NrAddPins].Name,&DialogTextLine,
                          sizeof(AddedPins[NrAddPins].Name)-1);
                  memmove(&AddedPins[NrAddPins].Label,&DialogTextLine,
                          sizeof(AddedPins[NrAddPins].Label)-1);
...
// ********************************************************************************************
            case 3:
              if ((res=SendDlgItemMessageUTF8(Dialog,IDC_EDIT1,WM_GETTEXT,MAX_LENGTH_STRING-50,
                                              (LPARAM)DialogTextLine))==0) {
                MessageBoxUTF8(SCHWindow,SC(68,"Label should have a name"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
                return about;
              }
...
#else
      res=DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_ADDPINS2), SCHWindow, (DLGPROC)AddPinsDialog2);
#endif
      break;
    case 2:
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL        ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP          ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1     ,SC(69,"Net Name"));
      SetDialogItemText(Dialog,IDC_STATIC2     ,SC(70,"Power pin(s)"));
      SetDialogItemText(Dialog,IDC_CHECK1      ,SC(71,"Power pin not visible in sheet"));

      if (DialogMode==0) SetWindowTextUTF8(Dialog,SC(72,"Add powerpin"));
      else SetWindowTextUTF8(Dialog,SC(73,"Change powerpin"));
    ...
    case WM_COMMAND:
      switch (LOWORD(WParam)) {
        case IDOK:
          PowerPinChanged=0;
          res=SendDlgItemMessageUTF8(Dialog,IDC_EDIT1,WM_GETTEXT,MAX_LENGTH_STRING-50,(LPARAM)DialogTextLine);
          DialogTextLine[res]=0;
          if (DialogTextLine[0]==0) {
          ...
          res=SendDlgItemMessageUTF8(Dialog,IDC_EDIT2,WM_GETTEXT,MAX_LENGTH_STRING-50,(LPARAM)DialogTextLine);
          DialogTextLine[res]=0;
          if (DialogTextLine[0]==0) {
            MessageBoxUTF8(SCHWindow,SC(76,"Power pin(s) must have a name"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
            return about;
          }
          while ((res>0)
                &&
          ...
          cnt3=0;
          while (cnt3<res) {
            if ((DialogTextLine2[cnt3]!=' ')
               &&
               (DialogTextLine2[cnt3]!='\t')) {
          ...
          if (PowerPinChanged) EndDialog(Dialog, 1);
          else EndDialog(Dialog, 2);
          return about;
        case IDHELP:
          if (DialogMode==0) {
...
//  DialogWindowText=DialogText;
  ...
  res=DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_ADDPOWERPINS), SCHWindow, (DLGPROC)AddPowerPinsDialog2);
  ok=1;
  return res;
}
...

{
  ...
  int32   hulp,TempPinConnectionType,TempPinType,cnt,cnt2,cnt3,TotalLength,
          res,StringLength,NrLines,LastLength,PinCount;
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDC_RADIO11     ,"CMOS");
      SetDialogItemText(Dialog,IDC_RADIO12     ,SC(54,"Analog"));
      SetDialogItemText(Dialog,IDC_RADIO13     ,SC(52,"Power"));
      SetDialogItemText(Dialog,IDC_CHECK1      ,SC(56,"Pin name not visible"));

      if (DialogMode==0) SetWindowTextUTF8(Dialog,SC(81,"Add pinbus"));
      else SetWindowTextUTF8(Dialog,SC(82,"Change pinbus"));
      ...
      for (cnt=0;cnt<(int32)strlen(WorkingPinBus->Text);cnt++) {
        if (WorkingPinBus->Text[cnt]=='\\') {
          ...
          if (cnt2<sizeof(DialogTextLine)-5) cnt2+=2;
        } else {
          DialogTextLine[cnt2]=WorkingPinBus->Text[cnt];
          if (cnt2<sizeof(DialogTextLine)-5) cnt2++;
        }
      }
      ...
      switch (LOWORD(WParam)) {
        case IDOK:
          ...
          for (cnt=0;cnt<8;cnt++) {
            ...
            if (DialogTextLine[0]!=0) {
              if (res>127) {
                MessageBoxUTF8(SCHWindow,SC(83,"Nr characters in a line > 127"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
                return about;
              }
              while ((res>0)
                    &&
...
//          memset(&PinTextName,0,sizeof(PinText));
          ...
          if ((res=SendDlgItemMessageUTF8(Dialog,IDC_EDIT4,WM_GETTEXT,MAX_LENGTH_STRING-50,
                                          (LPARAM)DialogTextLine))!=0) {
            DialogTextLine[res]=0;
            while ((res>0)
                  &&
          ...
          for (cnt=0;cnt<8;cnt++) {
            ...
            if (StringLength>0) {
              if (LastLength==0) {
                MessageBoxUTF8(SCHWindow,SC(87,"Nr characters in a line is 0"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
                return about;
              }
              ...
              if ((res=GetNrPinNames(PinStrings[cnt]))>0) PinCount+=res;
              if (TotalLength+StringLength+1<sizeof(PtrPinBus->Text)) {
                ...
                MessageBoxUTF8(SCHWindow,SC(89,"Nr characters in all lines > 371"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
                return about;
              }
            } else {
              if (NrLines==0) {
          ...
          if (PtrPinBus->Text[0]==0) {
            MessageBoxUTF8(SCHWindow,SC(91,"Pin bus should have pin names"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
            return about;
          }
...
#ifdef _DEBUG
          memset(DialogTextLine,0,200);
          if ((res=SendDlgItemMessageUTF8(Dialog,IDC_EDIT5,WM_GETTEXT,(WPARAM)17,
                                      (LPARAM)DialogTextLine))>0) {
            res=strtol(DialogTextLine,&weg,2);
            if (res>0) {
          ...
          if ((DialogMode==0)
             ||
             (PinBusChanged)) EndDialog(Dialog, 1);
          else EndDialog(Dialog, 2);
          return about;
        case IDHELP:
          if (DialogMode==0) {
...
#else
  res=DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_ADDPINBUS), SCHWindow, (DLGPROC)AddPinBusDialog2);
#endif
...
{
  int32   about,ok,ErrorLine,res,cnt,cnt2,cnt3,cnt4,count,count2,
          PinCount,NrSubPinDefsLines,NrPins;
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL          ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP            ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1       ,SC(92,"Pin name"));
      SetDialogItemText(Dialog,IDC_STATIC2       ,SC(93,"Pins per part"));
      ...
      for (cnt=0;cnt<DesignSymbol.NrPins;cnt++) {
        ...
        if ((Pin->Info & (OBJECT_NOT_VISIBLE)) == 0) {
          NrPins++;
          SendDlgItemMessageUTF8(Dialog,IDC_LIST1,LB_ADDSTRING,0,
                                 (LPARAM)(LPSTR)Pin->Name);
          ...
          if (cnt2<NrSubPinDefsLines) {
            for (cnt3=0;cnt3<DesignSymbol.NrPartsPerPackage;cnt3++) {
              ...
              if (cnt3<DesignSymbol.NrPartsPerPackage-1) strcat(DialogTextLine,",");
            }
          }
          ...
          for (cnt=0;cnt<DesignSymbol.NrPins;cnt++) {
            ...
            if ((Pin->Info & (OBJECT_NOT_VISIBLE)) == 0) {
              ...
              for (cnt4=0;cnt4<DesignSymbol.NrPartsPerPackage;cnt4++) {
                while ((cnt2<(int32)strlen(DialogTextLine))
                      &&
                      (DialogTextLine[cnt2]!=',')) cnt2++;
                if (cnt2==cnt3) {
                  ok=0;
                  ErrorLine=NrPins+1;
                }
                if ((ok)
                   &&
                   (count<MaxNrSubPinDefs)) {
                  SubPinDef=&((*SubPinDefs)[count]);
                  memset(SubPinDef,0,sizeof(SubPinDefsType));
                  memmove(SubPinDef,&DialogTextLine[cnt3],(int32)min(sizeof(SubPinDefsType)-1,cnt2-cnt3));
                  cnt2++;
                  cnt3=cnt2;
                  count++;
                  FileChanged=1;
...
//  DialogWindowText=DialogText;
  DialogMode=Mode;
  if (EditingSymbol) {
    res=DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_SUBPINSTRINGS), SCHWindow, (DLGPROC)SubPinStringsDialog2);
  } else res=0;
  ok=1;
  return res;
}
...
{
  int32   about,InstanceChanged,cnt,res,SymbolNr,MemPos,NrPartsPerPackage,NrAttributes,
          LengthIdent,LengthValue,pos,cnt2,cnt3,MaxLength,
          PropertyError,NrCompProperties;
  char    sel[MAX_LENGTH_STRING],AttributeIdent[4096],AttributeValue[4096],
          DialogTextLine[4096],DialogTextLine2[4096],
          DialogTextLine3[4096],DialogTextLine4[4096],
          PropertyID[MAX_LENGTH_STRING],PropertyValue[MAX_LENGTH_STRING],
          PropertyBuf[4096],*InstanceAttrBuf;
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL        ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP          ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDABORT         ,SC(97,"Abort"));
      SetDialogItemText(Dialog,IDC_STATIC1     ,SC(98,"Reference"));
      SetDialogItemText(Dialog,IDC_STATIC2     ,SC(99,"Symbol name"));
      SetDialogItemText(Dialog,IDC_STATIC3     ,SC(100,"Value"));
      SetDialogItemText(Dialog,IDC_STATIC4     ,SC(101,"Part nr"));
      SetDialogItemText(Dialog,IDC_STATIC5     ,SC(102,"Geometry"));
      SetDialogItemText(Dialog,IDC_STATIC6     ,SC(103,"Part description"));
      SetDialogItemText(Dialog,IDC_STATIC7     ,SC(104,"Package part nr"));
      SetDialogItemText(Dialog,IDC_STATIC8     ,SC(123,"Properties"));
      SetDialogItemText(Dialog,IDC_STATIC9     ,SC(124,"Property ID"));
      SetDialogItemText(Dialog,IDC_STATIC10    ,SC(125,"Property value"));
      SetDialogItemText(Dialog,IDC_STATIC11    ,SC(450,"Powernet names overrules"));
      SetDialogItemText(Dialog,IDC_STATIC12    ,SC(451,"Netname"));
      SetDialogItemText(Dialog,IDC_STATIC13    ,SC(452,"New netname"));
      SetDialogItemText(Dialog,IDC_CHECK2      ,SC(105,"Not placed"));
      SetDialogItemText(Dialog,IDC_CHECK3      ,SC(22,"Not visible"));
      SetDialogItemText(Dialog,IDC_CHECK4      ,SC(22,"Not visible"));
      SetDialogItemText(Dialog,IDC_CHECK5      ,SC(523,"No geometry"));

      SetDialogItemText(Dialog,IDC_BUTTON1     ,SC(106,"Select geometry"));
      SetWindowTextUTF8(Dialog,SC(107,"Component info"));

//      Instance=(InstanceRecord *)&((*Instances)[WorkingInstanceNr]);
      ...
      if (DialogMode==0) {
        ...
        for (cnt=0;cnt<Design.NrSymbols;cnt++) {
          ...
          if (stricmpUTF8(SymbolPos->SymbolName,WorkingInstance->SymbolName)==0) SymbolNr=cnt;
        }
        if (SymbolNr==-1) {
          return about;
        }
...

{
  ...
  res=DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_INSTANCEINFO), SCHWindow, (DLGPROC)InstanceInfoDialog2);
  return res;
}
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL       ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP         ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1    ,SC(108,"Net label"));

      if (DialogMode==0) {
        SetWindowTextUTF8(Dialog,SC(109,"Add label"));
//        SetDialogItemText(Dialog,IDC_EDIT1,WM_SETTEXT,0,(LPARAM)&(NetLabelText));
        SendDlgItemMessageUTF8(Dialog,IDC_EDIT1,WM_SETTEXT,0,(LPARAM)&(WorkingNetLabel->Name));
      } else {
        SetWindowTextUTF8(Dialog,SC(110,"Change label"));
        SendDlgItemMessageUTF8(Dialog,IDC_EDIT1,WM_SETTEXT,0,(LPARAM)&(WorkingNetLabel->Name));
      }
      return about;
    case WM_MOVE:
    ...
    case WM_COMMAND:
      switch (LOWORD(WParam)) {
        case IDOK:
          ...
          if ((DialogTextLine[0]==0)
             ||
             (CheckNetName(DialogTextLine)==-1)) {
            sprintf(sel,SC(111,"Net name ( %s ) is not valid"),DialogTextLine);
            MessageBoxUTF8(SCHWindow,sel,SC(38,"Error"),MB_APPLMODAL|MB_OK);
            return about;
          }
//          if (DialogMode==0) {
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDHELP          ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1     ,SC(108,"Net label"));
      SetDialogItemText(Dialog,IDC_STATIC2     ,SC(112,"Start number"));
      SetDialogItemText(Dialog,IDC_STATIC3     ,SC(113,"Step"));
      ...
      switch (LOWORD(WParam)) {
        case IDOK:
          ...
          if (GetDialogIntValue(Dialog,IDC_EDIT2,&DialogStartNr)==0) {
            MessageBoxUTF8(SCHWindow,SC(115,"Wrong value in (Start number)"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
            return about;
          }
          if (GetDialogIntValue(Dialog,IDC_EDIT3,&DialogStep)==0) {
            MessageBoxUTF8(SCHWindow,SC(116,"Wrong value in (Step)"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
            return about;
          }
          EndDialog(Dialog, 1);
          return about;
...

{
  ...
  res=DialogBox(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_ADDLABELS), SCHWindow, (DLGPROC)AddNetlabelsDialog2);
  if (res==1) {
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL       ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP         ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1    ,SC(99,"Symbol name"));
      SetDialogItemText(Dialog,IDC_STATIC2    ,SC(118,"Interface name"));
      SetDialogItemText(Dialog,IDC_STATIC3    ,SC(119,"Initial reference"));
      SetDialogItemText(Dialog,IDC_STATIC4    ,SC(120,"Description"));
      SetDialogItemText(Dialog,IDC_STATIC5    ,SC(121,"Initial geometry"));
      SetDialogItemText(Dialog,IDC_STATIC6    ,SC(122,"Part number"));
      SetDialogItemText(Dialog,IDC_STATIC7    ,SC(123,"Properties"));
      SetDialogItemText(Dialog,IDC_STATIC8    ,SC(124,"Property ID"));
      SetDialogItemText(Dialog,IDC_STATIC9    ,SC(125,"Property value"));
      SetDialogItemText(Dialog,IDC_CHECK1     ,SC(126,"Symbol protected"));
      SetDialogItemText(Dialog,IDC_CHECK2     ,SC(22,"Not visible"));
      SetDialogItemText(Dialog,IDC_CHECK3     ,SC(22,"Not visible"));
      SetDialogItemText(Dialog,IDC_CHECK4     ,SC(127,"Multiple symbols"));
...

{
  ...
  if (!EditingSheetSymbol) {
    res=DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_SYMBOLINFO20), SCHWindow, (DLGPROC)SymbolInfoDialog2);
  } else {
    res=DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_SHEETSYMBOLINFO), SCHWindow, (DLGPROC)SymbolInfoDialog2);
  }
  ok=1;
  return res;
}
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDOK           ,SC(1,"OK"));
      SetDialogItemText(Dialog,IDCANCEL       ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDC_STATIC1    ,SC(112,"Start number"));
      SetDialogItemText(Dialog,IDC_STATIC2    ,SC(113,"Step"));
      SetDialogItemText(Dialog,IDC_STATIC3    ,SC(129,"Count"));
      ...
      switch (LOWORD(WParam)) {
        case IDOK:
          ...
          if (GetDialogIntValue(Dialog,IDC_EDIT1,&ObjectNumbers.Start)==0) {
            MessageBoxUTF8(SCHWindow,SC(131,"Wrong value in Number start"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
            return about;
          }
          if (GetDialogIntValue(Dialog,IDC_EDIT2,&ObjectNumbers.Step)==0) {
            MessageBoxUTF8(SCHWindow,SC(132,"Wrong value in Number step"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
            return about;
          }

          if (GetDialogIntValue(Dialog,IDC_EDIT3,&ObjectNumbers.Count)==0) {
            MessageBoxUTF8(SCHWindow,SC(133,"Wrong value in Count"),SC(38,"Error"),MB_APPLMODAL|MB_OK);
            return about;
          }
          EndDialog(Dialog, 1);
          return about;
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL     ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP       ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1  ,SC(134,"Net labels"));
      SetWindowTextUTF8(Dialog,SC(135,"Add wire/labels"));
      return about;
    case WM_MOVE:
      break;
    case WM_COMMAND:
      switch (LOWORD(WParam)) {
        case IDOK:
          ...
          NrWireLabels=64;
          while ((NrWireLabels>0)
                &&
                (strlen(WireLabel[NrWireLabels-1])==0)) NrWireLabels--;
          if (NrWireLabels==0) EndDialog(Dialog, 2);
...

{
  ...
  if ((Libfp=FileOpenReadOnlyUTF8(str))==-1) return 0;
  if (FileRead(Libfp,&Lib,sizeof(LibRecord),&result)==-1) return 0;
...

{
  ...
  res=1;
  if (FileSearchHandle==INVALID_HANDLE_VALUE) res=0;
  while (res) {
...

{
  ...
  char    str[MAX_LENGTH_STRING],str2[MAX_LENGTH_STRING],str3[MAX_LENGTH_STRING*5],
          InitStr[MAX_LENGTH_STRING],ExeParams[MAX_LENGTH_STRING*5];
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL       ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP         ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1    ,SC(136,"Geometry source"));
      SetDialogItemText(Dialog,IDC_STATIC2    ,SC(137,"Geometries"));
      ...
      SendDlgItemMessage(Dialog,IDC_LIST1,LB_ADDSTRING,0,(LPARAM)str);
...
//              CurrentGeometryNrInLibrary=Found2;
              ...
              if (FileExistsUTF8(GeometrieEditor)!=0) {
                ...
                MessageBox(SCHWindow,str3,SC(38,"Error"),MB_APPLMODAL|MB_OK);
                return about;
              }
              if (LibMode==0) {
                if (FileExistsUTF8(str)==0) {
                  if (ClosingWindowMessage!=0) {
                    ...
                    sprintf(ExeParams,"\"%s\" \"%s\" /S %i,%i,%i,%i %s /a /w %x /u \"%s\"",
                            GeometrieEditor,str,GeomScreenWidth,GeomScreenHeight,
                            GeomStartX,GeomStartY,InitStr,(uint32)SCHWindow,ProjectPath);
                    StartupInfo.cb=sizeof(StartupInfo);
                    StartupInfo.wShowWindow=SW_SHOW;
                    CreateProcess(GeometrieEditor,ExeParams,NULL,NULL,1,0,NULL,NULL,&StartupInfo,&ProcessInfo);
                  }
                } else {
                ...
                sprintf(ExeParams,"\"%s\" \"%s\" /l \"%s\" /S %i,%i,%i,%i %s /a /w %x /u \"%s\"",
                        GeometrieEditor,str,str2,GeomScreenWidth,GeomScreenHeight,
                        GeomStartX,GeomStartY,InitStr,(uint32)SCHWindow,ProjectPath);
                StartupInfo.cb=sizeof(StartupInfo);
                StartupInfo.wShowWindow=SW_SHOW;
                if (ClosingWindowMessage!=0) {
...
// Search in default libraries
  ...
  res=DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_EDITGEOMETRY), SCHWindow, (DLGPROC)SelectGeomDialog2);
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetWindowTextUTF8(Dialog,"About schematic editor");
      SetDialogItemText(Dialog,IDC_STATIC1  ,SC(144,"Schematic editor PCB Elegance"));
      SetDialogItemText(Dialog,IDOK         ,SC(1,"OK"));
      SetDialogItemText(Dialog,IDCANCEL     ,SC(2,"Cancel"));

      sprintf(str,"Build version %i.%i.%i  [ %s ]",PROGRAM_VERSION/100,PROGRAM_VERSION % 100,BUILD_VERSION,TIME_STRING);
#ifdef GCC_COMP
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL          ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP            ,SC(3,"Help"));
      SetDialogItemText(Dialog,ID_CHANGE_COLOR   ,SC(145,"Change color"));
      SetWindowTextUTF8(Dialog,SC(146,"Select colors"));
...
{
  int32  cnt,cnt2,cnt3,cnt4,StrLength,ok,PinCnt,GroupCodes[16],GroupLines[16],
         res,BracePos1,BracePos2,pos1,pos2,LineNr,PinInfo[16][64],NrPinsLine[16],
         PinGroupCnt,PinCodeNr;
    ...
    if (GroupLines[cnt]>0) {
      ...
      for (cnt2=0;cnt2<16;cnt2++) {
        if (GroupCodes[cnt2]==cnt) {
          ...
          while ((!Error)
            ...
            if (!Error) {
              while ((cnt3<StrLength)
                    &&
                    (PinString[cnt2][cnt3]!=',')
                    &&
                    (PinString[cnt2][cnt3]!=')')) cnt3++;
              pos2=cnt3;
              if ((cnt3==StrLength)
                 &&
                 (BracePos1!=-1)) Error=1;
              ...
              if (!Error) {
                if (((pos2-pos1)>0)
                  ...
                  for (cnt4=0;cnt4<(int32)strlen(PinNames[LineNr][PinCnt]);cnt4++) {
                    if (PinNames[LineNr][PinCnt][cnt4]==' ') Error=1;
                  }
                  if (!Error) {
                    res=GetInfoPinName(PinNames[LineNr][PinCnt]);
                    if (res==0) {
                      sprintf(str,SC(152,"Pin or Pinbus %s in line %i does not exist"),PinNames[LineNr][PinCnt],cnt2+1);
                      MessageBoxUTF8(SCHWindow,str,SC(38,"Error"),MB_APPLMODAL|MB_OK);
                      return -1;
                    } else {
                      if ((res & 1024) == 1024) {
                        sprintf(str,SC(153,"Double pin or pinbus %s in line %i"),PinNames[LineNr][PinCnt],cnt2+1);
                        MessageBoxUTF8(SCHWindow,str,SC(38,"Error"),MB_APPLMODAL|MB_OK);
                        return -1;
                      } else {
      ...
      for (cnt2=0;cnt2<LineNr;cnt2++) {
        ...
        for (cnt4=0;cnt4<NrPinsLine[cnt2];cnt4++) {
          ...
          if ((PinInfo[cnt2][cnt4] & 2048) == 2048) SwapInfo++;
    ...
    for (cnt=0;cnt<DesignSymbol.NrPinBusses;cnt++) {
      ...
      if ((PinBus->Info & OBJECT_NOT_VISIBLE) == 0) {
        if ((PinBus->Info & 0x10) == 0x10) {
          ...
          if ((PinBus->AddNr<=TempLastActionNr)
             &&
             (PinBus->SwapInfo!=0)) {
            memmove(&NewPinBus,PinBus,sizeof(PinBusRecord));
...
{
  int32   about,NewPinGroup,LineIndexExists,FirstLine,FirstPinSwap,
          FirstPinPlaced,cnt,SwapInfo,TestSwapInfo,res,Group,LineIndex,PinIndex,
          MaxLineIndex,MaxPinIndex,GroupCount;
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL         ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP           ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1      ,SC(158,"Code"));
      SetDialogItemText(Dialog,IDC_STATIC2      ,SC(159,"Pins"));
      SetDialogItemText(Dialog,IDC_STATIC3      ,SC(160,"Line 1"));
      SetDialogItemText(Dialog,IDC_STATIC4      ,SC(161,"Line 2"));
      SetDialogItemText(Dialog,IDC_STATIC5      ,SC(162,"Line 3"));
      SetDialogItemText(Dialog,IDC_STATIC6      ,SC(163,"Line 4"));
      SetDialogItemText(Dialog,IDC_STATIC7      ,SC(164,"Line 5"));
      SetDialogItemText(Dialog,IDC_STATIC8      ,SC(165,"Line 6"));
      SetDialogItemText(Dialog,IDC_STATIC9      ,SC(166,"Line 7"));
      SetDialogItemText(Dialog,IDC_STATIC10     ,SC(167,"Line 8"));
      SetDialogItemText(Dialog,IDC_STATIC11     ,SC(168,"Line 9"));
      SetDialogItemText(Dialog,IDC_STATIC12     ,SC(169,"Line 10"));
      SetDialogItemText(Dialog,IDC_STATIC13     ,SC(170,"Line 11"));
      SetDialogItemText(Dialog,IDC_STATIC14     ,SC(171,"Line 12"));
      SetDialogItemText(Dialog,IDC_STATIC15     ,SC(172,"Line 13"));
      SetDialogItemText(Dialog,IDC_STATIC16     ,SC(173,"Line 14"));
      SetDialogItemText(Dialog,IDC_STATIC17     ,SC(174,"Line 15"));
      SetDialogItemText(Dialog,IDC_STATIC18     ,SC(175,"Line 16"));
          ...
          for (LineIndex=0;LineIndex<MaxLineIndex;LineIndex++) {
            ...
            for (PinIndex=0;PinIndex<MaxPinIndex;PinIndex++) {
              ...
              for (cnt=0;cnt<DesignSymbol.NrPins;cnt++) {
                ...
                if (((Pin->Info & OBJECT_NOT_VISIBLE) == 0)
                   &&
                   ((Pin->SwapInfo & 0xfffe) == TestSwapInfo)) {
                  if (!LineIndexExists) {
                    if (FirstLine) {
                      strcat(GroupStr,"\r\n");
                      strcat(PinStr,"\r\n");
...

{
  ...
  DialogMode=Mode;
  res=DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_GATEPINSWAP), SCHWindow, (DLGPROC)GatePinSwapDialog2);
  for (cnt=0;cnt<DesignSymbol.NrPins;cnt++) {
    Pin=&((*Pins)[cnt]);
    if ((Pin->Info & OBJECT_NOT_VISIBLE) == 0) {
      Pin->Info&=~0x10;
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDHELP          ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1     ,SC(98,"Reference"));
      SetDialogItemText(Dialog,IDC_STATIC2     ,SC(179,"Pin bus label"));
      SetDialogItemText(Dialog,IDC_STATIC3     ,SC(180,"Nr pins pinbus"));
      SetDialogItemText(Dialog,IDC_STATIC4     ,SC(181,"Reorder"));
      SetWindowTextUTF8(Dialog,SC(182,"Pinbus reorder"));
...
/*
          memset(DialogTextLine,0,200);
          if (res=SendDlgItemMessage(Dialog,IDC_EDIT1,EM_GETLINE,31,(LPARAM)DialogTextLine)==0) {
          ...
          memset(DialogTextLine,0,200);
          if (res=SendDlgItemMessage(Dialog,IDC_EDIT2,EM_GETLINE,31,(LPARAM)DialogTextLine)==0) {
...
*/
          ...
          for (cnt=0;cnt<NewRedefinedPinBus.Info2;cnt++) {
            ...
            if (res<0) Error=1;
            if ((sscanf(sel,"%i",&hulp)!=1)
               ||
               (hulp<0)
               ||
               (hulp>=NewRedefinedPinBus.Info2)) {
              Error=1;
            }
            if (!Error) {
...

{
  ...
  res=DialogBox(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_PINBUSREORDER), SCHWindow, (DLGPROC)PinBusReorderDialog2);
  if (res==1) {
...

{
  ...
  if (Mode==0) {
    if ((Libfp=FileOpenReadOnlyUTF8(FileName))==-1) return 0;
    if (FileRead(Libfp,&Lib,sizeof(LibRecord),&result)==-1) return 0;
    if (strcmp(Lib.Identification,LibraryCode1)==0) {
      ...
      while ((!Found)
            &&
            (cnt<NrLibEntries)) {
        if (FileRead(Libfp,&LibName,sizeof(LibNameRecord),&result)==-1) return 0;
  ...
  if ((Designfp=FileOpenReadOnlyUTF8(FileName))==-1) return 0;
...

{
  ...
  char  str[MAX_LENGTH_STRING],str2[MAX_LENGTH_STRING],
        str3[MAX_LENGTH_STRING],str5[MAX_LENGTH_STRING];
...
// ********************************************************************************************************
  ...
  while (res) {
    ...
    if (((SearchString2W[0]!='*')
       ...
       ((SearchString2W[0]=='*')
       &&
       (wcsstr(str4,(WCHAR *)&SearchString2W[1])!=0))) {
...

{
  ...
  char    str[MAX_LENGTH_STRING],str2[MAX_LENGTH_STRING],str3[MAX_LENGTH_STRING],
          str4[MAX_LENGTH_STRING],InfoStr[MAX_LENGTH_STRING];
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL       ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP         ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1    ,SC(186,"Symbol"));
      SetDialogItemText(Dialog,IDC_STATIC2    ,SC(128,"Symbol info"));
...

{
  ...
  if (TextInputDialog(&SymbolText,8)==2) return -1;
  if (SymbolText.Text[0]==0) return -1;
  if (strcmp(SymbolText.Text,"*")==0) return -1;

  strcpy(SearchString2,SymbolText.Text);
  struprUTF8(SearchString2);
  res=DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_ADDSYMBOL2), SCHWindow, (DLGPROC)AddSymbolOnShortCut2);
  if (res==1) {
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL      ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP        ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1   ,SC(189,"Symbol source"));
      SetDialogItemText(Dialog,IDC_STATIC2   ,SC(190,"Symbols"));
      SetDialogItemText(Dialog,IDC_STATIC3   ,SC(128,"Symbol info"));
      SetWindowTextUTF8(Dialog,SC(187,"Select symbol"));
...
// Add global symbol libraries
  ...
  OkToAddSymbol=0;
  NrTryingSymbols=0;
  SymbolDialog=CreateDialog(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_ADDSYMBOL), SCHWindow, (DLGPROC)SelectSymbolDialog2);
  if (SymbolDialog!=NULL) {
    NetDialogMode=1;
...

{
  ...
  int32 fp,cnt,cnt2,cnt3,Code1,Num,Length,MenuPos2,
        MenuCode,res,ok;
    ...
    switch (CompSelect->Info) {
      case 1:
        ...
        if (cnt2<20) {
          ...
          CompSelect->TreeItem=(HTREEITEM)SendDlgItemMessage(Dialog,TreeID,TVM_INSERTITEM,0,(LPARAM)&CompSelect->TreeItemInfo);
          Parent1=CompSelect->TreeItem;
//          SendDlgItemMessage(Dialog,TreeID,TVM_SETINSERTMARK,0,(LPARAM)CompSelect->TreeItem);
          ok=1;
        }
        break;
      case 2:
...
{
  char    Name[MAX_LENGTH_STRING],Code1Str[MAX_LENGTH_STRING],Code2Str[MAX_LENGTH_STRING],
          PartNr[MAX_LENGTH_STRING],Value[MAX_LENGTH_STRING],
          Geometry[MAX_LENGTH_STRING],CompInfo[MAX_LENGTH_STRING],
          FileStr[MAX_LENGTH_STRING],LineBuf[MAX_LENGTH_STRING],
          DialogTextLine[MAX_LENGTH_STRING],TestString[MAX_LENGTH_STRING];
  ...
  while ((Length=ReadLnWithMaxLength(fp,LineBuf,MAX_LENGTH_STRING-1))>=0) {
    ...
    if ((Length>1)
      ...
      Code1=0;
      Code2=0;
      if ((sscanf(Code1Str,"%d",&Code1)==1)
         &&
         (sscanf(Code2Str,"%d",&Code2)==1)
         &&
         (Code1>=1)
         &&
         (Code1<=9)
        ...
        switch (mode) {
          case 0: // Search for a code1, code2 type components
            if ((Code1==Comp1)
              ...
              sprintf(DialogTextLine,"%s\t%s\t%s\t%s\t%s\t%d,%d",
                      Name,PartNr,Value,Geometry,CompInfo,
                      Code1,Code2);
...
{
  int32   about,cnt,res,res2,ok,hulp,TabStops[5],code1,code2,
          pos,Selected,Length,dialogunitX,lengte;
  char    Name[MAX_LENGTH_STRING],PartNr[MAX_LENGTH_STRING],CodeStr[MAX_LENGTH_STRING],
          Value[MAX_LENGTH_STRING],Geometry[MAX_LENGTH_STRING],CompInfo[MAX_LENGTH_STRING],
          FileStr[MAX_LENGTH_STRING],LineBuf[MAX_LENGTH_STRING],str[MAX_LENGTH_STRING],
          DialogTextLine[MAX_LENGTH_STRING],FileName[MAX_LENGTH_STRING];
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      SetDialogItemText(Dialog,IDCANCEL       ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP         ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1    ,SC(198,"Component groups"));
      SetDialogItemText(Dialog,IDC_STATIC2    ,SC(199,"Component"));
      SetDialogItemText(Dialog,IDC_STATIC3    ,SC(100,"Value"));
      SetDialogItemText(Dialog,IDC_STATIC4    ,SC(200,"Partnr"));
      SetDialogItemText(Dialog,IDC_STATIC5    ,SC(120,"Description"));
      SetDialogItemText(Dialog,IDC_STATIC6    ,SC(201,"Component search"));
      SetDialogItemText(Dialog,IDC_STATIC12   ,SC(102,"Geometry"));
      SetDialogItemText(Dialog,IDC_BUTTON1    ,SC(432,"Search"));
      SetDialogItemText(Dialog,IDC_BUTTON2    ,SC(432,"Search"));
      SetDialogItemText(Dialog,IDC_BUTTON3    ,SC(432,"Search"));
      SetDialogItemText(Dialog,IDC_BUTTON4    ,SC(432,"Search"));
      SetDialogItemText(Dialog,IDC_BUTTON5    ,SC(432,"Search"));


/*
      SetDialogItemText(Dialog,IDC_STATIC7    ,SC(99,"Symbol name"));
      SetDialogItemText(Dialog,IDC_STATIC8    ,SC(122,"Part number"));
      SetDialogItemText(Dialog,IDC_STATIC9    ,SC(100,"Value"));
      SetDialogItemText(Dialog,IDC_STATIC10   ,SC(102,"Geometry"));
      SetDialogItemText(Dialog,IDC_STATIC11   ,SC(103,"Part description"));
*/
...
//      RefName,PartNr,Value,Geometry,CompInfo,
      ...
      SendDlgItemMessage(Dialog,IDC_LIST2,LB_ADDSTRING,0,(LPARAM)str);
      return about;
    case WM_MOVE:
      GetWindowRect(Dialog,&DialogWindowRect);
...

{
  ...
  OkToAddSymbol=0;
  NrTryingSymbols=0;
  ComponentDialog=CreateDialog(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_ADDCOMP), SCHWindow,
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL       ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP         ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC4    ,SC(229,"Grid"));
      SetDialogItemText(Dialog,IDC_CHECK4     ,SC(460,"Cross hair"));
      SetDialogItemText(Dialog,IDC_STATIC7    ,SC(392,"Repeat mode"));
      SetDialogItemText(Dialog,IDC_CHECK5     ,SC(459,"On"));
      SetDialogItemText(Dialog,IDC_CHECK6     ,SC(459,"On"));
      if (DialogMode==0) {
        SetDialogItemText(Dialog,IDC_CHECK7     ,SC(521,"Append properties to netlabels"));
        SetDialogItemText(Dialog,IDC_CHECK8     ,SC(522,"Append properties to references"));
      }
      SetDialogItemText(Dialog,IDC_STATIC6    ,SC(367,"Selection mode"));
      SetDialogItemText(Dialog,IDC_STATIC9    ,SC(481,"Mouse cursor Info display"));
      SetDialogItemText(Dialog,IDC_STATIC10   ,SC(482,"Sec"));
      SetDialogItemText(Dialog,IDC_STATIC11   ,SC(482,"Sec"));
      SetDialogItemText(Dialog,IDC_STATIC12   ,SC(483,"Activate after"));
      SetDialogItemText(Dialog,IDC_STATIC13   ,SC(484,"Visible for"));
      ...
      SetDialogItemText(Dialog,IDC_STATIC5    ,SC(461,"Wire/line select mode"));
      ...
      if (DialogMode==0) {
        SetDialogItemText(Dialog,IDC_CHECK2     ,SC(462,"Disable one pinnet check"));
//        SetDialogItemText(Dialog,IDC_CHECK3     ,SC(463,"Do not display component/net info"));
        SetDialogItemText(Dialog,IDC_CHECK1     ,SC(454,"Activate"));
        SetDialogItemText(Dialog,IDC_STATIC1    ,SC(455,"Start number"));
        SetDialogItemText(Dialog,IDC_STATIC2    ,SC(456,"Sheet numbering"));
        ...
        SetDialogItemText(Dialog,IDC_STATIC5    ,SC(461,"Line select mode"));
...

{
  DialogMode=mode;
  if (mode==0) {
    DialogBox(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_VIEW_SHEET), SCHWindow, (DLGPROC)EditSymbolSheetInfoDialog2);
  } else {
    DialogBox(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_VIEW_SYMBOL), SCHWindow, (DLGPROC)EditSymbolSheetInfoDialog2);
  }
  RePaint();
  return 0;
}
...

{
  ...
  char   str[MAX_LENGTH_STRING],SearchStr2[MAX_LENGTH_STRING],
         str2[MAX_LENGTH_STRING],str3[MAX_LENGTH_STRING],
         str4[MAX_LENGTH_STRING],SearchFileName[MAX_LENGTH_STRING];
  WCHAR  str5[MAX_LENGTH_STRING],str6[MAX_LENGTH_STRING],
         SearchStrW[MAX_LENGTH_STRING];
  WIN32_FIND_DATAW FileInfo;
  HANDLE FileSearchHandle;
...
//    SendDlgItemMessageW(Dialog,IDC_LIST2,LB_ADDSTRING,0,(LPARAM)strW);
  ...
  for (cnt=0;cnt<NrGeometryLibFiles;cnt++) {
    if ((Libfp=FileOpenReadOnlyUTF8(GeometryLibNames[cnt]))==-1) return 0;
    if (FileRead(Libfp,&Lib,sizeof(LibRecord),&result)==-1) return 0;
    if (strcmp(Lib.Identification,GeometryLibraryCode1)==0) {
      NrLibEntries=Lib.NrLibEntries;
...

{
  ...
  char    str[MAX_LENGTH_STRING],str2[MAX_LENGTH_STRING],str3[MAX_LENGTH_STRING*5],
          InitStr[MAX_LENGTH_STRING],*strp,ExeParams[MAX_LENGTH_STRING*5];
  PROCESS_INFORMATION ProcessInfo;
              ...
              if (LibMode==0) {
                if (FileExistsUTF8(str)==0) {
                  if (ClosingWindowMessage!=0) {
                    SendMessage(HWND_BROADCAST,ClosingWindowMessage,0,1);
                    sprintf(ExeParams,"\"%s\" \"%s\" /S %i,%i,%i,%i %s /a /w %x /u \"%s\"",
                            GeometrieEditor,str2,GeomScreenWidth,GeomScreenHeight,
                            GeomStartX,GeomStartY,InitStr,(int32)SCHWindow,ProjectPath);
                    StartupInfo.cb=sizeof(StartupInfo);
                    StartupInfo.wShowWindow=SW_SHOW;
                    CreateProcess(GeometrieEditor,ExeParams,NULL,NULL,1,0,NULL,NULL,&StartupInfo,&ProcessInfo);
                  }
...
int32 GetCompString(InstanceRecord *Instance,LPSTR str)
{
  switch (CompSortMode) {
    case 0:
      sprintf(str,"%s\t%s\t%s\t%s\t%s",Instance->Reference,Instance->SymbolName,
              Instance->Value,Instance->Geometry,Instance->PartNr);
      break;
    case 1:
      sprintf(str,"%s\t%s\t%s\t%s\t%s",Instance->SymbolName,Instance->Reference,
              Instance->Value,Instance->Geometry,Instance->PartNr);
      break;
    case 2:
      sprintf(str,"%s\t%s\t%s\t%s\t%s",Instance->Geometry,Instance->Reference,
              Instance->SymbolName,Instance->Value,Instance->PartNr);
      break;
    case 3:
      sprintf(str,"%s\t%s\t%s\t%s\t%s",Instance->Value,Instance->Reference,
              Instance->SymbolName,Instance->Geometry,Instance->PartNr);
      break;
    case 4:
      sprintf(str,"%s\t%s\t%s\t%s\t%s",Instance->PartNr,Instance->Reference,
              Instance->SymbolName,Instance->Value,Instance->Geometry);
      break;
  }
  return 0;
}
...

{
  ...
  char    str[MAX_LENGTH_STRING],
          PartNr[MAX_LENGTH_STRING],Name[MAX_LENGTH_STRING],
          ShapeName[MAX_LENGTH_STRING],Value[MAX_LENGTH_STRING],
          SymbolName[MAX_LENGTH_STRING];
...

{
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      ...
      SetDialogItemText(Dialog,IDCANCEL                   ,SC(2,"Cancel"));
      SetDialogItemText(Dialog,IDHELP                     ,SC(3,"Help"));
      SetDialogItemText(Dialog,IDC_STATIC1                ,SC(510,"Sort by"));
      SetDialogItemText(Dialog,IDC_BUTTON1                ,SC(509,"Move components"));
      SetDialogItemText(Dialog,IDC_BUTTON2                ,SC(508,"Select all"));
      SetDialogItemText(Dialog,IDC_BUTTON3                ,SC(253,"Deselect all"));
      SetDialogItemText(Dialog,IDC_BUTTON4                ,SC(513,"Center screen on component"));
      SendDlgItemMessage(Dialog,IDC_LIST1,LB_SETHORIZONTALEXTENT,1200,0);
      res=SendDlgItemMessage(Dialog,IDC_LIST2,LB_ADDSTRING,0,(LPARAM)SC(98,"Reference"));
      res=SendDlgItemMessage(Dialog,IDC_LIST2,LB_ADDSTRING,0,(LPARAM)SC(99,"Symbol name"));
      res=SendDlgItemMessage(Dialog,IDC_LIST2,LB_ADDSTRING,0,(LPARAM)SC(102,"Geometry"));
      res=SendDlgItemMessage(Dialog,IDC_LIST2,LB_ADDSTRING,0,(LPARAM)SC(100,"Value"));
      res=SendDlgItemMessage(Dialog,IDC_LIST2,LB_ADDSTRING,0,(LPARAM)SC(200,"Partnr"));
      ...
      SetWindowTextOwn(Dialog,SC(511,"Component selections"));
      return about;
    case WM_MOVE:
      break;
    case WM_COMMAND:
...

{
  ...
  res=DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_COMP_SEL), SCHWindow,
  ...
  switch ( Message ) {
    case WM_INITDIALOG:
      switch (DialogMode) {
        case 0:
        case 1:
          SetWindowText(Dialog,"Replace text");
          break;
        case 2:
        case 3:
          SetWindowText(Dialog,"Find nr text occurences");
          break;
        case 4:
          break;
      }
    ...
    case WM_COMMAND:
      ...
      switch (LOWORD(WParam)) {
        case IDOK:
          ...
          if (res>0) strcpy(SearchString,DialogTextLine);
          memset(DialogTextLine,0,200);
          ReplaceString[0]=0;
          res=SendDlgItemMessage(Dialog,IDC_EDIT2,WM_GETTEXT,150,(LPARAM)DialogTextLine);
          if (res>0) strcpy(ReplaceString,DialogTextLine);
...
{
  DialogMode=Mode;
  return DialogBox(SCHClass.hInstance,MAKEINTRESOURCE(IDD_DIALOG_REPLACE),
                   SCHWindow, (DLGPROC)ReplaceDialog2);
}
