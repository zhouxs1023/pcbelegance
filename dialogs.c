...
int32 CALLBACK TextInputDialog2(HWND Dialog, UINT Message, WPARAM WParam, LPARAM LParam)
{
	...
	case WM_INITDIALOG:
		...
		case 3:
			if (!EditingSymbol)
				SetWindowTextUTF8(Dialog, SC(26, "Change value"));
			else
				SetWindowTextUTF8(Dialog, SC(27, "Change symbol name"));
...
//  DialogWindowText=DialogText;
	...
	case 0:
		res =
		    DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT4), SCHWindow,
		              (DLGPROC) TextInputDialog2);
		break;

	case 1:
		res =
		    DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT3), SCHWindow,
		              (DLGPROC) TextInputDialog2);
		break;
	...
	case 3:
		res =
		    DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT), SCHWindow, (DLGPROC) TextInputDialog2);
		break;
	...
	case 14:
		res =
		    DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_TEXTINPUT2), SCHWindow,
		              (DLGPROC) TextInputDialog2);
		break;
...
int32 CALLBACK AddPowerPinsDialog2(HWND Dialog, UINT Message, WPARAM WParam, LPARAM LParam)
{
	...
	case WM_INITDIALOG:
		...
		if (DialogMode == 0)
			SetWindowTextUTF8(Dialog, SC(72, "Add powerpin"));
		else
			SetWindowTextUTF8(Dialog, SC(73, "Change powerpin"));
...
//  DialogWindowText=DialogText;
	...
	res =
	    DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_ADDPOWERPINS), SCHWindow,
...
int32 CALLBACK AddPinBusDialog2(HWND Dialog, UINT Message, WPARAM WParam, LPARAM LParam)
{
	...
	case WM_INITDIALOG:
		...
		if (DialogMode == 0)
			SetWindowTextUTF8(Dialog, SC(81, "Add pinbus"));
		else
			SetWindowTextUTF8(Dialog, SC(82, "Change pinbus"));
...
//  DialogWindowText=DialogText;
	...
	{
		res =
		    DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_SUBPINSTRINGS), SCHWindow,
...
int32 CALLBACK AddNetlabelsDialog2(HWND Dialog, UINT Message, WPARAM WParam, LPARAM LParam)
{
	...
	case WM_COMMAND:
		...
		case IDOK:
			...
			{
				MessageBoxUTF8(SCHWindow, SC(115, "Wrong value in (Start number)"), SC(38, "Error"),
				               MB_APPLMODAL | MB_OK);
				return about;
			}
...
int32 SymbolInfoDialog(SymbolRecord * Symbol)
{
	...
	{
		res =
		    DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_SYMBOLINFO20), SCHWindow,
		              (DLGPROC) SymbolInfoDialog2);
	}
	else
	{
		res =
		    DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_SHEETSYMBOLINFO), SCHWindow,
		              (DLGPROC) SymbolInfoDialog2);
	}
...
int32 CALLBACK NumberInputDialog2(HWND Dialog, UINT Message, WPARAM WParam, LPARAM LParam)
{
	...
	case WM_COMMAND:
		...
		case IDOK:
			...
			{
				MessageBoxUTF8(SCHWindow, SC(131, "Wrong value in Number start"), SC(38, "Error"),
				               MB_APPLMODAL | MB_OK);
				return about;
			}
...
int32 PinBusReorderDialog(RedefinedPinBusRecord * RedefinedPinBus, int32 mode)
{
	...
	res =
	    DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_PINBUSREORDER), SCHWindow,
...
int32 SearchGeometrie()
{
	...
	res =
	    DialogBox(SCHClass.hInstance, MAKEINTRESOURCE(IDD_DIALOG_GEOM_SEARCH), SCHWindow, (DLGPROC) SearchGeomDialog2);
