...
{
  double   hulp,CentreX,CentreY,
          DisplayX,DisplayY,BoardCentreX,BoardCentreY;
...
//              break;
            case 3:
              strcpy(str,SC(150,"Add round through holes"));
              if (GetKeyString(str2,ID_CREATE_SIL,0x21)==1) strcat(str,str2);
              break;
            case 4:
              strcpy(str,SC(151,"Add square through holes"));
              if (GetKeyString(str2,ID_CREATE_SIL2,0x21)==1) strcat(str,str2);
              break;
            case 5:
              strcpy(str,SC(152,"Add round SMD pads"));
              if (GetKeyString(str2,ID_CREATE_SIL_SMD_CIRCLE,0x21)==1) strcat(str,str2);
              break;
            case 6:
              strcpy(str,SC(153,"Add square SMD pads"));
              if (GetKeyString(str2,ID_CREATE_SIL_SMD_RECT,0x21)==1) strcat(str,str2);
              break;
            case 7:
              strcpy(str,SC(154,"Add unplated drill hole"));
              if (GetKeyString(str2,ID_ADD_DRILL_UNPLATED,0x21)==1) strcat(str,str2);
              break;
            case 8:
              strcpy(str,SC(155,"Assign objects to pin"));
              if (GetKeyString(str2,ID_ASSIGN_PINS,0x21)==1) strcat(str,str2);
              break;
            case 9:
              strcpy(str,SC(156,"Add line placement outline"));
              if (GetKeyString(str2,ID_ADD_LINE_PLACE_OUTL,0x21)==1) strcat(str,str2);
              break;
            case 10:
              strcpy(str,SC(157,"Add rectangle placement outline"));
              if (GetKeyString(str2,ID_ADD_RECT_PLACE_OUTL,0x21)==1) strcat(str,str2);
              break;
            case 11:
              strcpy(str,SC(158,"Add line component outline"));
              if (GetKeyString(str2,ID_ADD_LINE_COMP_OUTL,0x21)==1) strcat(str,str2);
              break;
            case 12:
              strcpy(str,SC(159,"Add rectangle component outline"));
              if (GetKeyString(str2,ID_ADD_RECT_COMP_OUTL,0x21)==1) strcat(str,str2);
              break;
            case 13:
              strcpy(str,SC(160,"Undo"));
              if (GetKeyString(str2,ID_EDIT_UNDO,0x21)==1) strcat(str,str2);
              break;
            case 14:
              strcpy(str,SC(161,"Redo"));
              if (GetKeyString(str2,ID_EDIT_REDO,0x21)==1) strcat(str,str2);
              break;
            case 15:
              strcpy(str,SC(162,"Copy"));
              if (GetKeyString(str2,ID_COPY_OBJECTS,0x21)==1) strcat(str,str2);
              break;
            case 16:
              strcpy(str,SC(163,"Delete"));
              if (GetKeyString(str2,ID_EDIT_DELETE,0x21)==1) strcat(str,str2);
              break;
            case 17:
              strcpy(str,SC(164,"Move"));
            ...
            case 18:
              ...
              break;
            case 19:
              strcpy(str,SC(165,"Select layers"));
              if (GetKeyString(str2,ID_VIEW_LAYERS,0x21)==1) strcat(str,str2);
              break;
            case 20:
              strcpy(str,SC(166,"Info selected objects"));
