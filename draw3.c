...
//  SystemBusyMode=300;
  ...
  if (!SelectionEsc) {
    ...
    Xoffset=((hulp*Design.BoardWidth/DisplayX)-(DisplX*0.5)+
            Design.BoardCentreX-Design.BoardWidth/2);
    hulp=(cy+(DisplayY/2)-MousePosY);
    Yoffset=((hulp*Design.BoardHeight/DisplayY)-(DisplY*0.5)+
            Design.BoardCentreY-Design.BoardHeight/2);
//    DisplX=PixelToRealOffX(DrawWindowMaxX)-PixelToRealOffX(DrawWindowMinX);
//    DisplY=PixelToRealOffY(DrawWindowMaxY)-PixelToRealOffY(DrawWindowMinY);
    Rect.left=DrawWindowMinX;
    Rect.right=DrawWindowMaxX;
    ...
    if (NewButtonNr!=NrButtonInfo) {
      ...
      if (!DisplayButtonNr) {
        if ((OldButtonNr!=NewButtonNr)
          ...
          if (!EditingSymbol) {
            switch (val) {
              case 0:
                ...
                if (GetKeyString(str2,ID_FILE_NEW_SHEET,0x21)==1) strcat(str,str2);
                break;
              case 1:
              ...
              case 4:
                ...
                if (GetKeyString(str2,ID_ADDWIRE2,0x21)==1) strcat(str,str2);
                break;
              case 5:
                strcpy(str,SC(236,"Add bus"));
                if (GetKeyString(str2,ID_ADDBUS2,0x21)==1) strcat(str,str2);
                break;
              case 6:
                strcpy(str,SC(237,"Add label to wire/bus"));
                if (GetKeyString(str2,ID_ADDNETLABEL,0x21)==1) strcat(str,str2);
                break;
              case 7:
                strcpy(str,SC(238,"Add busconnection"));
                if (GetKeyString(str2,ID_ADDBUSCONNECTION,0x21)==1) strcat(str,str2);
                break;
              case 8:
                strcpy(str,SC(239,"Add external output connection"));
                if (GetKeyString(str2,ID_ADDGLOBALCONNECTION_O,0x21)==1) strcat(str,str2);
                break;
              case 9:
                strcpy(str,SC(240,"Add external input connection"));
                if (GetKeyString(str2,ID_ADDGLOBALCONNECTION_I,0x21)==1) strcat(str,str2);
                break;
              case 10:
                strcpy(str,SC(241,"Add external I/O connection"));
                if (GetKeyString(str2,ID_ADDGLOBALCONNECTION_IO,0x21)==1) strcat(str,str2);
                break;
              case 11:
                strcpy(str,SC(242,"Add symbol"));
                if (GetKeyString(str2,ID_ADDSYMBOL,0x21)==1) strcat(str,str2);
                break;
              case 12:
                strcpy(str,SC(243,"Add component"));
                if (GetKeyString(str2,ID_ADDCOMPONENT,0x21)==1) strcat(str,str2);
                break;
              case 13:
              ...
              case 18:
                ...
                if (GetKeyString(str2,ID_DRAG_OBJECTS,0x21)==1) strcat(str,str2);
                break;
              case 19:
                strcpy(str,SC(250,"Open subsheet"));
                if (GetKeyString(str2,ID_FILE_EDIT_SHEET,0x21)==1) strcat(str,str2);
                break;
              case 20:
                strcpy(str,SC(251,"Open sheet symbol"));
                if (GetKeyString(str2,ID_FILE_EDIT_SYMBOL,0x21)==1) strcat(str,str2);
                break;
              case 21:
                strcpy(str,SC(252,"Goto higher sheet"));
                if (GetKeyString(str2,ID_FILE_SHEETBACK,0x21)==1) strcat(str,str2);
                break;
              case 22:
                strcpy(str,SC(253,"Unselect all"));
            ...
            switch (val) {
              case 0:
                if (EditingSheetSymbol) {
                  ...
                  if (GetKeyString(str2,ID_FILE_NEW_SHEETSYMBOL,0x21)==1) strcat(str,str2);
                } else {
                  strcpy(str,SC(255,"New symbol"));
                  if (GetKeyString(str2,ID_FILE_NEW_SYMBOL,0x21)==1) strcat(str,str2);
                }
                break;
              case 1:
              ...
              case 3:
                ...
                break;
              case 4:
                strcpy(str,SC(258,"Add pin"));
                if (GetKeyString(str2,ID_ADDPIN,0x21)==1) strcat(str,str2);
                break;
              case 5:
                strcpy(str,SC(81,"Add pinbus"));
                if (GetKeyString(str2,ID_ADDPINBUS,0x21)==1) strcat(str,str2);
                break;
              case 6:
                strcpy(str,SC(259,"Add powertext"));
                if (GetKeyString(str2,ID_ADDPOWERPIN,0x21)==1) strcat(str,str2);
                break;
              case 7:
                strcpy(str,SC(260,"Add line"));
                if (GetKeyString(str2,ID_ADDLINE,0x21)==1) strcat(str,str2);
                break;
              case 8:
                strcpy(str,SC(261,"Add rectangle"));
                if (GetKeyString(str2,ID_ADDRECT2,0x21)==1) strcat(str,str2);
                break;
              case 9:
                strcpy(str,SC(262,"Add circle"));
                if (GetKeyString(str2,ID_ADDCIRCLE,0x21)==1) strcat(str,str2);
                break;
              case 10:
                strcpy(str,SC(263,"Add arc"));
                if (GetKeyString(str2,ID_ADDARC,0x21)==1) strcat(str,str2);
                break;
              case 11:
                strcpy(str,SC(23,"Add text"));
                if (GetKeyString(str2,ID_ADDTEXT,0x21)==1) strcat(str,str2);
                break;
              case 12:
                strcpy(str,SC(244,"Undo"));
                if (GetKeyString(str2,ID_EDIT_UNDO,0x21)==1) strcat(str,str2);
          ...
          TextOut(OutputDisplay,ButtonRect.left+4,ButtonRect.top+4,str,strlen(str));
