...
//  Layer=INFO_LAYER2;
	...
	if (GetNewFileUTF8
	        (PCBWindow, NULL, ImportDXFFile, ExportDir, SC(363, "DXF file"), NULL, SC(364, "DXF files"), "dxf", 0))
		return -1;
...
int32 CALLBACK DXFExportLayerDialogBody(HWND Dialog, UINT Message, WPARAM WParam, LPARAM LParam)
{
	...
	case WM_COMMAND:
		...
		case IDC_BUTTON1:
			if (!GetNewFileUTF8
			        (PCBWindow, NULL, ExportFileName, ExportDir, SC(363, "DXF file"), NULL, SC(364, "DXF files"), "dxf", 1))
				SendDlgItemMessageOwn(Dialog, IDC_EDIT1, WM_SETTEXT, 0, (LPARAM) ExportFileName);
