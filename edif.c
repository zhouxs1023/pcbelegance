...
int32 NrPadStacks,*PadStackObjectStartNr,*PadStackObjectCount,
      NrPinObjects,ok;
      ...
      for (cnt3=0;cnt3<PadStackObjectCount[cnt];cnt3++) {
        ...
        switch (Object->ObjectType) {
          ...
          case PIN_SMD_RECT:                 // SMD Pad rect
            if ((InRange(Object->x2,PinObject->x2))
               &&
               (InRange(Object->y2,PinObject->y2))) {
              PinObject->Info=cnt3;
              Object->Info=cnt2;
            }
            break;
...
{
  int32  Layer,ok,cnt,cnt2,cnt3,cnt4,Mirror,Start,pos,NrShapes,
         count,fp,PinOffset,NewPin,MemPosComp,First,
         ShapeNr,MemPos,PinNr,NrPins,PinsMemPos,ShapePos,
         NrLayers,Found,PadCount,NetNr,NrPinShapes,
         *ShapeNrUsed,NrShapesUsed,LengthLine,
         TempUnits,res,ObjectInclude,ShapeType,Count,ShapeInfo,
...
//  GeomPolygonRecord *GeomPolygon;
  char  str[MAX_LENGTH_STRING],str2[MAX_LENGTH_STRING],DesignName[MAX_LENGTH_STRING],
        str3[MAX_LENGTH_STRING],str4[MAX_LENGTH_STRING],str5[MAX_LENGTH_STRING],
        FileStr[MAX_LENGTH_STRING],
        strx1[64],stry1[64],strx2[64],strx3[64],stry2[64];
