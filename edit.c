  ...
  if ((Mode & 3)<2) {
    ...
    switch (OldDir) {
      case 0:
        if (X1SmallerThenX2(divy,0)) {
          if (X1SmallerThenX2(divx,0)) OldDir=3;
          else
            if (X1GreaterThenX2(divx,0)) OldDir=1;
            else OldDir=2;
        }
        break;
      case 2:
      ...
      case 1:
        if (X1SmallerThenX2(divx,0)) {
          if (X1SmallerThenX2(divy,0)) OldDir=2;
          else
            if (X1GreaterThenX2(divy,0)) OldDir=0;
            else
              if (X1SmallerThenX2(divy,0)) OldDir=3;
        }
        break;
      case 3:
        if (X1GreaterThenX2(divx,0)) {
          if (X1SmallerThenX2(divy,0)) OldDir=2;
            ...
            if (X1GreaterThenX2(divy,0)) OldDir=0;
              ...
              if (X1SmallerThenX2(divy,0)) OldDir=1;
        }
        break;
      case -1:
        if ((NotInRange(divx,0))
           ||
           (NotInRange(divy,0))) {
          if (X1GreaterThenX2(divx,0)) {
            if (X1GreaterThenX2(divy,0)) {
              if (X1GreaterThenX2(divx,divy)) OldDir=1;
              else OldDir=0;
            } else {
              if (X1SmallerThenX2(divy,0)) {
                if (X1GreaterThenX2(divx,divy)) OldDir=1;
            ...
            if (X1SmallerThenX2(divx,0)) {
              if (X1GreaterThenX2(divy,0)) {
                if (X1GreaterThenX2(divx,divy)) OldDir=3;
                else OldDir=0;
              } else {
                if (X1SmallerThenX2(divy,0)) {
                  if (X1GreaterThenX2(divx,divy)) OldDir=3;
    ...
    switch (OldDir) {
      ...
      case 2:
        ...
        if ((NotInRange(FirstWire.X1,FirstWire.X2))
           ||
           (NotInRange(FirstWire.Y1,FirstWire.Y2))) {
    ...
    if (GetDimensionTextFromLine(CurrentX2,CurrentY2,CurrentX,CurrentY,
                                 &NewObjectText,NewObjectLine.LineMode)==0) {
...

{
  ...
  if ((Mode & 4)==4) {
    ...
    if (FirstWireOk) {
      WireChanged=0;
      if (!SecondWireOk) {
        PointBetweenLines=TestLineConnectedToCircle(lastx1,lasty1,
                                                    lastx2,lasty2,
                                                    CurrentX,CurrentY,
                                                    0.04);
      } else {
...
// ********************************************************************************
        if ((Count>0)
           &&
           (PointBetweenLines)) {
          if (((InRange(lastx2,FirstWire.X1))
             &&
             (InRange(lasty2,FirstWire.Y1)))
             ||
             ((InRange(lastx2,FirstWire.X2))
             &&
             (InRange(lasty2,FirstWire.Y2)))) {
        ...
        if (WireChanged) CommandAddTryingWire(&FirstWire,4);
        else CommandAddTryingWire(&FirstWire,0);
        lastx1=FirstWire.X1;
        lasty1=FirstWire.Y1;
        lastx2=FirstWire.X2;
        lasty2=FirstWire.Y2;
        ...
        if ((Count>0)
           &&
           (PointBetweenLines)) {
          if (((InRange(lastx2,FirstBus.X1))
             &&
             (InRange(lasty2,FirstBus.Y1)))
             ||
             ((InRange(lastx2,FirstBus.X2))
             &&
             (InRange(lasty2,FirstBus.Y2)))) {
        ...
        if (WireChanged) CommandAddTryingBus(&FirstBus,4);
        else CommandAddTryingBus(&FirstBus,0);
        lastx1=FirstBus.X1;
        lasty1=FirstBus.Y1;
        lastx2=FirstBus.X2;
        lasty2=FirstBus.Y2;
...
// ********************************************************************************
    if (SecondWireOk) {
      ...
      if ((Mode & 3)==0) {
        ...
        if (WireChanged) CommandAddTryingWire(&SecondWire,4);
        else CommandAddTryingWire(&SecondWire,0);
        ...
        if (WireChanged) CommandAddTryingBus(&SecondBus,4);
        else CommandAddTryingBus(&SecondBus,0);
        lastx1=SecondBus.X1;
        lasty1=SecondBus.Y1;
        lastx2=SecondBus.X2;
        lasty2=SecondBus.Y2;
...

{
  ...
  while (!SelectionEsc) {
    ...
    if (!Focused) {
      ...
      CheckInputMessages(0);
      ClipMouseCursor();
      if (!SelectionEsc) DrawTryingWire(CurrentX,CurrentY,Mode|0x10000);
    }
    if ((ZoomActive())
       &&
       (!SelectionEsc)) {
...
//      RightButtonPressed=0;
    ...
    if (NrFunctionsInBuf>0) {
      ...
      OldY=CurrentY;
      ClipMouseCursor();
      if (SelectionEsc) DisplayObjectOnEscape=0;
      else DrawTryingWire(CurrentX,CurrentY,Mode|0x10000);
    }
  }
  if (DisplayObjectOnEscape) DrawTryingWire(CurrentX,CurrentY,Mode);
  UnClipMouseCursor();

  if (Count>0) LastActionNr--;
  SystemBusyMode=0;
...

{
  ...
  while (!SelectionEsc) {
    ...
    if (!Focused) {
      ...
      CheckInputMessages(0);
      ClipMouseCursor();
      if (!SelectionEsc) DrawTryingJunction(CurrentX,CurrentY,Mode);
    }
...
//      RightButtonPressed=0;
    ...
    if (NrFunctionsInBuf>0) {
      ...
      ClipMouseCursor();
      if (SelectionEsc) DisplayObjectOnEscape=0;
      else DrawTryingJunction(OldX,OldY,Mode);
    }
  }
  if (DisplayObjectOnEscape) DrawTryingJunction(CurrentX,CurrentY,Mode);
  UnClipMouseCursor();
  if (Count>0) LastActionNr--;
  SystemBusyMode=0;
}
...

{
  ...
  while (!SelectionEsc) {
    ...
    if (!Focused) {
      ...
      CheckInputMessages(0);
      ClipMouseCursor();
      if (!SelectionEsc) DrawTryingOnePinNet(CurrentX,CurrentY,Mode);
    }
...
//      RightButtonPressed=0;
    ...
    if (NrFunctionsInBuf>0) {
      ...
      ClipMouseCursor();
      if (SelectionEsc) DisplayObjectOnEscape=0;
      else DrawTryingOnePinNet(OldX,OldY,Mode);
    }
  }
  if (DisplayObjectOnEscape) DrawTryingOnePinNet(CurrentX,CurrentY,Mode);
  UnClipMouseCursor();
  if (Count>0) LastActionNr--;
  SystemBusyMode=0;
}
...

{
  ...
  while (!SelectionEsc) {
    ...
    if (!Focused) {
      ...
      CheckInputMessages(0);
      ClipMouseCursor();
      if (!SelectionEsc) DrawTryingBusConnection(CurrentX,CurrentY,Mode);
    }
    if ((ZoomActive())
       &&
       (!SelectionEsc)) {
...
//      RightButtonPressed=0;
    ...
    if (NrFunctionsInBuf>0) {
      ...
      ClipMouseCursor();
      if (SelectionEsc) DisplayObjectOnEscape=0;
      else DrawTryingBusConnection(CurrentX,CurrentY,Mode);
    }
  }
  if (DisplayObjectOnEscape) DrawTryingBusConnection(CurrentX,CurrentY,Mode);
  UnClipMouseCursor();
  if (Count>0) LastActionNr--;
  SystemBusyMode=0;
}
...
{
  int32  cnt,NrWiresSelected,NrBussesSelected,res,
         WiresSelected[256],BussesSelected[256];
  BusRecord    *Bus;
  WireRecord   *Wire;
...
{
  int32  cnt,cnt2,NrWiresSelected,res,Found,Length,HighestCnt,LowestCnt,ok,
         count,count2,WiresSelected[256];
...
//        DrawWire(Wire,0.0,0.0,0);
        NrWiresSelected++;
        if (NotInRange(Wire->Y1,Wire->Y2)) Check=0;
        if (Wire->Y1>Highest) {
          Highest=Wire->Y1;
          HighestCnt=cnt;
        }
...
//  strcpy(AddLabelsTextLine,"hallo");
  if ((res=AddNetlabelsDialog(AddLabelsTextLine,&AddLabelsStartNr,&AddLabelsStep))==1) {
    ...
    for (cnt=0;cnt<Length;cnt++) {
      if (AddLabelsTextLine[cnt]=='#') Found=cnt;
    }
...

{
  ...
  while (!SelectionEsc) {
    ...
    if (!Focused) {
      ...
      CheckInputMessages(0);
      ClipMouseCursor();
      if (!SelectionEsc) DrawTryingNetLabel(CurrentX,CurrentY,Mode);
    }
    if ((ZoomActive())
       &&
       (!SelectionEsc)) {
...
//    if (RightButtonPressed) {
  ...
  //    RightButtonPressed=0;
    ...
    if (NrFunctionsInBuf>0) {
      ...
      UnClipMouseCursor();
      if (SelectionEsc) DisplayObjectOnEscape=0;
      else DrawTryingNetLabel(CurrentX,CurrentY,Mode);
    }
  }
  UnClipMouseCursor();
  if (DisplayObjectOnEscape) DrawTryingNetLabel(CurrentX,CurrentY,Mode);
  SystemBusyMode=0;
...
//  while (LeftButtonPressed) CheckInputMessages(0) ;
  ...
  while (!SelectionEsc) {
    ...
    if (!Focused) {
      ...
      CheckInputMessages(0);
      ClipMouseCursor();
      if (!SelectionEsc) DrawTryingObjectRect(CurrentX,CurrentY,Mode);
    }
    if ((ZoomActive())
       &&
       (!SelectionEsc)) {
    ...
    if (LeftButtonPressed) {
      DrawTryingObjectRect(CurrentX,CurrentY,Mode);
      if ((Mode & 2) == 2) {
        if ((NotInRange(NewObjectRect.Width,0.0))
           ||
           (NotInRange(NewObjectRect.Height,0.0))) {
      ...
      CheckInputMessages(0);
      Mode+=2;
      if (DisplayObjectOnEscape) DrawTryingObjectRect(CurrentX,CurrentY,Mode);
    }
...
//    if (RightButtonPressed) {
    ...
    if (NrFunctionsInBuf>0) {
      ...
      ClipMouseCursor();
      if (SelectionEsc) DisplayObjectOnEscape=0;
      else DrawTryingObjectRect(CurrentX,CurrentY,Mode);
    }
  }
  UnClipMouseCursor();
  InfoStr[0]=0;
...

{
  ...
  while (!SelectionEsc) {
    ...
    if (!Focused) {
      ...
      CheckInputMessages(0);
      ClipMouseCursor();
      if (!SelectionEsc) DrawTryingObjectCircle(CurrentX,CurrentY,Mode);
    }
    if ((ZoomActive())
       &&
       (!SelectionEsc)) {
    ...
    if (LeftButtonPressed) {
      ...
      LeftButtonPressed=0;
      CheckInputMessages(0);
      if (DisplayObjectOnEscape) DrawTryingObjectCircle(CurrentX,CurrentY,Mode);
    }
...
//    if (RightButtonPressed) {
    ...
    if (NrFunctionsInBuf>0) {
      ...
      ClipMouseCursor();
      if (SelectionEsc) DisplayObjectOnEscape=0;
      else DrawTryingObjectCircle(CurrentX,CurrentY,Mode);
    }
  }
  InfoStr[0]=0;
  RedrawInfoStr(1);
...

{
  ...
  switch (Mode) {
    case 1:
      DrawLine(Mult(NewObjectArc.CentreX-Xoffset)+DrawWindowMinX-3,DrawWindowMaxY-Mult(NewObjectArc.CentreY-Yoffset)-1-3,
               Mult(NewObjectArc.CentreX-Xoffset)+DrawWindowMinX+3,DrawWindowMaxY-Mult(NewObjectArc.CentreY-Yoffset)-1+3);
      DrawLine(Mult(NewObjectArc.CentreX-Xoffset)+DrawWindowMinX-3,DrawWindowMaxY-Mult(NewObjectArc.CentreY-Yoffset)-1+3,
               Mult(NewObjectArc.CentreX-Xoffset)+DrawWindowMinX+3,DrawWindowMaxY-Mult(NewObjectArc.CentreY-Yoffset)-1-3);
      break;
    case 2:
    case 3:
      DrawLine(Mult(NewObjectArc.CentreX-Xoffset)+DrawWindowMinX,DrawWindowMaxY-Mult(NewObjectArc.CentreY-Yoffset)-1,
               Mult(CurrentX-Xoffset)+DrawWindowMinX,DrawWindowMaxY-Mult(CurrentY-Yoffset)-1);
      break;
  }
  DrawCrossHair(8);
  ExitDrawing();
...

{
  ...
  while (!SelectionEsc) {
    ...
    if (LeftButtonPressed) {
      ...
      LeftButtonPressed=0;
      CheckInputMessages(0);
      if (DisplayObjectOnEscape) DrawTryingObjectArc(CurrentX,CurrentY,Mode);
    }
...
//    if (RightButtonPressed) {
    ...
    if (NrFunctionsInBuf>0) {
      ...
      ClipMouseCursor();
      if (SelectionEsc) DisplayObjectOnEscape=0;
      else DrawTryingObjectArc(CurrentX,CurrentY,Mode);
    }
  }
  InfoStr[0]=0;
  RedrawInfoStr(1);
...

{
  ...
  if (Mode==0) NewObjectText.TextMode=0;
  else NewObjectText.TextMode=1;
  DrawObjectText(&NewObjectText,0.0,0.0,0);
  DrawCrossHair(8);
  ExitDrawing();
  EndDrawingEditingWindow();
...

{
  ...
  if (TextInputDialog(&NewObjectText,0)==2) return;
  if (strlen(NewObjectText.Text)==0) return;
  ...
  while (!SelectionEsc) {
    ...
    if (!Focused) {
      ...
      CheckInputMessages(0);
      ClipMouseCursor();
      if (!SelectionEsc) DrawTryingObjectText(CurrentX,CurrentY,Mode);
    }
    if ((ZoomActive())
       &&
       (!SelectionEsc)) {
...
//      RightButtonPressed=0;
    ...
    if (NrFunctionsInBuf>0) {
      ...
      ClipMouseCursor();
      if (SelectionEsc) DisplayObjectOnEscape=0;
      else DrawTryingObjectText(OldX,OldY,Mode);
    }
  }
  UnClipMouseCursor();
  if (DisplayObjectOnEscape) DrawTryingObjectText(CurrentX,CurrentY,Mode);
  SystemBusyMode=0;
}
...

{
  ...
  for (cnt=0;cnt<ObjectNumbers.Count;cnt++) {
    ...
    NewObjectText.FontHeight=1.0;
    if (Mode==1) NewObjectText.TextMode=ALIGN_RIGHT_BOTTOM;
    DrawObjectText(&NewObjectText,0.0,0.0,0);
  }
  DrawCrossHair(8);
  ExitDrawing();
...

{
  ...
  while (!SelectionEsc) {
    ...
    if (!Focused) {
      ...
      CheckInputMessages(0);
      ClipMouseCursor();
      if (!SelectionEsc) DrawTryingObjectNumbers(CurrentX,CurrentY,Mode);
    }
    if ((ZoomActive())
       &&
       (!SelectionEsc)) {
...
//      RightButtonPressed=0;
    ...
    if (NrFunctionsInBuf>0) {
      ...
      ClipMouseCursor();
      if (SelectionEsc) DisplayObjectOnEscape=0;
      else DrawTryingObjectNumbers(OldX,OldY,Mode);
    }
  }
  UnClipMouseCursor();
  if (DisplayObjectOnEscape) DrawTryingObjectNumbers(CurrentX,CurrentY,Mode);
  SystemBusyMode=0;
}
...
//  char   *Mem;
  ...
  if (!OpenClipboard(SCHWindow)) return -1;
  if (!EmptyClipboard()) return -1;
  if ((GlobalClipBoardMem=GlobalAlloc(GHND|GMEM_DDESHARE,MemSize))==NULL) return -1;
  if ((ClipBoardMem=GlobalLock(GlobalClipBoardMem))==NULL) return -1;
...

{
  ...
  if (!OpenClipboard(SCHWindow)) return -2;
  if ((GlobalClipBoardMem=GetClipboardData(ClipBoardSchematicID))==NULL) {
    return -1;
  }
  if ((ClipBoardMem=GlobalLock(GlobalClipBoardMem))==NULL) return -2;
...

{
  ...
  if (!OpenClipboard(SCHWindow)) return -1;
//  if (!EmptyClipboard()) return -1;
  if ((NewGlobalClipBoardMem=GlobalAlloc(GHND|GMEM_DDESHARE,ClipBoardMemPos+16))==NULL) return -1;
  if ((NewClipBoardMem=GlobalLock(NewGlobalClipBoardMem))==NULL) return -1;
    ...
    if ((Instance->Info & (OBJECT_NOT_VISIBLE|OBJECT_PROTECTED)) == 0) {
      ...
      if ((CurrentX>x1a)
        ...
        for (cnt2=0;cnt2<NrObjects;cnt2++) {
          Object=&((*Objects)[cnt2]);
          if ((InRange(Object->x1,CurrentX))
             &&
             (InRange(Object->y1,CurrentY))) return 1;
        }
      }
    }
  }
  if (mode==0) {
    for (cnt=0;cnt<Design.NrWires;cnt++) {
      ...
      if ((Wire->Info & OBJECT_NOT_VISIBLE) == 0) {
        ...
        if (TestLineConnectedToCircle(x1,y1,x2,y2,CurrentX,CurrentY,0.04)) return 1;
      }
    }
  } else {
    for (cnt=0;cnt<Design.NrBusses;cnt++) {
