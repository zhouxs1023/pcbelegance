...
int32 LoadBitmapFile(LPSTR EditFile)
{
	...
	result =
	    GetNewFileUTF8(GEOMWindow, NULL, EditFile, EditPath, SC(246, "Bitmap files"), NULL, SC(246, "Bitmap files"),
	                   "bmp", 0);
...
int32 SaveFileName(int32 Mode)
{
	...
	result =
	    GetNewFileUTF8(GEOMWindow, NULL, EditFile, EditPath, SC(245, "Geometry files (*.shp)"), NULL,
	                   SC(245, "Geometry files (*.shp)"), "shp", 1);
