...
//  OwnAppendMenu(PopUpMenu,MF_ENABLED|MF_STRING,ID_ROT_270,"Rotate objects 270");
	...
	if ((CheckMenuItem) || (NrDrillsSelected > 0))
	{
		...
		OwnAppendMenu(PopUpMenu, MF_ENABLED | MF_STRING, ID_ASSIGN_PINS2,
		              SC(300, "Assign objects to pin (Auto increment)"));
	...
	{
		OwnAppendMenu(PopUpMenu1, MF_ENABLED | MF_STRING, ID_SELECT_ONLY_SILK_BOTTOM,
		              SC(316, "Objects silkscreen bottom"));
	}

	if (NrCompOutlinesSelected > 0)
	{
		OwnAppendMenu(PopUpMenu1, MF_ENABLED | MF_STRING, ID_SELECT_ONLY_COMP_OUTLINE,
		              SC(317, "Objects component outline"));
	}

	if (NrPlacemOutlinesSelected > 0)
	{
		OwnAppendMenu(PopUpMenu1, MF_ENABLED | MF_STRING, ID_SELECT_ONLY_PLACEM_OUTLINE,
		              SC(318, "Objects placement outline"));
	}
	...
	{
		OwnAppendMenu(PopUpMenu1, MF_ENABLED | MF_STRING, ID_SELECT_ONLY_MASK_BOTTOM,
		              SC(320, "Objects solder mask bottom"));
	}
	...
	{
		OwnAppendMenu(PopUpMenu1, MF_ENABLED | MF_STRING, ID_SELECT_ONLY_PASTE_BOTTOM,
		              SC(322, "Objects paste mask bottom"));
	}

	if (NrBoardOutlinesSelected > 0)
	{
		OwnAppendMenu(PopUpMenu1, MF_ENABLED | MF_STRING, ID_SELECT_ONLY_BOARD_OUTLINE,
		              SC(323, "Objects board outline"));
	}
	...
	if (NrSilkBottomObjectsSelected > 0)
	{
		OwnAppendMenu(PopUpMenu2, MF_ENABLED | MF_STRING, ID_UNSELECT_SILK_BOTTOM,
		              SC(316, "Objects silkscreen bottom"));
	}

	if (NrCompOutlinesSelected > 0)
	{
		OwnAppendMenu(PopUpMenu2, MF_ENABLED | MF_STRING, ID_UNSELECT_COMP_OUTLINE,
		              SC(317, "Objects component outline"));
	}

	if (NrPlacemOutlinesSelected > 0)
	{
		OwnAppendMenu(PopUpMenu2, MF_ENABLED | MF_STRING, ID_UNSELECT_PLACEM_OUTLINE,
		              SC(318, "Objects placement outline"));
	}
	...
	if (NrMaskBottomObjectsSelected > 0)
	{
		OwnAppendMenu(PopUpMenu2, MF_ENABLED | MF_STRING, ID_UNSELECT_MASK_BOTTOM,
		              SC(320, "Objects solder mask bottom"));
	}
	...
	if (NrPasteBottomObjectsSelected > 0)
	{
		OwnAppendMenu(PopUpMenu2, MF_ENABLED | MF_STRING, ID_UNSELECT_PASTE_BOTTOM,
		              SC(322, "Objects paste mask bottom"));
	}
...
//  OwnAppendMenu(PopUpMenuPad,MF_ENABLED|MF_STRING,ID_ADD_THROUGHOLE,"Through hole");
	...
	if (PastePadsTopVisible)
	{
		...
		OwnAppendMenu(PopUpMenuPadRect, MF_ENABLED | MF_STRING, ID_ADD_RECT_PAD_OBJECT + Layer,
		              SC(8, "Paste mask top"));
	}
...
// *****************************************************************************************
	...
	if (NrPadLayers == 2)
	{
		...
		OwnAppendMenu(PopUpMenuPadCircle, MF_ENABLED | MF_STRING, ID_ADD_CIRCLE_PAD_OBJECT + Layer,
		              SC(139, "Inner pads"));
	}
...
// *****************************************************************************************
	...
	{
		Layer = SILKSCREEN_TOP_LAYER;
		OwnAppendMenu(PopUpMenuArrow1, MF_ENABLED | MF_STRING, ID_ADD_LINE_OBJECT_ARROW1 + Layer,
		              SC(9, "Silkscreen top"));
	}
...
// *****************************************************************************************
	...
	{
		Layer = SILKSCREEN_TOP_LAYER;
		OwnAppendMenu(PopUpMenuArrow2, MF_ENABLED | MF_STRING, ID_ADD_LINE_OBJECT_ARROW2 + Layer,
		              SC(9, "Silkscreen top"));
	}
...
// *****************************************************************************************
	...
	{
		Layer = SILKSCREEN_TOP_LAYER;
		OwnAppendMenu(PopUpMenuArrow3, MF_ENABLED | MF_STRING, ID_ADD_LINE_OBJECT_ARROW3 + Layer,
		              SC(9, "Silkscreen top"));
	}
...
// *****************************************************************************************
	...
	{
		Layer = SILKSCREEN_TOP_LAYER;
		OwnAppendMenu(PopUpMenuDimension1, MF_ENABLED | MF_STRING, ID_ADD_DIMENSION_OBJECT + Layer,
		              SC(9, "Silkscreen top"));
	}
...
// *****************************************************************************************
	...
	{
		Layer = SILKSCREEN_TOP_LAYER;
		OwnAppendMenu(PopUpMenuDimension2, MF_ENABLED | MF_STRING, ID_ADD_DIMENSION_OBJECT2 + Layer,
		              SC(9, "Silkscreen top"));
	}
...
// *****************************************************************************************
	...
	if (SilkScreenBottomVisible)
	{
		OwnAppendMenu(PopUpMenuCircle, MF_ENABLED | MF_POPUP, (uint32) PopUpMenuCircleSilk2,
		              SC(10, "Silkscreen bottom"));
		Layer = SILKSCREEN_BOTTOM_LAYER;
	...
	{
		Layer = PLACEMENT_OUTLINE_LAYER;
		OwnAppendMenu(PopUpMenuCircle, MF_ENABLED | MF_POPUP, (uint32) PopUpMenuCirclePlace,
		              SC(17, "Placement outline"));
	...
	{
		Layer = COMP_OUTLINE_LAYER;
		OwnAppendMenu(PopUpMenuCircle, MF_ENABLED | MF_POPUP, (uint32) PopUpMenuCircleComp,
		              SC(11, "Component outline"));
	...
	{
		Layer = BOARD_OUTLINE_LAYER;
		OwnAppendMenu(PopUpMenuCircle, MF_ENABLED | MF_POPUP, (uint32) PopUpMenuCircleBoardOutline,
		              SC(12, "Board outline"));
...
// *****************************************************************************************
	...
	{
		Layer = SOLD_MASK_TOP_LAYER;
		OwnAppendMenu(PopUpMenuPolygon, MF_ENABLED | MF_STRING, ID_ADD_POLYGON_OBJECT + Layer,
		              SC(6, "Solder mask top"));
	}
...
// *****************************************************************************************
	...
	{
		Layer = PASTE_MASK_TOP_LAYER;
		OwnAppendMenu(PopUpMenuPolyline, MF_ENABLED | MF_STRING, ID_ADD_POLYLINE_OBJECT + Layer,
		              SC(8, "Paste mask top"));
	}
...
// *****************************************************************************************
	...
	if (DrillVisible)
	{
		OwnAppendMenu(PopUpMenuDrill, MF_ENABLED | MF_STRING, ID_ADD_CIRCLE_PAD_OBJECT + DRILL_LAYER,
		              SC(354, "Plated"));
	}

	if (DrillUnplatedVisible)
	{
		OwnAppendMenu(PopUpMenuDrill, MF_ENABLED | MF_STRING, ID_ADD_CIRCLE_PAD_OBJECT + DRILL_UNPLATED_LAYER,
		              SC(355, "Unplated"));
	}
