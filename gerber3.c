...

{
  ...
  if (!ChangeSilkScreenPenAsk) {
    if (InRange(*SpecialLineThickNess,CurrentPlotPenSize)) return 0;
    strcpy(str,SC(424,"There are lines/rectangles/circles/arcs/texts on the layers\n"));
    strcat(str,SC(425,"  Silkscreen\n"));
    strcat(str,SC(426,"  Board outline\n"));
    strcat(str,SC(427,"  Info layers\n"));
    strcat(str,SC(428,"  with a different diameter than plotter pen 1\n"));
    strcat(str,"\n");
    strcat(str,SC(429,"Do you want to use plotter pen 1 for these objects\n"));
...

{
  ...
  // Add thermal relief if diameter greater MinDrillForThermalRelief
                Object4->Info2=CheckThermalReliefAperTure(Via->DrillThickNess,
...

{
  ...
  //              case DRILL_UNPLATED:
                ...
                case PIN_SMD_POLYGON:
                  if (Object->ObjectType2!=0) {
                    ...
                    Object4->Info2=CheckPolygonAperTure(Object->ObjectType2,Object->x2,Object->y2,
                                                        Object->RotationAngle,
                                                        Object->Mirror,0);
                  } else {
                    Object4->ObjectType=PIN_SMD_POLYGON;
                    Object4->Info2=CheckPolygonAperTure(0,0.0,0.0,Object->RotationAngle,
                ...
                case PIN_PUT_THROUGH_POLYGON:
                  ...
                  if (Object->ObjectType2!=0) {
                    Object4->Info2=CheckPolygonAperTure(Object->ObjectType2,Object->x2,Object->x2,
                                                        Object->RotationAngle,
                                                        Object->Mirror,0);
                  } else {
                    Object4->Info2=CheckPolygonAperTure(0,0.0,0.0,Object->RotationAngle,
  ...
  //                        Object4->x3=AreaFill->ThermalReliefDistance;
                      Object4->Info2=CheckThermalReliefAperTure(Object->y2,
          ...
          if (GerberInfo.Invert) {
            switch (Object->ObjectType) {
              ...
              case PIN_SMD_POLYGON:
                if ((Object->ObjectType2==0)
                   ||
                   ((Object->Info & OBJECT_FILLED) == OBJECT_FILLED)) {
                  Object->Mirror^=1;
                  Object->RotationAngle=-Object->RotationAngle;
                  if (Object->RotationAngle<0.0) {
                    Object->RotationAngle+=360.0;
