...
COLORREF                    BlackColor,
                            ...
                            ShapeSilkScreenTopColor,
                            ShapeSilkScreenBottomColor,
                            ShapeCompOutlineColor,
                            ShapePlacementOutLineColor,
                            ShapePinsDrillColor,
                            ShapePinsDrillUnplatedColor,
                            ShapePinsTopColor,
                            ShapePinsBottomColor,
                            ShapePinsInnerColor,
                            ShapePasteMaskTopColor,
                            ShapePasteMaskBottomColor,
                            ShapeSoldMaskTopColor,
                            ShapeSoldMaskBottomColor,
                            ShapeRoutingKeepoutTopColor,
                            ShapeRoutingKeepoutBottomColor,
                            ShapeRoutingKeepoutInnerColor,
                            ShapeBoardOutlineColor,
                            ShapeInfo1Color,
                            ShapeInfo2Color,
                            ShapeInfo3Color,
                            ShapeInfo4Color,
...
LOGBRUSH                    BrushObject,
                            BrushObjectMagenta,
                            BrushObjectYellow,
                            ShapePinsTopBrushObject,
                            ShapePinsBottomBrushObject,
                            ShapePinsInnerBrushObject,
                            ShapePasteMaskTopBrushObject,
                            ShapePasteMaskBottomBrushObject,
                            ShapeSoldMaskTopBrushObject,
                            ShapeSoldMaskBottomBrushObject,
                            ShapeRoutingKeepoutTopBrushObject,
                            ShapeRoutingKeepoutBottomBrushObject,
                            ShapeRoutingKeepoutInnerBrushObject,
                            ShapePowerPadBrushObject,
                            ShapeInfo1BrushObject,
                            ShapeInfo2BrushObject,
                            ShapeInfo3BrushObject,
                            ShapeInfo4BrushObject,
                            ShapeSilkScreenTopBrushObject,
                            ShapeSilkScreenBottomBrushObject,
                            ShapeCompOutlineBrushObject,
                            EmptyBrushObject,
                            ButtonInfoBrushObject,
                            BackGroundBrushObject,
                            WhiteBrushObject;

uint32                        BrushMode;

HGDIOBJ                     ShapePinsTopBrush,
                            ShapePinsBottomBrush,
                            ShapePinsInnerBrush,
                            ShapePasteMaskTopBrush,
                            ShapePasteMaskBottomBrush,
                            ShapeSoldMaskTopBrush,
                            ShapeSoldMaskBottomBrush,
                            ShapeInfo1Brush,
                            ShapeInfo2Brush,
                            ShapeInfo3Brush,
                            ShapeInfo4Brush,
                            ShapeSilkScreenTopBrush,
                            ShapeSilkScreenBottomBrush,
                            ShapeCompOutlineBrush,
                            ShapeRoutingKeepoutTopBrush,
                            ShapeRoutingKeepoutBottomBrush,
                            ShapeRoutingKeepoutInnerBrush,
                            ShapePowerPadBrush,
                            ButtonInfoBrush,
                            LayerBrush,
                            BackGroundBrush,
...
HPEN                        ShapeSilkScreenTopPen,
                            ShapeSilkScreenBottomPen,
                            ShapeCompOutlinePen,
                            ShapePlacementOutLinePen,
                            DrawPen,
                            SavePen,
                            EmptyPen,
                            BlackPen,
                            ...
                            ShapePinsInnerPen,
                            ShapePinsDrillPen,
                            ShapePinsDrillUnplatedPen,
                            ShapePasteMaskTopPen,
                            ShapePasteMaskBottomPen,
                            ShapeSoldMaskTopPen,
                            ShapeSoldMaskBottomPen,
                            ShapeRoutingKeepoutTopPen,
                            ShapeRoutingKeepoutBottomPen,
                            ShapeRoutingKeepoutInnerPen,
                            ShapeBoardOutlinePen,
                            ShapeInfo1Pen,
                            ShapeInfo2Pen,
                            ShapeInfo3Pen,
                            ShapeInfo4Pen,
...
int32      NrGraphicsObjects,
           SilkScreenTopLineThickNess,
           SilkScreenBottomLineThickNess,
           BackGroundPenThickNess2,
           Info1ThickNess,Info2ThickNess,
           Info3ThickNess,Info4ThickNess,
           ShapePasteMaskTopThickNess,
           ShapePasteMaskBottomThickNess,
           ShapeSoldMaskTopThickNess,
           ShapeSoldMaskBottomThickNess,
           ShapePinsBottomThickNess,
           ShapePinsTopThickNess,
           ShapePinsInnerThickNess,
           BoardOutlineThickNess,
           SelectColorMode,GeomNameLineThickNess,ok,
...
#endif
  if (NrGraphicsObjects>=200) return;
...
//  ShapePinsTopBrushObject.lbStyle        = BS_HATCHED;
  ...
  if (!Printing) {
    PinTextFont=CreateFont(20,0,0,0,0,0,0,0,ANSI_CHARSET,
                           OUT_TT_PRECIS,CLIP_DEFAULT_PRECIS,PROOF_QUALITY,
                           FIXED_PITCH,"Courier New");
  } else {
    if (PixelsPerInchX<400) {
      PinTextFont=CreateFont(30,0,0,0,0,0,0,0,ANSI_CHARSET,
                             OUT_TT_PRECIS,CLIP_DEFAULT_PRECIS,PROOF_QUALITY,
                             FIXED_PITCH,"Courier New");
    } else {
      if (PixelsPerInchX<800) {
        PinTextFont=CreateFont(50,0,0,0,0,0,0,0,ANSI_CHARSET,
                               OUT_TT_PRECIS,CLIP_DEFAULT_PRECIS,PROOF_QUALITY,
                               FIXED_PITCH,"Courier New");
      } else {
        if (PixelsPerInchX<1600) {
          PinTextFont=CreateFont(80,0,0,0,0,0,0,0,ANSI_CHARSET,
                                 OUT_TT_PRECIS,CLIP_DEFAULT_PRECIS,PROOF_QUALITY,
                                 FIXED_PITCH,"Courier New");
        }
      }
...
{
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,YellowPen);
  else SelectObject(OutputDisplay,YellowPen);
...
{
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,YellowPen2);
  else SelectObject(OutputDisplay,YellowPen2);
  if (SaveBrush==(HGDIOBJ)-1) {
    SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
  } else {
    SelectObject(OutputDisplay,EmptyBrush);
...

{
  if (mode==0) {
    ...
    if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,WhitePen2);
    else SelectObject(OutputDisplay,WhitePen2);
...

{
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ButtonInfoPen);
  else SelectObject(OutputDisplay,ButtonInfoPen);
  if (SaveBrush==(HGDIOBJ)-1) {
...

{
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ClearancePen);
  else SelectObject(OutputDisplay,ClearancePen);
  ...
  switch (Layer) {
    case DRILL_LAYER:
      ...
      if ((mode & 2) == 0) {
        if (CurrentObjectCode!=ShapePinsDrillObjectCode) {
          if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapePinsDrillPen);
          else SelectObject(OutputDisplay,ShapePinsDrillPen);
          if (SaveBrush==(HGDIOBJ)-1) {
    ...
    case DRILL_UNPLATED_LAYER:
      ...
      if ((mode & 2) == 0) {
        if (CurrentObjectCode!=ShapePinsDrillUnplatedObjectCode) {
          if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapePinsDrillUnplatedPen);
          else SelectObject(OutputDisplay,ShapePinsDrillUnplatedPen);
          if (SaveBrush==(HGDIOBJ)-1) {
            SaveBrush=SelectObject(OutputDisplay,BackGroundBrush);
          } else {
            SelectObject(OutputDisplay,BackGroundBrush);
    ...
    case POWER_PAD_LAYER:
      ...
      if (CurrentObjectCode!=ShapePowerPadObjectCode) {
        if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapePowerPadPen);
        else SelectObject(OutputDisplay,ShapePowerPadPen);
        if (SaveBrush==(HGDIOBJ)-1) {
    ...
    case INNER_PAD_LAYER:
      ...
      if (CurrentObjectCode!=ShapePinsInnerObjectCode) {
        ...
        if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapePinsInnerPen);
        else SelectObject(OutputDisplay,ShapePinsInnerPen);
        if (SaveBrush==(HGDIOBJ)-1) {
        ...
        case OBJECT_TEXT:
          ...
          if (ThickNess==0) {
            if (CurrentObjectCode!=ShapeSoldMaskBottomObjectCode) {
              ...
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeSoldMaskBottomPen);
              else SelectObject(OutputDisplay,ShapeSoldMaskBottomPen);
              if (SaveBrush==(HGDIOBJ)-1) {
        ...
        case OBJECT_TEXT:
          ...
          if (ThickNess==0) {
            if (CurrentObjectCode!=ShapeSoldMaskTopObjectCode) {
              ...
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeSoldMaskTopPen);
              else SelectObject(OutputDisplay,ShapeSoldMaskTopPen);
              if (SaveBrush==(HGDIOBJ)-1) {
            ...
            if ((CurrentObjectCode!=ShapeSoldMaskTopObjectCode2)
               ||
               (ShapeSoldMaskTopThickNess!=ThickNess)) {
              if (ShapeSoldMaskTopPen==(HGDIOBJ)NULL) {
                ShapeSoldMaskTopThickNess=ThickNess;
            ...
            if (CurrentObjectCode!=ShapePasteMaskBottomObjectCode) {
              ...
              if ((ShapePasteMaskBottomThickNess!=ThickNess)
                ...
                if (ShapePasteMaskBottomPen==(HGDIOBJ)NULL) {
                  ...
                  ThickNess=(ThickNess-1)|1;
                  if ((ShapePasteMaskBottomPen = CreatePen(PS_SOLID,ThickNess,ShapePasteMaskBottomColor))==NULL) {
                    ok=1;
                  }
              ...
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapePasteMaskBottomPen);
              else SelectObject(OutputDisplay,ShapePasteMaskBottomPen);
              if (SaveBrush==(HGDIOBJ)-1) {
        ...
        case OBJECT_ARC:
          ...
          if (ThickNess==0) {
            if (CurrentObjectCode!=ShapePasteMaskTopObjectCode) {
              ...
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapePasteMaskTopPen);
              else SelectObject(OutputDisplay,ShapePasteMaskTopPen);
              if (SaveBrush==(HGDIOBJ)-1) {
            ...
            if ((CurrentObjectCode!=ShapePasteMaskTopObjectCode2)
               ||
               (ShapePasteMaskTopThickNess!=ThickNess)) {
              if (ShapePasteMaskTopPen==(HGDIOBJ)NULL) {
                ShapePasteMaskTopThickNess=ThickNess;
        ...
        case OBJECT_TEXT:
          ...
          if (ThickNess==0) {
            if (CurrentObjectCode!=ShapeSilkScreenTopObjectCode) {
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,EmptyPen);
              else SelectObject(OutputDisplay,EmptyPen);
              if (SaveBrush==(HGDIOBJ)-1) {
            ...
            if ((CurrentObjectCode!=ShapeSilkScreenTopObjectCode2)
               ||
              ...
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeSilkScreenTopPen);
              else SelectObject(OutputDisplay,ShapeSilkScreenTopPen);
              if (SaveBrush==(HGDIOBJ)-1) {
                SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
              } else {
                SelectObject(OutputDisplay,EmptyBrush);
        ...
        case OBJECT_TEXT:
          ...
          if (ThickNess==0) {
            ...
            if ((CurrentObjectCode!=ShapeSilkScreenBottomObjectCode2)
              ...
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeSilkScreenBottomPen);
              else SelectObject(OutputDisplay,ShapeSilkScreenBottomPen);
              if (SaveBrush==(HGDIOBJ)-1) {
                SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
              } else {
                SelectObject(OutputDisplay,EmptyBrush);
      ...
      switch (ObjectType) {
        ...
        case OBJECT_TEXT:
          ...
          if (CurrentObjectCode!=ShapePlacementOutLineObjectCode) {
            if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapePlacementOutLinePen);
            else SelectObject(OutputDisplay,ShapePlacementOutLinePen);
            if (SaveBrush==(HGDIOBJ)-1) {
              SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
            } else {
              SelectObject(OutputDisplay,EmptyBrush);
      ...
      switch (ObjectType) {
        ...
        case OBJECT_TEXT:
          ...
          if (ThickNess==0) {
            ...
            if ((CurrentObjectCode!=ShapeCompOutlineObjectCode2)
               ||
              ...
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeCompOutlinePen);
              else SelectObject(OutputDisplay,ShapeCompOutlinePen);
              if (SaveBrush==(HGDIOBJ)-1) {
                SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
              } else {
                SelectObject(OutputDisplay,EmptyBrush);
    ...
    case BOARD_OUTLINE_LAYER:
      switch (ObjectType) {
        ...
        case OBJECT_ARC:
          ...
          if ((CurrentObjectCode!=ShapeBoardOutlineObjectCode)
             ||
            ...
            if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeBoardOutlinePen);
            else SelectObject(OutputDisplay,ShapeBoardOutlinePen);
            if (SaveBrush==(HGDIOBJ)-1) {
              SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
            } else {
              SelectObject(OutputDisplay,EmptyBrush);
      ...
      switch (ObjectType) {
        ...
        case OBJECT_TEXT:
          ...
          if (ThickNess==0) {
            ...
            if ((CurrentObjectCode!=ShapeInfo1ObjectCode2)
               ||
              ...
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeInfo1Pen);
              else SelectObject(OutputDisplay,ShapeInfo1Pen);
              if (SaveBrush==(HGDIOBJ)-1) {
                SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
              } else {
                SelectObject(OutputDisplay,EmptyBrush);
      ...
      switch (ObjectType) {
        ...
        case OBJECT_TEXT:
          ...
          if (ThickNess==0) {
            ...
            if ((CurrentObjectCode!=ShapeInfo2ObjectCode2)
               ||
              ...
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeInfo2Pen);
              else SelectObject(OutputDisplay,ShapeInfo2Pen);
              if (SaveBrush==(HGDIOBJ)-1) {
                SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
              } else {
                SelectObject(OutputDisplay,EmptyBrush);
      ...
      switch (ObjectType) {
        ...
        case OBJECT_TEXT:
          ...
          if (ThickNess==0) {
            ...
            if ((CurrentObjectCode!=ShapeInfo3ObjectCode2)
               ||
              ...
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeInfo3Pen);
              else SelectObject(OutputDisplay,ShapeInfo3Pen);
              if (SaveBrush==(HGDIOBJ)-1) {
                SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
              } else {
                SelectObject(OutputDisplay,EmptyBrush);
      ...
      switch (ObjectType) {
        ...
        case OBJECT_TEXT:
          ...
          if (ThickNess==0) {
            ...
            if ((CurrentObjectCode!=ShapeInfo4ObjectCode2)
               ||
              ...
              if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeInfo4Pen);
              else SelectObject(OutputDisplay,ShapeInfo4Pen);
              if (SaveBrush==(HGDIOBJ)-1) {
                SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
              } else {
                SelectObject(OutputDisplay,EmptyBrush);
    ...
    case GEOM_NAME_LAYER:
      switch (ObjectType) {
        case OBJECT_TEXT:
          ...
          if ((CurrentObjectCode!=ShapeGeomNameObjectCode)
             ||
            ...
            if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeGeomNamePen);
            else SelectObject(OutputDisplay,ShapeGeomNamePen);
            if (SaveBrush==(HGDIOBJ)-1) {
              SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
            } else {
              SelectObject(OutputDisplay,EmptyBrush);
    ...
    case PIN_TEXT_LAYER:
      if (CurrentFontCode!=PinTextFontCode) {
        if (SaveFont==(HGDIOBJ)-1) SaveFont=SelectObject(OutputDisplay,PinTextFont);
        else SelectObject(OutputDisplay,PinTextFont);
    ...
    default:
      if (Layer<32) {
            ...
            case OBJECT_ARC:
              ...
              if (ThickNess==0) {
                ...
                if ((CurrentObjectCode!=ShapePinsBottomObjectCode2)
                  ...
                  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapePinsBottomPen);
                  else SelectObject(OutputDisplay,ShapePinsBottomPen);
                  if (SaveBrush==(HGDIOBJ)-1) {
                    SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
                  } else {
                    SelectObject(OutputDisplay,EmptyBrush);
          ...
          switch (ObjectType) {
            ...
            case OBJECT_ARC:
              ...
              if (ThickNess==0) {
                ...
                if ((CurrentObjectCode!=ShapePinsTopObjectCode2)
                   ||
                  ...
                  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapePinsTopPen);
                  else SelectObject(OutputDisplay,ShapePinsTopPen);
                  if (SaveBrush==(HGDIOBJ)-1) {
                    SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
                  } else {
                    SelectObject(OutputDisplay,EmptyBrush);
          ...
          switch (ObjectType) {
            ...
            case OBJECT_ARC:
              ...
              if (TempThickness==0) {
                ...
                if ((CurrentObjectCode!=ShapePinsInnerObjectCode2)
                   ||
                   (ShapePinsInnerThickNess!=ThickNess)) {
                  if (SaveBrush==(HGDIOBJ)-1) {
                    SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
        ...
        if ((Layer>=ROUTING_KEEPOUT_LAYER)
          ...
          if (Layer==ROUTING_KEEPOUT_LAYER+NrPadLayers-1) { // Top
            switch (ObjectType) {
              case OBJECT_POLYGON:
              case OBJECT_CIRCLE:
                if (BackGroundActive) {
                ...
                if (CurrentObjectCode!=ShapeRoutingKeepoutTopObjectCode) {
                  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeRoutingKeepoutTopPen);
                  else SelectObject(OutputDisplay,ShapeRoutingKeepoutTopPen);
                  if (SaveBrush==(HGDIOBJ)-1) {
          ...
          if (Layer==ROUTING_KEEPOUT_LAYER) { // Bottom
            switch (ObjectType) {
              case OBJECT_POLYGON:
              case OBJECT_CIRCLE:
              case OBJECT_RECT:
                ...
                if (CurrentObjectCode!=ShapeRoutingKeepoutBottomObjectCode) {
                  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ShapeRoutingKeepoutBottomPen);
                  else SelectObject(OutputDisplay,ShapeRoutingKeepoutBottomPen);
                  if (SaveBrush==(HGDIOBJ)-1) {
          ...
          if (CheckIfInnerLayer(Layer-ROUTING_KEEPOUT_LAYER)) { // Routing keepout inner layer
            switch (ObjectType) {
              case OBJECT_POLYGON:
              case OBJECT_CIRCLE:
              case OBJECT_RECT:
...

{
  ...
  if (((mode==1)
    ...
    if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,BackGroundPen2);
    else SelectObject(OutputDisplay,BackGroundPen2);
  }
  if (mode==1) {
