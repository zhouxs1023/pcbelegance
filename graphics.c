...
COLORREF                    BlackColor,
                            ...
                            BusColor,
                            BusConnectionColor,
                            GlobalConnectionColor,
                            JunctionColor,
                            OnePinNetColor,
                            NetLabelColor,
                            InstanceRefTextColor,
                            InstanceValueTextColor,
                            SymbolPinColor,
                            SymbolPinBusColor,
                            SymbolPinTextColor,
                            SymbolPowerPinTextColor,
                            SymbolPinBusTextColor,
                            SymbolLinesColor,
                            SymbolRectsColor,
                            SymbolTextsColor,
                            SymbolArcsColor,
...
LOGBRUSH                    JunctionBrushObject,
                            SymbolPinBrushObject,
                            SymbolPinBusBrushObject,
                            BusConnectionBrushObject,
                            GlobalConnectionBrushObject,
                            SpecialObjectsBrushObject,
...
int32                       PrintingThickness,BackGroundPenThickness2,
                            WireThickness,
                            BusThickness,
                            BusConnectionThickness,
                            GlobalConnectionThickness,
                            NetLabelThickness,
                            OnePinNetThickness,
                            InstanceRefTextThickness,
                            InstanceValueTextThickness,
                            SymbolPinTextThickness,
                            SymbolPinBusTextThickness,
                            SymbolPowerPinTextThickness,
                            SymbolLinesThickness,
                            SymbolRectsThickness,
                            SymbolCirclesThickness,
                            SymbolArcsThickness,
                            SymbolTextsThickness,
                            ObjectLinesThickness,
                            ObjectRectsThickness,
                            ObjectCirclesThickness,
                            ObjectArcsThickness,
                            ObjectTextsThickness,
...

{
  ...
  if ((CurrentObjectCode==WireObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,WirePen);
  else SelectObject(OutputDisplay,WirePen);
...

{
  ...
  if ((CurrentObjectCode==BusObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,BusPen);
  else SelectObject(OutputDisplay,BusPen);
...

{
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,JunctionPen);
  else SelectObject(OutputDisplay,JunctionPen);
  if (SaveBrush==(HGDIOBJ)-1) {
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==OnePinNetObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,OnePinNetPen);
  else SelectObject(OutputDisplay,OnePinNetPen);
...

{
  ...
  OldThickness=Thickness;
  if (OldThickness==0) {
    if ((CurrentObjectCode==BusConnectionObjectCode)
       &&
       (BusConnectionThickness==Thickness)) {
      return;
    }
  } else {
    if (CurrentObjectCode==BusConnectionObjectCode2) return;
  }
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,BusConnectionPen);
  else SelectObject(OutputDisplay,BusConnectionPen);
  if (OldThickness==0) {
    if (SaveBrush==(HGDIOBJ)-1) {
...

{
  ...
  OldThickness=Thickness;
  if (OldThickness==0) {
    if ((CurrentObjectCode==GlobalConnectionObjectCode)
       &&
       (GlobalConnectionThickness==Thickness)) {
      return;
    }
  } else {
    if (CurrentObjectCode==GlobalConnectionObjectCode2) return;
  }
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,GlobalConnectionPen);
  else SelectObject(OutputDisplay,GlobalConnectionPen);
  if (OldThickness==0) {
    if (SaveBrush==(HGDIOBJ)-1) {
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==NetLabelObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,NetLabelPen);
  else SelectObject(OutputDisplay,NetLabelPen);
...

{
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,SymbolPinPen);
  else SelectObject(OutputDisplay,SymbolPinPen);
  if (SaveBrush==(HGDIOBJ)-1) {
...

{
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,SymbolPinBusPen);
  else SelectObject(OutputDisplay,SymbolPinBusPen);
  if (SaveBrush==(HGDIOBJ)-1) {
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==SymbolPowerPinTextObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,SymbolPowerPinTextPen);
  else SelectObject(OutputDisplay,SymbolPowerPinTextPen);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==SymbolPinBusTextObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,SymbolPinBusTextPen);
  else SelectObject(OutputDisplay,SymbolPinBusTextPen);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==SymbolPinTextObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,SymbolPinTextPen);
  else SelectObject(OutputDisplay,SymbolPinTextPen);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==SymbolLinesObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,SymbolLinesPen);
  else SelectObject(OutputDisplay,SymbolLinesPen);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==SymbolRectsObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,SymbolRectsPen);
  else SelectObject(OutputDisplay,SymbolRectsPen);
  if (SaveBrush==(HGDIOBJ)-1) {
    SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
  } else {
    SelectObject(OutputDisplay,EmptyBrush);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==SymbolCirclesObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,SymbolCirclesPen);
  else SelectObject(OutputDisplay,SymbolCirclesPen);
  if (SaveBrush==(HGDIOBJ)-1) {
    SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
  } else {
    SelectObject(OutputDisplay,EmptyBrush);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==SymbolArcsObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,SymbolArcsPen);
  else SelectObject(OutputDisplay,SymbolArcsPen);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==SymbolTextsObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,SymbolTextsPen);
  else SelectObject(OutputDisplay,SymbolTextsPen);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==InstanceRefTextObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,InstanceRefTextPen);
  else SelectObject(OutputDisplay,InstanceRefTextPen);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==InstanceValueTextObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,InstanceValueTextPen);
  else SelectObject(OutputDisplay,InstanceValueTextPen);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==ObjectLinesObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ObjectLinesPen);
  else SelectObject(OutputDisplay,ObjectLinesPen);
...

{
  ...
  if (Filled) {
    ...
    OldThickness=Thickness;
    if ((CurrentObjectCode==ObjectRectsObjectCode)
       &&
    ...
    if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ObjectRectsPen);
    else SelectObject(OutputDisplay,ObjectRectsPen);
    if (SaveBrush==(HGDIOBJ)-1) {
      SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
    } else {
      SelectObject(OutputDisplay,EmptyBrush);
...

{
  ...
  if (Filled) {
    ...
    OldThickness=Thickness;
    if ((CurrentObjectCode==ObjectCirclesObjectCode)
       &&
    ...
    if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ObjectCirclesPen);
    else SelectObject(OutputDisplay,ObjectCirclesPen);
    if (SaveBrush==(HGDIOBJ)-1) {
      SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
    } else {
      SelectObject(OutputDisplay,EmptyBrush);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==ObjectArcsObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ObjectArcsPen);
  else SelectObject(OutputDisplay,ObjectArcsPen);
...

{
  ...
  OldThickness=Thickness;
  if ((CurrentObjectCode==ObjectTextsObjectCode)
     &&
  ...
  if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,ObjectTextsPen);
  else SelectObject(OutputDisplay,ObjectTextsPen);
  if (SaveBrush==(HGDIOBJ)-1) {
    SaveBrush=SelectObject(OutputDisplay,EmptyBrush);
  } else {
    SelectObject(OutputDisplay,EmptyBrush);
...

{
  ...
  if ((mode==1)
    ...
    if (CurrentObjectCode!=BackGroundObjectCode1) {
      if (SavePen==(HGDIOBJ)-1) SavePen=SelectObject(OutputDisplay,BackGroundPen);
      else SelectObject(OutputDisplay,BackGroundPen);
      if (SaveBrush==(HGDIOBJ)-1) {
