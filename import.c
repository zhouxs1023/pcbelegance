...
int32 ImportNetList(int32 mode)
{
	...
	{
		if (MessageBoxOwn
		        (PCBWindow, SC(433, "The whole design will be deleted, Ok to go on ?"), SC(1, "Message"),
	...
	if (GetNewFileUTF8
	        (PCBWindow, NULL, FileName, str, SC(389, "Netlist files"), NULL, SC(389, "Netlist files"), "net", 0))
	{
