...
double                      SearchMinX,SearchMinY,SearchMaxX,SearchMaxY,
                            ...
                            CurrentClearance,TraceThickness,CurrentSilkscreenLine,
                            CurrentBoardOutLine,CurrentTextHeight,
                            CurrentInfoLine,
                            CurrentCompOutLine,TraceWidths[32],TraceClearances[32],
                            GridSizes[32],SilkscreenLines[32],CompOutLines[32],
...
int32                       WindowWidth,WindowHeight,MousePosX,MousePosY,
                            ...
                            ScrollEndOfWindow,DrawDrillMode,
                            MaxLastActionNr,ZoomMode,
...
int32                       ClientWindowDivX,ClientWindowDivY,
                            CrossHairType,SystemBusyMode,
                            NrPadLayers,CrossHairVisible,
                            MaxNrObjects,NrObjects,MaxNrObjects2,NrObjects2,
                            MaxNrPinObjects,NrPinObjects,
                            NrTraceWidths,NrTraceClearances,MessageBufMemSize,
                            NrSilkscreenLines,NrCompOutLines,NrGridSizes,
                            NrBoardOutLines,NrInfoLines,
                            NrObjectPolygons,MaxNrObjectPolygons,
                            MaxSpecialMemory[32],
                            ObjectPolygonMemorySize,SnapMode,
                            NrMappableObjectPolygons,
                            MappableObjectPolygonStart,
                            MessageBufPos,NrPinObjectsInfo,MaxShapesMem,

                            NrPadLayerObjectsSelected[32],
                            NrDrillsSelected,
...
int32                        Created,Painting,DCInUse,MouseChanged,Focused,
                            LeftButtonPressed,MiddleButtonPressed,RightButtonPressed,Printing,
                            UnselectAll,LeftButtonDoublePressed,
                            DataBaseChanged,FileChanged,FirstPaint,
                            MouseCursorOnGrid,BackGroundActive,
                            DrawOnGrid,GridVisible,
                            FinishPolygon,
                            SelectionActive,SelectionEsc,
                            OkToAddViewPos,UndoRedoActive,
                            SpacePressed,ParametersRelative,
                            ReplaceSelections,
                            OkToUseSharedMemory,
                            PadsVisible[32],
                            RoutingKeepoutVisible[32],
                            PastePadsTopVisible,
                            SoldMaskPadsTopVisible,
                            PastePadsBottomVisible,
                            SoldMaskPadsBottomVisible,
                            PlacementVisible,
                            CompOutlineVisible,
                            PowerPadsVisible,
                            PinNamesVisible,
                            InnerPadsVisible,
                            SilkScreenTopVisible,
                            SilkScreenBottomVisible,
                            BoardOutlineVisible,
                            Info1Visible,
                            Info2Visible,
                            Info3Visible,
...
double                      Xoffset,Yoffset,Factor,RelX,RelY,
                            GridSize,BoardWidth,BoardHeight,BoardOX,BoardOY,
                            TextMinX,TextMinY,
                            TextMaxX,TextMaxY,
                            CenterMoveX,CenterMoveY,
                            DimensionHeight,
                            ArrowLength;
float                       ParamsFloat[32];

int32                       FirstSize,NrObjects,NrObjects2,
                            CurrentObjectCode,Units,CurrentFontCode,
                            ClipBoardMemSize,
                            ClipBoardMemPos,
                            MaxNrObjectPolygons,
...
HGLOBAL                     ObjectsGlobal,
                            Objects2Global,
                            PinObjectsGlobal,
                            PinObjectsInfoGlobal,
                            ShapesMemGlobal,
                            MessageBufGlobal,
...

{
  ...
  if (MaxShapesMem==0) {
    ...
    if ((ShapesMemGlobal=GlobalAlloc(GHND,ShapesMemSize))==NULL) return -1;
    if ((ShapesMem=(uint8 *)GlobalLock(ShapesMemGlobal))==NULL) return -1;
    MaxShapesMem=ShapesMemSize;
  } else {
    if (ShapesMemSize>MaxShapesMem) {
      if ((NewMem=GlobalReAlloc(ShapesMemGlobal,ShapesMemSize,GHND))==NULL) return -1;
