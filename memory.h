...
extern int32                    WindowWidth,WindowHeight,MousePosX,MousePosY,
                                ScrollSize,ScrollSizeDrawing,ScrollEndOfWindow,
                                SelectionMode,LastActionNr,DrawDrillMode,
                                MinActionNr,CompRotationForMoving,
                                NrDesigns,MaxLastActionNr,
                                SaveSymbolsLocally,
...
extern int32                     Created,Painting,DCInUse,MouseChanged,Focused,
                                ...
                                CompsSelectionMode,DataBaseChanged,InsertTwoTracesFromDrawing,
                                ViasSelectionMode,MovingComponents,MouseCursorOnGrid,
                                TracesSelectionMode,CutDrawingTraceToFit,
                                DrawOnGridForLimitTrace,GridVisible,DrawOnGrid,DrawDrill,
                                DrawPowerPads,ReDrawing,DrawSCH,ReserveMemoryForPolygons,
                                ConnectionCoorsSwitched,TraceCoorsSwitched,
                                DrawTwoTryingTraces,ReplaceSelections,EditingSheetSymbol,
                                ForceDisableOnePinNetCheck,
                                Printing,EditingSymbol,FirstWrite,FileChanged,
                                MemoryAllocated,UndoRedoActive,HelpAsked,
                                SelectionActive,SelectionEsc,ExecuteZoom,TraceMode,
                                EmptyBrushActive,FillObjects,DrawClearances,DrawSpecial,
                                DrawCompPlacement,DrawCompOutline,DrawViaClearances,
                                DrawCompReference,DrawCompValue,CompRotationChanged,
                                OkToSwitchDrawingLayers,OkToAddViewPos,
                                CurrentDrawingNetHilited,DrawViaInfoForTryingTrace,
                                DesignActive,UsingPartNumbers,DisableOnePinNetCheck,
                                DrawTraceUsingGuide,IncDeleteNr,DrawTraceLimitInfo;

extern ObjectRecord             DrawWire1,DrawWire2,LimitObject,
                                WireObject1,WireObject2,
                                CurrentWorkingWire,NullObject;

extern double                    Xoffset,Yoffset,Factor,Factor2,RelX,RelY,
                                GridSize,CurrentFontSize,
                                DrawGridSize;

extern int32                    FirstSize,NrObjects,NrObjects2,NrObjects3,NrObjects4,
                                NrObjects5,NrObjects6,MaxSpecialMemory[32],
                                MaxNrNewSymbols,NrNewSymbols,
                                NrConnections,MouseOnGridPosX,MouseOnGridPosY,
                                CurrentObjectCode,CurrentGuideNr,Units,LastSheetNr,
                                LastAction,NrSearchDirs,NrWireLabels,
