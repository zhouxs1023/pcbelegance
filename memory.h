...
extern int32                    ClientWindowDivX,ClientWindowDivY,
                                ...
                                PopupDisplayVisible,ZoomMode,
                                ButtonInfoTimeoutStart,ZoomInOutProcessed,
                                SaveSymbolsLocally,MousePanMultiply,
                                SystemBusyMode,ActiveOnePinNetError,
                                CurrentDirection;
extern double                   TextMinX,TextMinY,
                                TextMaxX,TextMaxY,
...
extern int32                    NetNrWires,NetNrBusses,NetNrJunctions,NetNrBusConnections,
...
extern int32                    Created,Painting,DCInUse,MouseChanged,Focused,
                                ...
                                UnselectAll,LeftButtonDoublePressed,SearchReference,
                                SearchPartnr,SearchReplaceOptions,
                                DataBaseChanged,GridVisible,
                                ReplaceSelections,EditingSheetSymbol,
                                Printing,EditingSymbol,FileChanged,
                                MemoryAllocated,UndoRedoActive,HelpAsked,
                                SelectionEsc,DisableOnePinNetCheck,
                                OkToSwitchDrawingLayers,OkToAddViewPos,
                                FirstPaint,BackGroundActive;
...
extern int32                    FirstSize,NrObjects,NrObjects2,NrObjects3,NrObjects4,
                                ...
                                LastAction,NrWireLabels,
                                NrLibFiles,
                                NrSchematicSymbolLibraries,
                                NrGeometryLibraries,
                                OperatingSystem,
                                ViewPosPointer,
                                NestingLevel,SystemBusyMode,
                                CrossHairVisible,
                                ButtonInfoTimeout,
