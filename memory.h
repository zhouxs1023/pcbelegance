...
extern int32                ClientWindowDivX,ClientWindowDivY,NrParams,
                            RepeatMode,LastAction,CurrentDirection,PreviousDirection,
                            CurrentGuideNr,SystemBusyMode,DrawDrillMode,
                            RepeatModeActive,SaveSymbolsLocally,
                            ButtonInfoTimeout,ButtonInfoTimeoutStart,
                            PopupDisplayVisible,StartWithMaximumView,
                            ZoomInOutProcessed,FastPaint,
                            MoveCompAutoZoom,ZoomMode,MousePanMultiply,
                            DrawLayerCode[32],DrawCode;
extern double               CurrentDrawX1,CurrentDrawY1,
...
extern double               GridSizes[30],GridSize,UserGridSize,CompGridSize,
                            TraceGridSize,AreafillGridSize;


extern int32                WindowWidth,WindowHeight,WindowStartX,WindowStartY,
                            MousePosX,MousePosY,
                            MaxScrollBarX,MaxScrollBarY,
                            ScrollSize,ScrollSizeDrawing,ScrollEndOfWindow,
                            SelectionMode,LastActionNr,
                            CurrentDrawingLayer,
                            CurrentDrawingNetNr,
                            ActionCountVias,MaxLastActionNr,
...
extern int32                NrGraphicsLayers,
                            GraphicsLayers[256];


extern int32                ViasSelected,
                            CompsSelected,
                            ConnectionsSelected,
                            AllTracesSelected,
                            TracesSelected[32],
...
extern int32                GeometryDialogInitialX,
...
extern int32                 Created,Painting,DCInUse,MouseChanged,Focused,
                            LeftButtonPressed,MiddleButtonPressed,RightButtonPressed,
                            UnselectAll,LeftButtonDoublePressed,
                            DataBaseChanged,
                            MovingComponents,MouseCursorOnGrid,
                            GridVisible,
                            DrawPowerPads,ReDrawing,
                            ...
                            DrawTraceUsingGuide,DrawTraceLimitInfo,
                            ...
                            DrawTopComponents,
                            DrawBottomComponents,
                            OkToDrawCrossHair,
                            OkToDrawCompReference,
                            OkToDrawCompValue;

extern int32                DrawSoldMaskBottomMode,
                            DrawSoldMaskTopMode,
                            DrawPasteMaskBottomMode,
                            DrawPasteMaskTopMode,
                            ViewSingleLayer;

extern double               Xoffset,Yoffset,Factor,RelX,RelY,
...
extern int32                FirstSize,NrObjects,NrObjects2,NrObjects3,NrObjects4,
                            NrObjects5,NrObjects6,
                            NrErrorObjects,NrGridSizes,NrTraceWidths,NrClearanceWidths,
...
extern int32                *IndexVerTraces[32],
                            *IndexHorTraces[32],
                            *IndexDiag1Traces[32],
                            *IndexDiag2Traces[32],
                            *IndexVias,
...
extern int32                NrIndexesVerTraces[32],
...
extern ObjectRecord         DrawTrace1,DrawTrace2,LimitObject,
                            TraceObject1,TraceObject2,
...
extern TracesArray          *HorTraces[32],
                            *VerTraces[32],
                            *Diag1Traces[32],
                            *Diag2Traces[32];

extern ObjectArray          *Objects,*Objects2,*Objects3,*Objects4,
                            *Objects5,*Objects6,*ErrorObjects;
...
extern PolygonRecord        *BufferPolygon,*ResultPolygon,*ExtraPolygon,*NewPolygon,
