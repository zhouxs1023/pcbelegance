...
int32           ObjectsNetHorTraces,ObjectsNetVerTraces,
...

{
  ...
  while (cnt<NrTracePoints) {
    if ((InRange4(x,(*TracePoints)[cnt].x))
       &&
       (InRange4(y,(*TracePoints)[cnt].y))) {
      return cnt;
    }
    cnt++;
  }
        ...
        switch (Object->ObjectType) {
          ...
          case PIN_ARC:
            LineSegments=ArcToLineSegments(Object->x1,Object->y1,Object->x2,Object->y2,
                                           Object->x3,Object->y3,Object->x4,Object->y4,(double *)&LineBuf,0);
            SegmentCount=0;
