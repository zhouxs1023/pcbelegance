...
extern int32 (CALLBACK *GetDiskFreeSpaceEx)
                         ...
                         PULARGE_INTEGER pliTotal, PULARGE_INTEGER pliFree)
{
    ...
    FARPROC fp;
    int32 fRc;
    int32 (CALLBACK *RealGetDiskFreeSpaceEx)
             (LPCTSTR, PULARGE_INTEGER, PULARGE_INTEGER, PULARGE_INTEGER);
...
int32 (CALLBACK *GetDiskFreeSpaceEx)
             (LPCTSTR, PULARGE_INTEGER, PULARGE_INTEGER, PULARGE_INTEGER) =
...
extern int32 (CALLBACK *GetFileAttributesEx)
                          ...
                          LPVOID pv)
{
    ...
    FARPROC fp;
    int32 fRc;
    int32 (CALLBACK *RealGetFileAttributesEx)
             (LPCTSTR, GET_FILEEX_INFO_LEVELS, LPVOID);
...
int32 (CALLBACK *GetFileAttributesEx)
                (LPCTSTR, GET_FILEEX_INFO_LEVELS, LPVOID) =
...
int32 (CALLBACK *IsDebuggerPresent)(VOID) =
