...
typedef struct {
        ...
        int count;
         ...
         3             2
(b1 x 256 ) + (b2 x 256 ) + (b3 x 256 ) + b4 =

        4            3            2
(c1 x 85 ) + (c2 x 85 ) + (c3 x 85 ) + (c4 x 85 ) + c5
...
then converted into a base-85 number. The five “digits” of the base-85 number
...
{
  int32 cnt,err,BytesLeft,BytesCompressed,SrcPos,
        BytesWritten,DestPos,Pos1,SpecialPos,IntsToEncode;
