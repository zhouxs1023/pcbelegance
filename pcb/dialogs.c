	...
	case WM_COMMAND:
		...
		case IDOK:
			...
			if ((DialogMode & 0x10) == 0)
			{
				...
				{
					MessageBoxOwn(PCBWindow, SC(188, "Wrong value for text height"), SC(100, "Error"),
					              MB_APPLMODAL | MB_OK);
					return about;
				}
				...
				{
					MessageBoxOwn(PCBWindow, SC(189, "Wrong value for line thickness"), SC(100, "Error"),
					              MB_APPLMODAL | MB_OK);
					return about;
				}
	...
	case WM_COMMAND:
		...
		case IDOK:
			...
			if (res > 0)
			{
				...
				MessageBoxOwn(PCBWindow, SC(206, "Wrong rotation value"), SC(100, "Error"), MB_APPLMODAL | MB_OK);
	...
	case WM_COMMAND:
		...
		case IDOK:
			...
			if (DialogMode == 0)
			{
				...
				{
					MessageBoxOwn(PCBWindow, SC(219, "Wrong value for clearance width in powerplane"), SC(100, "Error"),
					              MB_APPLMODAL | MB_OK);
					return about;
				}
			...
			{
				MessageBoxOwn(PCBWindow, SC(220, "Wrong value for clearance width"), SC(100, "Error"),
				              MB_APPLMODAL | MB_OK);
				return about;
			}
			...
			if (DialogMode == 2)
			{
				...
				{
					MessageBoxOwn(PCBWindow, SC(221, "Wrong value for surround thickness"), SC(100, "Error"),
					              MB_APPLMODAL | MB_OK);
					return about;
				}
			...
			if (SendDlgItemMessageOwn(Dialog, IDC_CHECK2, BM_GETCHECK, 0, 0))
			{
				...
				{
					MessageBoxOwn(PCBWindow, SC(222, "Wrong value for thermal relief"), SC(100, "Error"),
					              MB_APPLMODAL | MB_OK);
					return about;
				}
	...
	case WM_COMMAND:
		...
		case IDOK:
			...
			else
			{
				...
				if (res == -1)
				{
					MessageBoxOwn(PCBWindow, SC(298, "A value should be selected"), SC(100, "Error"),
					              MB_APPLMODAL | MB_OK);
					return about;
				}
