...
#ifdef TEST
	sprintf(str2,
	        "TEST TEST TEST TEST TEST TEST TEST TEST TEST     %s     TEST TEST TEST TEST TEST TEST TEST TEST TEST",
	        str);
	strcpy(str, str2);
#endif
...
int32 LoadNewFile()
{
	...
	if (GetNewFileUTF8
	        (PCBWindow, NULL, EditFile2, ProjectPath, SC(389, "Layout files"), NULL, SC(389, "Layout files"), "pcb", 0))
		return -1;
...
int32 SaveFileName(int32 Mode)
{
	...
	if (GetNewFileUTF8
	        (PCBWindow, NULL, EditFile, str, SC(389, "Layout files"), NULL, SC(389, "Layout files"), "pcb", 1))
		return -1;
...
{
	if (GetNewFileUTF8(PCBWindow, NULL, NewFile, ExportDir, SC(363, "DXF file"), NULL, SC(364, "DXF files"), "dxf", 1))
		return -1;
