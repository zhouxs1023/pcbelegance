...

{
  ...
  x2=x+width;
  y2=y+height;
  if ((x2<=DrawWindowMinX-1000)
     ||
     (x1>=DrawWindowMaxX+1000)
     ||
     (y2<=DrawWindowMinY-1000)
     ||
     (y1>=DrawWindowMaxY+1000)) return;

  if (x1<DrawWindowMinX-1000) x1=DrawWindowMinX-1000;
  if (y1<DrawWindowMinY-1000) y1=DrawWindowMinY-1000;
  if (x2>DrawWindowMaxX+1000) x2=DrawWindowMaxX+1000;
  if (y2>DrawWindowMaxY+1000) y2=DrawWindowMaxY+1000;
