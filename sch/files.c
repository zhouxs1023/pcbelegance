...
int32 LoadNewFile(int32 mode)
{
	...
	char str[MAX_LENGTH_STRING], str3[MAX_LENGTH_STRING], str4[MAX_LENGTH_STRING], str5[MAX_LENGTH_STRING],
	     NewEditFile[MAX_LENGTH_STRING], EditFile2[MAX_LENGTH_STRING], FileName[MAX_LENGTH_STRING],
...
int32 SaveFileName(int32 Mode)
{
	...
	char str[MAX_LENGTH_STRING], str3[MAX_LENGTH_STRING], str4[MAX_LENGTH_STRING], str5[MAX_LENGTH_STRING],
	     FileName[MAX_LENGTH_STRING], DefExt[10];
	LPSTR Niks;
