...
//      break;
  ...
  if (BufSize>0) {
    if (ClipBoardMemPos+BufSize+128>=ClipBoardMemSize) {
      if (AllocateMemClipBoard(ClipBoardMemPos+BufSize+16384)!=0) return -1;
    }
...
//    if (stricmp(Instance->SymbolName
      ...
      if (UnselectAll) {
        ...
        if ((SearchMaxX>x1a)
          ...
          while ((!Found)
                ...
                (cnt2<NrObjects)) {
            Object=&((*Objects)[cnt2]);
            if ((Object->maxx>=SearchMinX)
               &&
               (Object->minx<=SearchMaxX)
               &&
               (Object->maxy>=SearchMinY)
               &&
...
// *****************************************************************************************
            ...
            if ((TextMaxX>=SearchMinX)
              ...
              if ((InstanceInfo & OBJECT_SELECTED) == OBJECT_SELECTED) {
                if ((InstanceInfo & 4) == 4) {
                  ...
                  InstanceInfo^=1;
                  if ((InstanceInfo & 7) == 0) InstanceInfo^=OBJECT_SELECTED;
                }
              } else {
  ...
  if (Selected>0) {
    sprintf(InfoStr,"%d symbols selected",Selected);
  } else {
    InfoStr[0]=0;
  }
  if (!OutputDisplay) {
    ...
    if ((WireInfo & OBJECT_NOT_VISIBLE) == 0) {
      ...
      if (UnselectAll) {
        if ((WireInfo & OBJECT_SELECTED) == OBJECT_SELECTED) {
          ...
          Changed=1;
          if (ViewMode==1) GetNetNrSelectedWiresObjects5(Wire,UNSELECT_NETNR);
        }
      } else {
          ...
          if ((WireInfo & OBJECT_SELECTED) == OBJECT_SELECTED) {
            ...
            if ((WireSelectMode==0)
              ...
              if (((SearchMinX<min(x1,x2))
                 ...
                 &&
                 (SearchMaxY>max(y1,y2)))) {
                if (ViewMode==1) GetNetNrSelectedWiresObjects5(Wire,SELECT_NETNR);
    ...
    if ((BusInfo & OBJECT_NOT_VISIBLE) == 0) {
      ...
      if (UnselectAll) {
        if ((BusInfo & OBJECT_SELECTED) == OBJECT_SELECTED) {
          ...
          if (ViewMode==1) GetNetNrSelectedBussesObjects5(Bus,UNSELECT_NETNR);
          Changed=1;
        }
      } else {
        if ((TestResult=RectTestLine2(x1,y1,x2,y2))!=0) {
          if ((BusInfo & OBJECT_SELECTED) == OBJECT_SELECTED) {
            ...
            if ((WireSelectMode==0)
              ...
              if (((SearchMinX<min(x1,x2))
                 ...
                 &&
                 (SearchMaxY>max(y1,y2)))) {
                if (ViewMode==1) GetNetNrSelectedBussesObjects5(Bus,SELECT_NETNR);
...
//      ThickNess=Junction->ThickNess;
      if (((UnselectAll) && ((JunctionInfo & OBJECT_SELECTED) == OBJECT_SELECTED))
         ...
         ((!UnselectAll)
         &&
         (RectTestCircle(x1,y1,ThickNess,0xff)))) {
        ...
        if (RectTestRect(Xmin,Ymin,Xmax,Ymax)) {
          ...
          if ((TextMaxX>=SearchMinX)
            ...
            if ((GlobalConnectionInfo & OBJECT_SELECTED) == OBJECT_SELECTED) {
              ...
              if ((GlobalConnectionInfo & 3) == 0) GlobalConnectionInfo&=~(OBJECT_SELECTED|3);
            } else {
      ...
      if (UnselectAll) {
        ...
        if (RectTestRect(x1-0.25,y1-0.25,x1+0.25,y1+0.25)) {
          ...
          if ((TextMaxX>=SearchMinX)
            ...
            if ((PinInfo & OBJECT_SELECTED) == OBJECT_SELECTED) {
              PinInfo^=2;
              if ((PinInfo & 3) == 0) PinInfo&=~(OBJECT_SELECTED|3);
            } else {
      ...
      if (UnselectAll) {
        ...
        if (RectTestRect(x1-0.25,y1-0.25,x1+0.25,y1+0.25)) {
          ...
          if ((Xmax>=SearchMinX)
            ...
            if ((PinBusInfo & OBJECT_SELECTED) == OBJECT_SELECTED) {
              PinBusInfo^=2;
              if ((PinBusInfo & 3) == 0) PinBusInfo&=~(OBJECT_SELECTED|3);
            } else {
  ...
  for (cnt=0;cnt<Design.NrInstances;cnt++) {
    ...
    if ((Instance->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
      if ((Instance->Info & 4)==4) {
        ...
        if ((Instance->Info & 1)==1) InstanceRefsSelected++;
        if ((Instance->Info & 2)==2) InstanceValuesSelected++;
      }
    }
  }
  ...
  if (!EditingSymbol) {
    ...
    for (cnt=0;cnt<Design.NrGlobalConnections;cnt++) {
      ...
      if ((GlobalConnection->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
        if ((GlobalConnection->Info & 1)==1) GlobalConnectionsSelected++;
        if ((GlobalConnection->Info & 2)==2) GlobalConnectionTextsSelected++;
      }
    }
  } else {
    for (cnt=0;cnt<DesignSymbol.NrPins;cnt++) {
...

{
  ...
  double  CompX,CompY,InstanceMinX,InstanceMaxX,InstanceMinY,InstanceMaxY,
          x1,y1,x2,y2,x3,y3;
      ...
      if ((Instance->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
        ...
        for (cnt3=0;cnt3<Design.NrWires;cnt3++) {
          ...
          if ((Wire->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
            if ((min(Wire->X1,Wire->X2)<InstanceMaxX)
               &&
               (max(Wire->X1,Wire->X2)>InstanceMinX)
               &&
               (min(Wire->Y1,Wire->Y2)<InstanceMaxY)
               &&
               (max(Wire->Y1,Wire->Y2)>InstanceMinY)) {
              if (CalcObjects==0) {
                NrObjects=0;
              ...
              while (cnt2<NrObjects) {
                ...
                if (stricmp(Instance->Reference,"t25")==0) {
                  ok=1;
                  if ((InRange(Object->x1,74.0))
                     &&
                     (InRange(Object->y1,38.0))) {
                    ok=1;
                  }
                }
#endif
                if ((InRange(Object->x1,Wire->X1))
                   &&
                   (InRange(Object->y1,Wire->Y1))) {
                  Wire->Info&=~3;
                  Wire->Info|=OBJECT_SELECTED|1;
                  cnt2=NrObjects;
                  DrawWire(Wire,0.0,0.0,0);
                } else {
                  if ((InRange(Object->x1,Wire->X2))
                     &&
                     (InRange(Object->y1,Wire->Y2))) {
                    Wire->Info&=~3;
        ...
        for (cnt3=0;cnt3<Design.NrBusses;cnt3++) {
          ...
          if ((Bus->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
            if ((min(Bus->X1,Bus->X2)<InstanceMaxX)
               &&
               (max(Bus->X1,Bus->X2)>InstanceMinX)
               &&
               (min(Bus->Y1,Bus->Y2)<InstanceMaxY)
               &&
               (max(Bus->Y1,Bus->Y2)>InstanceMinY)) {
              if (CalcObjects==0) {
                NrObjects=0;
                InstanceToObject(Instance,0.0,0.0,1);
                CalcObjects=1;
              ...
              while (cnt2<NrObjects) {
                Object=&((*Objects)[cnt2]);
                if ((InRange(Object->x1,Bus->X1))
                   &&
                   (InRange(Object->y1,Bus->Y1))) {
                  Bus->Info&=~3;
                  Bus->Info|=OBJECT_SELECTED|1;
                  cnt2=NrObjects;
                  DrawBus(Bus,0.0,0.0,0);
                } else {
                  if ((InRange(Object->x1,Bus->X2))
                     &&
                     (InRange(Object->y1,Bus->Y2))) {
                    Bus->Info&=~3;
      ...
      if ((Wire->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED|3)) == (OBJECT_SELECTED|3)) {
        for (cnt2=0;cnt2<Design.NrWires;cnt2++) {
          if (cnt2!=cnt3) {
            ...
            if ((Wire2->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
              if ((InRange(Wire->X1,Wire2->X1))
                 &&
                 (InRange(Wire->Y1,Wire2->Y1))) {
                Wire2->Info&=~3;
                Wire2->Info|=OBJECT_SELECTED|1;
                DrawWire(Wire2,0.0,0.0,0);
              } else {
                if ((InRange(Wire->X1,Wire2->X2))
                   &&
                   (InRange(Wire->Y1,Wire2->Y2))) {
                  Wire2->Info&=~3;
        ...
        for (cnt2=0;cnt2<Design.NrWires;cnt2++) {
          if (cnt2!=cnt3) {
            Wire2=&((*Wires)[cnt2]);
            if ((Wire2->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
              if ((InRange(Wire->X2,Wire2->X1))
                 &&
                 (InRange(Wire->Y2,Wire2->Y1))) {
                Wire2->Info&=~3;
                Wire2->Info|=OBJECT_SELECTED|1;
                DrawWire(Wire2,0.0,0.0,0);
              } else {
                if ((InRange(Wire->X2,Wire2->X2))
                   &&
                   (InRange(Wire->Y2,Wire2->Y2))) {
                  Wire2->Info&=~3;
                  Wire2->Info|=OBJECT_SELECTED|2;
                  DrawWire(Wire2,0.0,0.0,0);
                }
      ...
      if ((Bus->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED|3)) == (OBJECT_SELECTED|3)) {
        for (cnt2=0;cnt2<Design.NrBusses;cnt2++) {
          if (cnt2!=cnt3) {
            ...
            if ((Bus2->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
              if ((InRange(Bus->X1,Bus2->X1))
                 &&
                 (InRange(Bus->Y1,Bus2->Y1))) {
                Bus2->Info&=~3;
                Bus2->Info|=OBJECT_SELECTED|1;
                DrawBus(Bus2,0.0,0.0,0);
              } else {
                if ((InRange(Bus->X1,Bus2->X2))
                   &&
                   (InRange(Bus->Y1,Bus2->Y2))) {
                  Bus2->Info&=~3;
        ...
        for (cnt2=0;cnt2<Design.NrBusses;cnt2++) {
          if (cnt2!=cnt3) {
            Bus2=&((*Busses)[cnt2]);
            if ((Bus2->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
              if ((InRange(Bus->X2,Bus2->X1))
                 &&
                 (InRange(Bus->Y2,Bus2->Y1))) {
                Bus2->Info&=~3;
                Bus2->Info|=OBJECT_SELECTED|1;
                DrawBus(Bus2,0.0,0.0,0);
              } else {
                if ((InRange(Bus->X2,Bus2->X2))
                   &&
                   (InRange(Bus->Y2,Bus2->Y2))) {
                  Bus2->Info&=~3;
                  Bus2->Info|=OBJECT_SELECTED|2;
                  DrawBus(Bus2,0.0,0.0,0);
                }
      ...
      if ((Bus->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED|3)) == (OBJECT_SELECTED|3)) {
        for (cnt3=0;cnt3<Design.NrBusConnections;cnt3++) {
          ...
          if ((BusConnection->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
            ...
            if (InRange(Bus->X1,Bus->X2)) { // Vertical
              if (InRange(Bus->X1,x2)) {
                BusConnection->Info|=OBJECT_SELECTED|3;
                DrawBusConnection(BusConnection,0.0,0.0,0);
              }
            }
            if (InRange(Bus->Y1,Bus->Y2)) { // Horizontal
    ...
    for (cnt3=0;cnt3<Design.NrBusConnections;cnt3++) {
      ...
      if ((BusConnection->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == (OBJECT_SELECTED)) {
        ...
        for (cnt2=0;cnt2<Design.NrWires;cnt2++) {
          Wire=&((*Wires)[cnt2]);
          if ((Wire->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
            if ((InRange(CompX,Wire->X1))
               &&
               (InRange(CompY,Wire->Y1))) {
              Wire->Info&=~3;
              Wire->Info|=OBJECT_SELECTED|1;
              DrawWire(Wire,0.0,0.0,0);
            } else {
              if ((InRange(CompX,Wire->X2))
                 &&
                 (InRange(CompY,Wire->Y2))) {
                Wire->Info&=~3;
                Wire->Info|=OBJECT_SELECTED|2;
                DrawWire(Wire,0.0,0.0,0);
              }
        ...
        for (cnt2=0;cnt2<Design.NrBusses;cnt2++) {
          Bus=&((*Busses)[cnt2]);
          if ((Bus->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
            if ((InRange(CompX,Bus->X1))
               &&
               (InRange(CompY,Bus->Y1))) {
              Bus->Info&=~3;
              Bus->Info|=OBJECT_SELECTED|1;
              DrawBus(Bus,0.0,0.0,0);
            } else {
              if ((InRange(CompX,Bus->X2))
                 &&
                 (InRange(CompY,Bus->Y2))) {
                Bus->Info&=~3;
                Bus->Info|=OBJECT_SELECTED|2;
                DrawBus(Bus,0.0,0.0,0);
              }
      ...
      if ((Wire->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == (OBJECT_SELECTED)) {
        for (cnt2=0;cnt2<Design.NrNetLabels;cnt2++) {
          ...
          if ((NetLabel->Info & (OBJECT_NOT_VISIBLE)) == 0) {
            if ((Wire->Info & 3) == 3) {
              if (((InRange(Wire->X1,NetLabel->ConnectX))
                 &&
                 (InRange(Wire->Y1,NetLabel->ConnectY)))
                 ||
                 ((InRange(Wire->X2,NetLabel->ConnectX))
                 &&
            ...
            if (((Wire->Info & 3) == 1)
               &&
               (InRange(Wire->X1,NetLabel->ConnectX))
               &&
               (InRange(Wire->Y1,NetLabel->ConnectY))) {
              Change=1;
            }
    ...
    for (cnt3=0;cnt3<Design.NrBusses;cnt3++) {
      ...
      if ((Bus->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == (OBJECT_SELECTED)) {
        for (cnt2=0;cnt2<Design.NrNetLabels;cnt2++) {
          ...
          if ((NetLabel->Info & (OBJECT_NOT_VISIBLE)) == 0) {
            if ((Bus->Info & 3) == 3) {
              if (((InRange(Bus->X1,NetLabel->ConnectX))
                 &&
            ...
            if (((Bus->Info & 3) == 1)
               &&
               (InRange(Bus->X1,NetLabel->ConnectX))
               &&
               (InRange(Bus->Y1,NetLabel->ConnectY))) {
              Change=1;
            }
...
//  ObjectRecord *Object,*Object2;
  ...
  if (!EditingSymbol) {
    if (((Mode==0) && (Selected==SELECTIONS_WIRES))
       ||
       ((Mode==1) && (Selected!=SELECTIONS_WIRES))) {
      for (cnt=0;cnt<Design.NrWires;cnt++) {
        Wire=&((*Wires)[cnt]);
        if ((Wire->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
    ...
    if (((Mode==0) && (Selected==SELECTIONS_BUSSES))
       ||
       ((Mode==1) && (Selected!=SELECTIONS_BUSSES))) {
      for (cnt=0;cnt<Design.NrBusses;cnt++) {
        Bus=&((*Busses)[cnt]);
        if ((Bus->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
    ...
    if (((Mode==0) && (Selected==SELECTIONS_JUNCTIONS))
       ||
       ((Mode==1) && (Selected!=SELECTIONS_JUNCTIONS))) {
      for (cnt=0;cnt<Design.NrJunctions;cnt++) {
        Junction=&((*Junctions)[cnt]);
        if ((Junction->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
    ...
    if (((Mode==0) && (Selected==SELECTIONS_BUSCONN))
       ||
       ((Mode==1) && (Selected!=SELECTIONS_BUSCONN))) {
      for (cnt=0;cnt<Design.NrBusConnections;cnt++) {
        BusConnection=&((*BusConnections)[cnt]);
        if ((BusConnection->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
    ...
    if (Mode==1) {
      if ((Selected!=SELECTIONS_GLOBALCONN)
         &&
         (Selected!=SELECTIONS_GLOBALCONN_TEXT)) {
        for (cnt=0;cnt<Design.NrGlobalConnections;cnt++) {
          GlobalConnection=&((*GlobalConnections)[cnt]);
          if ((GlobalConnection->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
    ...
    if (((Mode==0) && (Selected==SELECTIONS_POWERPINS))
       ||
       ((Mode==1) && (Selected!=SELECTIONS_POWERPINS))) {
      for (cnt=0;cnt<DesignSymbol.NrPowerPins;cnt++) {
        PowerPin=&((*PowerPins)[cnt]);
        if ((PowerPin->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
    ...
    if (Selected==SELECTIONS_INST) {
      for (cnt=0;cnt<Design.NrInstances;cnt++) {
        ...
        if ((Instance->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
          Instance->Info&=~(OBJECT_SELECTED|7);
          DrawInstance(Instance,0.0,0.0,0);
          if (ViewMode==1) CopyToClipBoardMem(UNSELECT_REF,0,Instance->Reference);
        }
      }
    }
    if (Selected==SELECTIONS_INST_REF) {
      for (cnt=0;cnt<Design.NrInstances;cnt++) {
        ...
        if ((Instance->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED|1)) == (OBJECT_SELECTED|1)) {
          Instance->Info&=~1;
          if ((Instance->Info & 3)==0) Instance->Info&=~(OBJECT_SELECTED|7);
          DrawInstance(Instance,0.0,0.0,0);
        }
      }
    }
  ...
  if (Mode==1) {
    if ((Selected!=SELECTIONS_INST_REF)
       &&
       (Selected!=SELECTIONS_INST_VALUE)
       &&
       (Selected!=SELECTIONS_INST)) {
      for (cnt=0;cnt<Design.NrInstances;cnt++) {
        Instance=(InstanceRecord *)&((*Instances)[cnt]);
        if ((Instance->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
          Instance->Info&=~(OBJECT_SELECTED|7);
  ...
  if (((Mode==0) && (Selected==SELECTIONS_LINES))
     ||
     ((Mode==1) && (Selected!=SELECTIONS_LINES))) {
    for (cnt=0;cnt<Design.NrObjectLines;cnt++) {
      ObjectLine=&((*ObjectLines)[cnt]);
      if ((ObjectLine->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
  ...
  if (((Mode==0) && (Selected==SELECTIONS_RECTS))
     ||
     ((Mode==1) && (Selected!=SELECTIONS_RECTS))) {
    for (cnt=0;cnt<Design.NrObjectRects;cnt++) {
      ObjectRect=&((*ObjectRects)[cnt]);
      if ((ObjectRect->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
  ...
  if (((Mode==0) && (Selected==SELECTIONS_CIRCLES))
     ||
     ((Mode==1) && (Selected!=SELECTIONS_CIRCLES))) {
    for (cnt=0;cnt<Design.NrObjectCircles;cnt++) {
      ObjectCircle=&((*ObjectCircles)[cnt]);
      if ((ObjectCircle->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
  ...
  if (((Mode==0) && (Selected==SELECTIONS_ARCS))
     ||
     ((Mode==1) && (Selected!=SELECTIONS_ARCS))) {
    for (cnt=0;cnt<Design.NrObjectArcs;cnt++) {
      ObjectArc=&((*ObjectArcs)[cnt]);
      if ((ObjectArc->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
  ...
  if (((Mode==0) && (Selected==SELECTIONS_TEXTS))
     ||
     ((Mode==1) && (Selected!=SELECTIONS_TEXTS))) {
    for (cnt=0;cnt<Design.NrObjectTexts;cnt++) {
      ObjectText=&((*ObjectTexts)[cnt]);
      if ((ObjectText->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
        ObjectText->Info&=~OBJECT_SELECTED;
...

{
  ...
  for (cnt=0;cnt<DesignSymbol.NrPins;cnt++) {
    ...
    if ((Pin->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
      sprintf(str2,"%s\t%s\r\n",Pin->Name,Pin->Label);
      if (strlen(Message)<16000) strcat(Message,str2);
    }
  }
  strcat(Message,"\r\n");
  for (cnt=0;cnt<DesignSymbol.NrPowerPins;cnt++) {
  ...
  for (cnt=0;cnt<DesignSymbol.NrPinBusses;cnt++) {
    ...
    if ((PinBus->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
      ...
      for (cnt2=0;cnt2<NrLines;cnt2++) {
        ...
        if (strlen(Message)<16000) strcat(Message,PinBusStrings[cnt2]);
        strcat(Message,"\r\n");
      }
  ...
  for (cnt=0;cnt<Design.NrObjectTexts;cnt++) {
    ObjectText=&((*ObjectTexts)[cnt]);
    if ((ObjectText->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == OBJECT_SELECTED) {
      if (strlen(Message)<16000) strcat(Message,ObjectText->Text);
      strcat(Message,"\r\n");
    }
  }
...

{
  ...
  sprintf(str,"%s\\net.nr",DesignPath);
  if ((fp=TextFileOpenUTF8(str))<0) return -1;
  while ((Length=ReadLn(fp,str2))>=0) {
    str2[Length]=0;
    if (Length>1) {
      if ((sscanf(str2,"%i %s",&cnt,str3)==2)
         &&
         (cnt==NetNr)) {
        TextFileClose(fp);
        strcpy(NetName,str3);
...

{
  ...
  Object5Pos=-1;
  cnt=0;
  while ((cnt<NrObjects5)
        &&
        (Object5Pos==-1)) {
    Object5=&((*Objects5)[cnt]);
    if (Object5->ObjectType==WIRE) {
      if ((InRange(Object5->x1,Wire->X1))
         &&
         (InRange(Object5->y1,Wire->Y1))
         &&
         (InRange(Object5->x2,Wire->X2))
         &&
...

{
  ...
  while ((cnt<NrObjects5)
    ...
    if (Object5->ObjectType==BUS) {
      if ((InRange(Object5->x1,Bus->X1))
         &&
         (InRange(Object5->y1,Bus->Y1))
         &&
         (InRange(Object5->x2,Bus->X2))
         &&
...

{
  ...
  if (mode==0) {
    ...
    if (TextInputDialog(&NewObjectText,6)==2) return;
...
again:
  ...
  for (cnt=0;cnt<Design.NrInstances;cnt++) {
    ...
    if ((Instance->Info & (OBJECT_NOT_VISIBLE|OBJECT_PROTECTED)) == 0) {
      if ((EditingSymbol)
         ||
         ((Instance->ValueInfo & TEXT_NOT_VISIBLE) == 0)) {
      ...
      for (cnt=0;cnt<Design.NrNetLabels;cnt++) {
        ...
        if ((NetLabel->Info & OBJECT_NOT_VISIBLE) == 0) {
          if (stricmpUTF8(NetLabel->Name,SearchTextStr)==0) {
            ...
            if (SkipSearchCount==SearchTextCount) {
              NetLabel->Info|=OBJECT_SELECTED|3;
              CenterScreen(NetLabel->ConnectX+NetLabel->TextX,
                           NetLabel->ConnectY+NetLabel->TextY,0);
              return;
            }
          }
        }
...

{
  ...
  char str[2048],str2[MAX_LENGTH_STRING],
  ...
  if (DisplayInfoCursorX!=-1) {
    if ((abs(DisplayInfoCursorX-MousePosX)>5)
       ||
       (abs(DisplayInfoCursorY-MousePosY)>5)) {
...
//       (Instance->Properties[0]!=0)) {
      if ((x>Instance->BoardPosMinX)
         &&
         (x<Instance->BoardPosMaxX)
         &&
         (y>Instance->BoardPosMinY)
         &&
        ...
        if (((GetMinMaxInstanceReferenceText(Instance)==0)
           ...
           (TextMinY<y))
           ||
           ((GetMinMaxInstanceValueText(Instance)==0)
           &&
           (TextMaxX>x)
           &&
           (TextMinX<x)
          ...
          if (!EditingSymbol) {
            sprintf(str,SC(492,"Component\r\n\f\r\n"));
          } else {
            if (!EditingSheetSymbol) {
              sprintf(str,SC(493,"Symbol\r\n\f\r\n"));
            } else {
              sprintf(str,SC(494,"Sheet symbol\r\n\f\r\n"));
            }
          }
          if (!EditingSheetSymbol) {
          ...
          if (!EditingSymbol) {
            sprintf(str2,SC(499,"PartNr: %s\r\n"),Instance->PartNr);
            strcat(str,str2);
          }
          sprintf(str2,SC(500,"PartDescription: %s\r\n"),Instance->PartDescription);
          strcat(str,str2);
