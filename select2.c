...
{
  int32               cnt,cnt2,FoundGuideNr,FoundAllLayerNr,FoundAllLayerTraceType,
                      FoundCurrentLayerTraceType,Layer,
                      ObjectLayer,FoundCurrentLayerTraceNr,FoundAllLayerTraceNr,FoundViaNr,
                      NetNr,TraceInfo,ObjectType;
  double              ConnectionX1,ConnectionY1,ConnectionX2,ConnectionY2,
                      SearchMinX,SearchMinY,SearchMaxX,SearchMaxY,
                      MinLengthCurrentLayerPin,MinLengthAllLayerPin,
                      MinLengthVia,MinLengthCurrentLayerTrace,MinLengthAllLayerTrace,
                      PointX,PointY,HulpLength,x1,y1,x2,y2,y2a,MinLengthGuide;
  ObjectRecord        *Object,FoundAllLayerPinObject,TraceObject,
                      FoundCurrentLayerPinObject;
    ...
    for (cnt=0;cnt<Design.NrConnections;cnt++) {
      ...
      if ((Connection->Info & (CONNECTIONS_DISABLED|OBJECT_NOT_VISIBLE)) == 0) {
        if ((Connection->Info & (OBJECT_HIGHLITED|CONNECTIONS_NOT_VISIBLE)) != CONNECTIONS_NOT_VISIBLE) {
          ...
          HulpLength=DistancePointToConnection(PointX,PointY,ConnectionX1,ConnectionY1,ConnectionX2,ConnectionY2);
...
// *******************************************************************************************************
  ...
  for (Layer=0;Layer<32;Layer++) {
    ...
    if ((TraceLayersSelectable[Layer]==-1)
       &&
       (DrawCode>=0)
       &&
      ...
      for (cnt=0;cnt<Design.NrDiag1Traces[Layer];cnt++) {
        ...
        if ((TraceInfo & OBJECT_NOT_VISIBLE) == 0) {
          ...
          if ((x2+y2a>=SearchMinX)
            ...
            MakePolygonFromObject(&TraceObject,PolygonObject,0.0,0.0,1,1);
            if ((PointInPolygon(PolygonObject,PointX,PointY) & 1) == 1) HulpLength=100.0;
            if (HulpLength<MinLengthAllLayerTrace) {
              MinLengthAllLayerTrace=HulpLength;
...
// *******************************************************************************************************
  for (cnt=0;cnt<Design.NrObjectLines;cnt++) {
    ...
    if (((ObjectLine->Info & (OBJECT_NOT_VISIBLE)) == 0)
      ...
      if ((max(x1,x2)+y2a>=SearchMinX)
         &&
         (min(x1,x2)-y2a<=SearchMaxX)
         &&
         (max(y1,y2)+y2a>=SearchMinY)
         &&
         (min(y1,y2)-y2a<=SearchMaxY)) {
        HulpLength=DistancePointToTrace(PointX,PointY,x1,y1,x2,y2)+100.0;
        if (HulpLength<MinLengthAllLayerTrace) {
          MinLengthAllLayerTrace=HulpLength;
          FoundAllLayerTraceNr=cnt;
  ...
  for (cnt=0;cnt<Design.NrObjectArcs;cnt++) {
    ...
    if (((ObjectArc->Info & (OBJECT_NOT_VISIBLE|OBJECT_FILLED)) == 0)
      ...
      if ((x1+y2a>=SearchMinX)
         ...
         &&
         (y1-y2a<=SearchMaxY)) {
        HulpLength=DistancePointToArc(PointX,PointY,ObjectArc->CentreX,ObjectArc->CentreY,
                                      ObjectArc->Width,ObjectArc->Height,
...
//        if (HulpLength<y2a) HulpLength=20000.0;
        if (HulpLength<y2a) HulpLength=50.0;
        ...
        for (cnt2=0;cnt2<NrObjects;cnt2++) {
          ...
          switch (Object->ObjectType) {
            case DRILL:
              ...
              if (HulpLength<Object->x2*0.5) HulpLength=200.0;
...
*/
              ...
              if ((PointInPolygon(PolygonObject,PointX,PointY) & 1) == 1) HulpLength=200.0;
              if (HulpLength<MinLengthAllLayerPin) {
                MinLengthAllLayerPin=HulpLength;
                memmove(&FoundAllLayerPinObject,Object,sizeof(ObjectRecord));
              }
...
//                if (HulpLength<Object->x2*0.5) HulpLength=20000.0;
              ...
              if ((CurrentDrawingLayer!=-1)
                 &&
                 (CurrentDrawingLayer==Object->Layer)
                 &&
...
*/
  ...
  if ((MinLengthGuide>3e5)
     &&
     (MinLengthCurrentLayerPin>3e5)
     &&
     (MinLengthAllLayerPin>3e5)
     &&
     (MinLengthCurrentLayerTrace>3e5)
     &&
     (MinLengthAllLayerTrace>3e5)
     &&
     (MinLengthVia>3e5)) {
    return;
  }

  if (mode==0) { // Only draw from pins/vias

    if ((MinLengthGuide<MinLengthCurrentLayerPin)
       &&
       (MinLengthGuide<MinLengthAllLayerPin)
       &&
       (MinLengthGuide<MinLengthCurrentLayerTrace)
       &&
       (MinLengthGuide<MinLengthAllLayerTrace)
       &&
    ...
    if ((MinLengthCurrentLayerPin<MinLengthAllLayerPin)
       &&
       (MinLengthCurrentLayerPin<MinLengthCurrentLayerTrace)
       &&
       (MinLengthCurrentLayerPin<MinLengthAllLayerTrace)
       &&
       (MinLengthCurrentLayerPin<MinLengthVia)
       &&
    ...
    if ((MinLengthAllLayerPin<MinLengthCurrentLayerPin)
       &&
       (MinLengthAllLayerPin<MinLengthCurrentLayerTrace)
       &&
       (MinLengthAllLayerPin<MinLengthAllLayerTrace)
       &&
       (MinLengthAllLayerPin<MinLengthVia)
       &&
    ...
    if ((MinLengthVia<MinLengthCurrentLayerPin)
       &&
       (MinLengthVia<MinLengthAllLayerPin)
       &&
       (MinLengthVia<MinLengthCurrentLayerTrace)
       &&
       (MinLengthVia<MinLengthAllLayerTrace)
       &&
...
//  MinLengthAllLayerTrace=max(.3e5,MinLengthAllLayerTrace);
  ...
  if ((MinLengthCurrentLayerTrace<MinLengthVia)
     &&
     (MinLengthCurrentLayerTrace<MinLengthAllLayerPin)
     &&
     (MinLengthCurrentLayerTrace<MinLengthCurrentLayerPin)
     &&
     (MinLengthCurrentLayerTrace<MinLengthAllLayerTrace)
     &&
     (MinLengthCurrentLayerTrace<MinLengthGuide)) {
  ...
  if ((MinLengthAllLayerTrace<MinLengthVia)
     &&
     (MinLengthAllLayerTrace<MinLengthAllLayerPin)
     &&
     (MinLengthAllLayerTrace<MinLengthCurrentLayerTrace)
     &&
     (MinLengthAllLayerTrace<MinLengthCurrentLayerPin)
     &&
...
{
  int32               cnt,cnt2,ConnectionObjectNr1,ConnectionObjectNr2,
                      ConnectionObjectNr1a,ConnectionObjectNr2a,
                      NetNr,Layer,Layer1,Layer2;
  double              ConnectionX1,ConnectionY1,ConnectionX2,ConnectionY2,hulp1,hulp2,
                      divx,x1,y1,x2,y2,Angle1,Angle2;
  ConnectionsRecord   *Connection;
  NetRecord *Net;
...
// **************************************************************************************************************
  ...
  if ((DrawLayerCode[CurrentDrawingLayer] & 0x10) == 0x10) {
    if (Design.NrBoardLayers==2) {
      ...
      cnt=0;
      while ((cnt<Design.NrBoardLayers)
            &&
            (DrawLayerCode[cnt]>=0x10)) cnt++;
      if (cnt==Design.NrBoardLayers) return;
  ...
  if (CurrentDrawingLayer==-1) {
    if ((Layer1==-1)
       ...
       (Layer2==-1)) {
      Layer=0;
      if (DrawLayerCode[Layer]<0x10) FoundLayer=1;
    }
    if ((!FoundLayer)
       &&
       (Layer1==-1)) {
    ...
    if (!FoundLayer) {
      switch (Object1->ObjectType) {
        ...
        case PIN_ARC:
        case PIN_LINE_ALL_ANGLE:
          if ((Object2->ObjectType==TRACE_HOR)
             ||
             (Object2->ObjectType==TRACE_VER)
             ||
             (Object2->ObjectType==TRACE_DIAG1)
             ||
             (Object2->ObjectType==TRACE_DIAG2)
             ||
             (Object2->ObjectType==TRACE_ALL_ANGLE)
             ||
             (Object2->ObjectType==TRACE_ARC)) {
            Layer=Layer1;
            if (DrawLayerCode[Layer]<0x10) FoundLayer=1;
          }
      }
    ...
    if (!FoundLayer) {
      switch (Object2->ObjectType) {
        ...
        case PIN_ARC:
        case PIN_LINE_ALL_ANGLE:
          if ((Object1->ObjectType==TRACE_HOR)
             ||
             (Object1->ObjectType==TRACE_VER)
             ||
             (Object1->ObjectType==TRACE_DIAG1)
             ||
             (Object1->ObjectType==TRACE_DIAG2)
             ||
             (Object1->ObjectType==TRACE_ALL_ANGLE)
             ||
             (Object1->ObjectType==TRACE_ARC)) {
            Layer=Layer2;
            if (DrawLayerCode[Layer]<0x10) FoundLayer=1;
          }
      }
...
// **************************************************************************************************************
    ...
    if ((!FoundLayer)
       &&
       (Layer1==-1)) {
      if (hulp1<hulp2) Layer=CurrentDrawingLayer;
      else Layer=Layer2;
      if (DrawLayerCode[Layer]<0x10) FoundLayer=1;
    }
    if ((!FoundLayer)
       &&
       (Layer2==-1)) {
      if (hulp2<hulp1) Layer=CurrentDrawingLayer;
      else Layer=Layer1;
      if (DrawLayerCode[Layer]<0x10) FoundLayer=1;
    }
    if (!FoundLayer) {
...
//      }
    ...
    if (Units==0) {
      sprintf(InfoStr,SC(141,"%s  [ %d ]   (%.1f,%.1f mils)"),Net->Name,cnt2,
                              CurrentTraceWidth/2540.0,
                              CurrentClearance/2540.0);
    } else {
      sprintf(InfoStr,SC(142,"%s  [ %d ]   (%.4f,%.4f mm)"),Net->Name,cnt2,
                              CurrentTraceWidth/100000.0,
    ...
    switch (ConnectionObject1.ObjectType) {
      case TRACE_HOR:
        if ((InRange(CurrentDrawX1,ConnectionObject1.x1))
           &&
           (InRange(CurrentDrawY1,ConnectionObject1.y1))) {
        ...
        PreviousDirection=GetNewDirection(StartPreviousTraceX,StartPreviousTraceY,
                                          EndPreviousTraceX,EndPreviousTraceY,0);
        break;
      case TRACE_VER:
        if ((InRange(CurrentDrawX1,ConnectionObject1.x1))
           &&
      ...
      case TRACE_ARC:
        ...
        if ((InRange(CurrentDrawX1,x1))
           &&
           (InRange(CurrentDrawY1,y1))) {
...

{
  ...
  if ((FoundObject.Layer<0)
     ||
     (FoundObject.Layer>=Design.NrBoardLayers)) return;
  ...
  for (cnt=0;cnt<NrObjects3;cnt++) {
    Object=&((*Objects3)[cnt]);
    if ((Object->ObjectType==FoundObject.ObjectType)
       &&
       (Object->Layer==FoundObject.Layer)
       &&
  ...
  if (Units==0) {
    sprintf(InfoStr,SC(141,"%s     (%.1f,%.1f mils)"),Net->Name,
                            CurrentTraceWidth/2540.0,
                            CurrentClearance/2540.0);
  } else {
    sprintf(InfoStr,SC(142,"%s     (%.4f,%.4f mm)"),Net->Name,
                            CurrentTraceWidth/100000.0,
                            CurrentClearance/100000.0);
  }
  RedrawInfoStr(1);
    ...
    switch (FoundObject.ObjectType) {
      ...
      case PIN_LINE_ALL_ANGLE:
        if (CalcLengthLine(PointX,PointY,FoundObject.x1,FoundObject.y1)<
          ...
          CurrentDrawX2=FoundObject.x1;
          CurrentDrawY2=FoundObject.y1;
          PreviousDirection=GetNewDirection(FoundObject.x2,FoundObject.y2,
                                            FoundObject.x1,FoundObject.y1,0);
        } else {
          CurrentDrawX1=FoundObject.x2;
          CurrentDrawY1=FoundObject.y2;
          CurrentDrawX2=FoundObject.x2;
          CurrentDrawY2=FoundObject.y2;
          PreviousDirection=GetNewDirection(FoundObject.x1,FoundObject.y1,
                                            FoundObject.x2,FoundObject.y2,0);
        }
        break;
    }
  }
...
//  CurrentDrawingLayer=0;
  if (CurrentDrawingLayer==-1) {
    ...
    if (CurrentDrawingLayer==-1) {
      CurrentDrawingLayer=0;
      if ((NewLayer=GetDrawingLayer(1))==-1) return;
...
//        Beep(1000,200);
//        MessageBoxOwn(PCBWindow,"One pin net",SC(1,"Message"),MB_APPLMODAL|MB_OK);
        break;
    }
  }
  Net=&((*Nets)[NetNr]);
...

{
  ...
  FoundNr=-1;
  for (cnt=0;cnt<NrObjects3;cnt++) {
    if ((cnt!=ObjectKeepOut)
       &&
       (cnt!=ObjectKeepOut2)) {
      Object=&((*Objects3)[cnt]);
#ifdef _DEBUG
      if ((InRange9(Object->x1,49.9e5))
         &&
         (InRange9(Object->y1,29.6e5))) {
        ok=1;
      }
#endif
      switch (Object->ObjectType) {
    ...
    if ((cnt!=ObjectKeepOut)
      ...
      switch (Object->ObjectType) {
        ...
        case PIN_LINE_ALL_ANGLE:
          if (ObjectsConnected(&CheckObject,Object)) {
            FoundNr=cnt;
            if (CalcLengthLine(EndX,EndY,Object->x1,Object->y1)<CalcLengthLine(EndX,EndY,Object->x2,Object->y2)) {
              *NewX=Object->x1;
              *NewY=Object->y1;
            } else {
              *NewX=Object->x2;
...
//            FoundNr=cnt;
            switch (Object->ObjectType) {
              case TRACE_HOR:
                ...
                if ((EndX>Object->x1+Object->x2-r)
                   &&
                   (EndX<Object->x1+Object->x2+r)
                   &&
                   (EndY>Object->y1-r)
                   &&
                   (EndY<Object->y1+r)) {
                ...
                *NewY=Object->y1;
                switch (Direction) {
                  ...
                  case 4:
                    *NewX=EndX;
                    if (*NewX<Object->x1) *NewX=Object->x1;
                    if (*NewX>Object->x1+Object->x2) *NewX=Object->x1+Object->x2;
                    return cnt;
                    break;
                  case 1:
                  case 5:
                  ...
                  case 6:
                    *NewX=Object->x1+Object->x2;
                    ...
                    break;
                  default:
                    if (LineCrosses2(StartX,StartY,EndX,EndY,
                                     Object->x1,Object->y1,Object->x1+Object->x2,Object->y1,
                                     &CenterX,&CenterY,0)==1) {
                      *NewX=CenterX;
                      *NewY=CenterY;
                      return cnt;
                ...
                switch (Direction) {
                  ...
                  case 5:
                    *NewY=(Object->x1+Object->y1-EndX+EndY)*0.5;
                    if (*NewY<Object->y1-Object->x2) *NewY=Object->y1-Object->x2;
                    if (*NewY>Object->y1) *NewY=Object->y1;
                  ...
                  default:
                    if (LineCrosses2(StartX,StartY,EndX,EndY,
                                     Object->x1,Object->y1,Object->x1+Object->x2,Object->y1-Object->x2,
                                     &CenterX,&CenterY,0)==1) {
                      *NewX=CenterX;
                      *NewY=CenterY;
                      return cnt;
              ...
              case TRACE_VER:
                ...
                *NewX=Object->x1;
                switch (Direction) {
                  ...
                  default:
                    if (LineCrosses2(StartX,StartY,EndX,EndY,
                                     Object->x1,Object->y1,Object->x1,Object->y1+Object->x2,
                                     &CenterX,&CenterY,0)==1) {
                      *NewX=CenterX;
                      *NewY=CenterY;
                      return cnt;
...

{
  ...
  for (cnt=0;cnt<NrObjects3;cnt++) {
    Object=&((*Objects3)[cnt]);
    if ((SearchObject->ObjectType==Object->ObjectType)
       &&
       (SearchObject->Layer==Object->Layer)
       &&
       (InRange(SearchObject->x1,Object->x1))
       &&
       (InRange(SearchObject->y1,Object->y1))
       &&
          ...
          if ((Trace->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
            if (Trace->NetNr!=CurrentDrawingNetNr) {
              ...
              if ((RectTestRect2(x1,y1+(lengte/2),dikte,lengte))
                 ||
                 (RectTestCircle(x1,y1,dikte,255))
                 ||
        ...
        for (cnt=0;cnt<Design.NrDiag1Traces[Layer];cnt++) {
          ...
          if ((Trace->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
            if (Trace->NetNr!=CurrentDrawingNetNr) {
              ...
              y2=y1-lengte;
              dikte=Trace->ThickNess;
              if ((RectTestDiag1(x1,y1,lengte,dikte))
                 ||
                 (RectTestCircle(x1,y1,dikte,255))
                 ||
                 (RectTestCircle(x2,y2,dikte,255))) {
        ...
        for (cnt=0;cnt<Design.NrDiag2Traces[Layer];cnt++) {
          ...
          if ((Trace->Info & (OBJECT_NOT_VISIBLE|OBJECT_SELECTED)) == 0) {
            if (Trace->NetNr!=CurrentDrawingNetNr) {
              ...
              y2=y1+lengte;
              dikte=Trace->ThickNess;
              if ((RectTestDiag2(x1,y1,lengte,dikte))
                 ||
                 (RectTestCircle(x1,y1,dikte,255))
                 ||
                 (RectTestCircle(x2,y2,dikte,255))) {
