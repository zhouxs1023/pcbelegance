...
double   Dir0X,Dir0Y,Dir1X,Dir1Y,Dir2X,Dir2Y,Dir3X,Dir3Y,
        Dir4X,Dir4Y,Dir5X,Dir5Y,Dir6X,Dir6Y,Dir7X,Dir7Y,
        DirX,DirY,OldX,OldY,
        OldCurrentTraceWidth,OldCurrentClearance;
...
void DrawTrace(double x1,double y1,double x2,double y2,double TraceWidth,
               double TraceClearanceWidth,int32 NetNr,int32 mode);

int32 FindShortestPadNet(double StartX,double StartY,double x1,double y1,
                         double ExcludeX1,double ExcludeY1,
                         double ExcludeX2,double ExcludeY2,
                         double *x2,double *y2,int32 mode);
...

{
  ...
  DrawTrace(CurrentDrawX1,CurrentDrawY1,OldX,OldY,
            CurrentTraceWidth,CurrentClearance,CurrentDrawingNetNr,TraceDrawingMode|16);
  DrawCrossObjects(0,0); // Display the traces/vias in the normal form
  if (((CurrentWorkingTrace.Info2 & 1)==1)
     &&
    ...
    if ((ObjectTrace.NetNr>=0)
       &&
       (ObjectTrace.NetNr<Design.NrNets)) {
...

{
  ...
  if (((CurrentWorkingTrace.Info2 & 1)==1)
    ...
    if ((ObjectTrace.ObjectType==TRACE_ALL_ANGLE)
       ||
       (ObjectTrace.ObjectType==TRACE_ARC)) {
  ...
  DrawTrace(CurrentDrawX1,CurrentDrawY1,OldX,OldY,
            CurrentTraceWidth,CurrentClearance,CurrentDrawingNetNr,TraceDrawingMode);
...

{
  ...
  ObjectKeepOut=-1;
  ObjectKeepOut2=-1;
  if (Direction==-1) Direction=DrawTrace1.Info2;
...
//  }
  ...
  if ((CurrentWorkingTrace.TraceNr>=0)
     &&
     (CurrentWorkingTrace.TraceNr<NrObjects3)) {
...
//      Direction=DrawTrace1.Info2 >> 2;
  ...
  if ((EndPointObjectNr=FindEndPointFromNetObjects(StartFirstDrawingTraceX,
                                                   StartFirstDrawingTraceY,
                                                   EndFirstDrawingTraceX,
                                                   EndFirstDrawingTraceY,
                                                   CurrentTraceWidth,
                                                   Direction,CurrentDrawingLayer,
                                                   &NewX,&NewY))!=-1) {
    Object3=&((*Objects3)[EndPointObjectNr]);
    DrawTrace(CurrentDrawX1,CurrentDrawY1,OldX,OldY,
              CurrentTraceWidth,CurrentClearance,CurrentDrawingNetNr,0);
    OldX2=OldX;
    OldY2=OldY;
    CurrentDrawX2=NewX;
    CurrentDrawY2=NewY;
...
//      Direction=DrawTrace2.Info2 >> 2;
  ...
  if ((EndPointObjectNr=FindEndPointFromNetObjects(StartSecondDrawingTraceX,
                                                   StartSecondDrawingTraceY,
                                                   EndSecondDrawingTraceX,
                                                   EndSecondDrawingTraceY,
                                                   CurrentTraceWidth,
                                                   Direction,CurrentDrawingLayer,
                                                   &NewX,&NewY))!=-1) {
    Object3=&((*Objects3)[EndPointObjectNr]);
...
#ifdef _DEBUG
      if ((InRange9(CurrentDrawX2,49.9e5))
         &&
         (InRange9(CurrentDrawY2,29.6e5))) {
        ok=1;
      }
#endif
...

{
  ...
  if (NewLayer==-1) return -1;
  if ((mode & 2) == 0) TraceDrawingOff(0);
  res=InsertVia();
  switch (res) {
    case -1:
    case -2:
...
*/
  ...
  int32   mx,my,ok,ConnectionObjectNr,OldLayer,OldCurrentDrawingLayer,
          res,NewLayer,OldLastActionNr,OldNetNr,
...
//  TraceDrawingMode=0;
  ...
  if (CurrentTraceWidth==0) CurrentTraceWidth=Design.StandardTraceWidth;
  if (CurrentClearance==0) CurrentClearance=Design.StandardClearance;
  ...
  while (!SelectionEsc) {
    if (MouseChanged) {
      ...
      if ((OldX!=CurrentDrawX2)
        ...
        OldX=CurrentDrawX2;
        OldY=CurrentDrawY2;
        DrawTrace(CurrentDrawX1,CurrentDrawY1,CurrentDrawX2,CurrentDrawY2,
                  CurrentTraceWidth,CurrentClearance,CurrentDrawingNetNr,TraceDrawingMode);
      }
...
// ***********************************************************************************
    if ((ZoomActive())
      ...
      OldX=CurrentDrawX2;
      OldY=CurrentDrawY2;
      if (!SelectionEsc) TraceDrawingOn(0);
    }
    if ((PanActive())
       &&
       (!SelectionEsc)) {
...
// ***********************************************************************************
  ...
  UnClipMouseCursor();
  CurrentWorkingTrace.Info2=0;
  if (TracesInserted>0) LastActionNr--;
  SystemBusyMode=0;
}
...

{
  ...
  double    divx,divy,divxabs,divyabs,mindivxy,x11,y11,x22,y22,x33,y33,x3,y3,x3a,x3b,
            ExcludeX1,ExcludeY1,ExcludeX2,ExcludeY2;
  int32      DrawOk=0;
  ...
  if (CurrentDirection>=0) {
    ...
    if (dv>16) dv-=32;
    dv2=abs(dv);
    if (dv2>=4) CurrentDirection=dir2;
  } else CurrentDirection=dir2;
  ...
  switch (TraceDrawingMode &0x0f) {
    ...
    /******************************************************************************************/
        ...
        if ((dir==0)
           ...
           ||
           ((dir==3) && (CurrentDirection==0))
           ||
           ((dir==31) && (CurrentDirection==0))
           ||
           ((dir==29) && (CurrentDirection==0))) {
          x22=x1;
          y22=y2-divxabs;
    //      Trace1Dir=0;
          DrawTrace1.Info2=0;
    ...
    /******************************************************************************************/
        ...
        if ((dir==4)
           ||
           ((dir==1) && (CurrentDirection==4))
           ||
           ((dir==3) && (CurrentDirection==4))
           ||
           ((dir==5) && (CurrentDirection==4))
           ||
           ((dir==7) && (CurrentDirection==4))) {
          x22=x1+mindivxy;
          y22=y1+mindivxy;
    //      Trace1Dir=1;
          DrawTrace1.Info2=1;
    ...
    /******************************************************************************************/
        ...
        if ((dir==8)
           ||
           ((dir==5) && (CurrentDirection==8))
           ||
           ((dir==7) && (CurrentDirection==8))
           ||
           ((dir==9) && (CurrentDirection==8))
           ||
           ((dir==11) && (CurrentDirection==8))) {
          x22=x2-mindivxy;
          y22=y1;
    //      Trace1Dir=2;
          DrawTrace1.Info2=2;
    ...
    /******************************************************************************************/
        ...
        if ((dir==12)
           ||
           ((dir==9) && (CurrentDirection==12))
           ||
           ((dir==11) && (CurrentDirection==12))
           ||
           ((dir==13) && (CurrentDirection==12))
           ||
           ((dir==15) && (CurrentDirection==12))) {
          x22=x1+mindivxy;
          y22=y1-mindivxy;
    //      Trace1Dir=3;
          DrawTrace1.Info2=3;
    ...
    /******************************************************************************************/
        ...
        if ((dir==16)
           ||
           ((dir==13) && (CurrentDirection==16))
           ||
           ((dir==15) && (CurrentDirection==16))
           ||
           ((dir==17) && (CurrentDirection==16))
           ||
           ((dir==19) && (CurrentDirection==16))) {
          x22=x1;
          y22=y2+mindivxy;
    //      Trace1Dir=4;
          DrawTrace1.Info2=4;
    ...
    /******************************************************************************************/
        ...
        if ((dir==20)
           ||
           ((dir==17) && (CurrentDirection==20))
           ||
           ((dir==19) && (CurrentDirection==20))
           ||
           ((dir==21) && (CurrentDirection==20))
           ||
           ((dir==23) && (CurrentDirection==20))) {
          x22=x1-mindivxy;
          y22=y1-mindivxy;
    //      Trace1Dir=5;
          DrawTrace1.Info2=5;
    ...
    /******************************************************************************************/
        ...
        if ((dir==24)
           ||
           ((dir==21) && (CurrentDirection==24))
           ||
           ((dir==23) && (CurrentDirection==24))
           ||
           ((dir==25) && (CurrentDirection==24))
           ||
           ((dir==27) && (CurrentDirection==24))) {
          x22=x2+divyabs;
          y22=y1;
    //      Trace1Dir=6;
          DrawTrace1.Info2=6;
    ...
    /******************************************************************************************/
        ...
        if ((dir==28)
           ||
           ((dir==25) && (CurrentDirection==28))
           ||
           ((dir==27) && (CurrentDirection==28))
           ||
           ((dir==29) && (CurrentDirection==28))
           ||
           ((dir==31) && (CurrentDirection==28))) {
          x22=x1-mindivxy;
          y22=y1+mindivxy;
    //      Trace1Dir=7;
          DrawTrace1.Info2=7;
...
// *******************************************************************************************************
    ...
    case 3:  // Arc trace
      ...
      DrawTrace2.x2=0.0;
      x3=0.0;
      switch (PreviousDirection) {  // GetNewDirection
// *******************************************************************************************************
...
//      InitDrawingObject(0,FIXED_COLOR_LAYER,1,GRAPHICS_GRAY+DRAW_WITH_PEN_AND_NOT_FILLED);
  ...
  if (DrawTraceUsingGuide) {
    if (DrawTwoTryingTraces) {
      ...
      DrawLine(MultX(DrawingConnectionX2),MultY(DrawingConnectionY2),
               MultX(StartSecondDrawingTraceX),MultY(StartSecondDrawingTraceY));
    }
  } else {
  ...
  for (cnt=0;cnt<NrObjects3;cnt++) {
    ...
    switch (Object->ObjectType) {
      ...
      case PIN_LINE_DIAG2:
        ...
        if (((NotInRange(x1a,ExcludeX1))
           ||
           (NotInRange(y1a,ExcludeY1)))
           &&
           ((NotInRange(x2a,ExcludeX2))
           ||
           (NotInRange(y2a,ExcludeY2)))) {
          if ((NotInRange(x1,Object->x1))
             ||
             (NotInRange(y1,Object->y1))) {
            if ((NotInRange(StartX,Object->x1))
               ||
               (NotInRange(StartY,Object->y1))) {
              if ((le=sqrt(SQR(x1-Object->x1)+SQR(y1-Object->y1)))<Length) {
                Length=le;
                Found=cnt;
                *x2=Object->x1;
          ...
          if ((NotInRange(x1,x2a))
             ||
             (NotInRange(y1,y2a))) {
            if ((NotInRange(StartX,x2a))
               ||
               (NotInRange(StartY,y2a))) {
      ...
      case TRACE_ARC:
        ...
        if (((NotInRange(x1a,ExcludeX1))
           ...
           ||
           (NotInRange(y2a,ExcludeY2)))) {
          if ((NotInRange(x1,x1a))
             ||
             (NotInRange(y1,y1a))) {
            if ((NotInRange(StartX,x1a))
               ||
               (NotInRange(StartY,y1a))) {
...

{
  ...
  if (CurrentDrawingNetNr<0) return -1;
  Net=&((*Nets)[CurrentDrawingNetNr]);
...
{
  int32   OldCurrentDrawingLayer,cnt,res,OldLastActionNr,
          ViasInserted,TempLastActionNr;
  RECT    Rect;
...
// ***********************************************************************************
    if ((ZoomActive())
      ...
      OldX=CurrentDrawX2;
      OldY=CurrentDrawY2;
      if (!SelectionEsc) DrawNewVia(CurrentDrawX2,CurrentDrawY2);
    }
    if ((PanActive())
       &&
       (!SelectionEsc)) {
...
//  TestCounter
  ...
  RePaint();
#endif
  if (ViasInserted>0) LastActionNr--;
  SystemBusyMode=0;
}
