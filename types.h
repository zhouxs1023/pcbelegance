...
typedef struct { // 96 bytes
          int32 ObjectType,Test,Layer,ObjectType2,
                Mirror,PinCount,TraceNr,
                Info,Info2,NetNr,CompNr,PinNr,CompNr2;
          double x1,y1,x2,y2,x3,y3,x4,y4,Clearance,
                 minx,miny,maxx,maxy,
                 Thickness,RotationAngle;
          uint8  *Address;
        } ObjectRecord ;
...
typedef struct {
          ...
          float CentreX,CentreY,StartDiffX,StartDiffY,
                EndDiffX,EndDiffY,Width,Height,LineThickNess;
          float Clearance,Dummy;
        } ObjectArcRecord;
...
typedef struct {
          int16 AreaFillType,NetNr,
                Info,AddNr,DeleteNr,FillType;
...
typedef struct {
          ...
          double ScaleFactor,PenSizes[16],PenSpeed,Xoffset,Yoffset,
                 BitmapExportResolution,AreaFillPen1,AreaFillPen2;
